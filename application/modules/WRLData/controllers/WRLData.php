...
class WRLData extends CI_Controller
{
...
function getSodexoReport(){
    ...
    function getFootfalAnalysisReport(){
        ...
        $fuelData = $this->Demo_model->getFootfalAnalysisData($this->input->get());        
          echo json_encode($fuelData);
    ...
    function getSodexoReportLive(){
        ...
        $fuelData['collector'] = $this->Demo_model->getsodexoDataLive($this->input->get('date')); 
        $fuelData['jp'] = $this->Demo_model->getsodexoDataLive_jp($this->input->get('date'));        
        echo json_encode($fuelData);
    ...
    function getOudorLevelReportLiveDashboard(){
        $data['collector'] = $this->Demo_model->getOudorLevelLiveDashboard($this->input->get('date'));
        $data['jp'] = $this->Demo_model->getOudorLevelLiveDashboard_jp($this->input->get('date'));  
        echo json_encode($data); 
    }
    function getWaterReportLive(){
        $data['water'] = $this->Demo_model->getWaterLevelLiveDashboard($this->input->get('date')); 
        $data['water_jp'] = $this->Demo_model->getWaterLevelLiveDashboard_jp($this->input->get('date'));  
        echo json_encode($data); 
    }
    ...
    function getWaterLekageReport(){
        $data['water_leak'] = $this->Demo_model->getLekageReport($this->input->get());
        // $data['lk_jp'] = $this->Demo_model->getJanitorNormaReport_jp($this->input->get());
          //$data = $this->Demo_model->getJanitorData($this->input->get());  
        echo json_encode($data); 
    }
    function getWaterConsReport(){
        $data['water_cons'] = $this->Demo_model->getWaterConsumptionReport($this->input->get());
        // $data['lk_jp'] = $this->Demo_model->getJanitorNormaReport_jp($this->input->get());
          //$data = $this->Demo_model->getJanitorData($this->input->get());  
        echo json_encode($data); 
    }
    function getHighOdourReport(){
        $data['high_odour'] = $this->Demo_model->getHighOdReport($this->input->get());
        // $data['lk_jp'] = $this->Demo_model->getJanitorNormaReport_jp($this->input->get());
          //$data = $this->Demo_model->getJanitorData($this->input->get());  
        echo json_encode($data); 
    }
...
//print_r($this->input->get('date'));die();
    ...
    function consolidateReport(){
        ...
        // $fdata=$this->Demo_model->getFootfallReportDb($this->input->get('date'),$this->input->get('location'));
        // //print_r($fdata);die();
        // if($fdata[2]>0){
        //     $c[0]=$fdata[0];
        //      $c[1]=$fdata[1];
        ...
        // }else{
        //     $data['footfallcount'] = $this->Demo_model->getFootfallReport($this->input->get('date'),$this->input->get('location'));
        // }
        // print_r($data['footfallcount']);die();
        $data['footfallcount'] = $this->Demo_model->getFootfallReport($this->input->get('date'),$this->input->get('location'));
        $data['waterlevel'] = $this->Demo_model->getWaterLevelLiveDashboard_consolidated($this->input->get('date'),$this->input->get('location'));
        

        $data['janitor'] = $this->Demo_model->getJanitorConsoData($this->input->get('date'),$this->input->get('location')); 
       
        //die();
        //  $oddata=$this->Demo_model->getOdourDataFromDb($this->input->get('date'),$this->input->get('location'));
        //  if($oddata['odr']>0){
        ...
        //     $data['odour'] =$odr;
        //  }else{
        //     $data['odour'] = $this->Demo_model->getOudorLevelLiveDashboardcreport($this->input->get('date'),$this->input->get('location'));
        //  }
         $data['odour'] = $this->Demo_model->getOudorLevelLiveDashboardcreport($this->input->get('date'),$this->input->get('location'));
        // $ffall=$this->Demo_model->getFootfallDataFromDb($this->input->get('date'),$this->input->get('location'));
        // if($ffall['ffal']>0){
        //     $ffl['xdata']=$ffall['xdata'];
        //     $ffl['ydata']=$ffall['ydata'];
        //     $ffl['ydata_female']=$ffall['ydata_female'];
        //     $ffl['fromdb']='yes';
        //     $data['footfall']=$ffl;

        // }else{
        //     $data['footfall'] = $this->Demo_model->getsodexoDataLivecreport($this->input->get('date'),$this->input->get('location'));
        // }
        $data['footfall'] = $this->Demo_model->getsodexoDataLivecreport($this->input->get('date'),$this->input->get('location'));
        
        $data['feedback'] = $this->Demo_model->getFeedbackDataDayLivecreport($this->input->get('date'),$this->input->get('location'));
        echo json_encode($data); 
    }
...
//print_r($this->input->get('date'));die();
    ...
    function getFeedbackReport(){
      ...
      function getFeedbackReportLive(){
        //echo "kk";
        $data['collector'] = $this->Demo_model->getFeedbackDataDayLive($this->input->get('date'));
        $data['jp'] = $this->Demo_model->getFeedbackDataDayLive_jp($this->input->get('date'));  
        echo json_encode($data); 
    }
