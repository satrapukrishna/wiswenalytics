    ...
    <div id="MnCtnr" class="DshMnCtnr">
       ...
       <input type="hidden" id="page" value="runninggg" />
		...
		<div class="DshBrdSctn" style="padding: 10px 10px 10px 15px;">
			...
			<form name="reports" id="myForm" action="<?php echo site_url("Admin_qr/Home/all_reports")?>" method="post" onSubmit="return formValidation();">
			...
			<?php //echo "<pre>";print_r($_POST);?>
				<?php /*<form name="reports" id="myForm" action="<?php echo site_url("Admin/Home/all_reports_search")?>" method="post" onSubmit="return formValidation();">*/?>
					...
					<div class="col-md-12" style="background: #f3f3f3;margin-top: -13px;padding-bottom:20px;border-bottom:#ccc 1px solid">
                           ...
                           <?php
                            ...
                            echo form_dropdown('report', $report, $this->input->post('report'), 'class="form-control chosen-select report" id="report"'); ?>
                            </div>
              ...
              <option value="0">Sunday
						  ...
						  <div class="col-md-11 no-leftpad" ><br/>
							...
							<a href="<?php echo site_url('Admin_qr/Home/all_reports') ?>" class="btn btn-info reset">Reset</a>
							</span>
...
function getsolutions(){
    ...
    $.ajax({
        ...
        url: BASE_URL+'Admin_qr/Home/ajax_hardware_device_dropdown/',
        success: function (data){
			// alert(data);return false;
            $("#solution").html(data);
            $("#solution").trigger("chosen:updated");
...
function getdevices(){
    ...
    $.ajax({
        ...
        url: BASE_URL+'Admin_qr/Home/ajax_hardware_dropdown/',
        success: function (data){
			 // alert(data);return false;
            $("#device").html(data);
...
function getreports(){
	...
	$.ajax({
        ...
        url: BASE_URL+'Admin_qr/Home/ajax_report_dropdown/',
        success: function (data){
			//alert(data);return false;
            $("#report").html(data);
            $("#report").trigger("chosen:updated");
