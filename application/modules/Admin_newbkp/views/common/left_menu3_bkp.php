            ...
            <div class="DshBrdLnkCntr" id="root" data-simplebar>
                <ul class="LnkHldr FrstLvl">
                        ...
                        <ul class="ScndLvl" id="subcat555" style="display: none;">                          
                            ...
                            <li>
                                <a href="<?php echo site_url('Admin/Home/water/')?>#hydro1" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/STP.png" width="22px"/> <span class="Txt">STP</span></a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('Admin/Home/water/')?>#hydro1" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/Boilers.png" width="22px"/> <span class="Txt">Boilers</span></a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('Admin/Home/water/')?>#hydro1" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/HotWaterTanks.png" width="22px"/> <span class="Txt">Hotwater Tanks</span></a>
                            </li>
                        ...
                        <ul class="ScndLvl" id="subcat556" style="display: none;">                          
                            ...
                            <li>
                             ...
                             <li>
                                <a href="<?php echo site_url('Admin/Home/energy/')?>#trip" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/DieselTank.png" width="22px"/> <span class="Txt">Diesel Tank</span></a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('Admin/Home/energy/')?>#trip" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/DieselMeter.png" width="22px"/> <span class="Txt">Diesel Meters</span></a>
                            </li>
                             <li>
                             ...
                             <!-- <ul class="ScndLvl" id="subcat558" style="display: none;"> -->
                                <li>
                                    ...
                                    <ul class="ScndLvl" id="subcat559" style="display: none;">
                                         ...
                                         <li>
                                            <a href="<?php echo site_url('Admin/Home/air/')?>#div7" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/Chillers.png" width="28px" style="margin-right:2px"/> <span class="Txt">Chiller</span></a>
                                        </li>
                                         <li>
                                ...
                                <li>
                                    <a class="Lnk Arr Slct" href="#" onclick="menushow(560)" id="cat558"><img src="<?php echo site_url() ?>asset/admin/images/AirQuality.png" width="20px"/> <span id="dsh" class="Lnk Arr Slct Dshbrd">Air Quality</span></a>
                                     <ul class="ScndLvl" id="subcat560" style="display: none;">
                                         <li>
                                             <a href="<?php echo site_url('Admin/Home/air/')?>#airqua" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/IndoorAirQuality.png" width="22px"/> <span class="Txt">Indoor Air Quality </span></a>
                                        </li>
                                         <li>
                                             <a href="<?php echo site_url('Admin/Home/air/')?>#airqua" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/ToiletExhaust.png" width="22px"/> <span class="Txt">Toilet Exhaust </span></a>
                                        </li>
                                         <li>
                                             <a href="<?php echo site_url('Admin/Home/air/')?>#airqua" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/VentilationFan.png" width="22px"/> <span class="Txt">Ventilation Fans</span></a>
                                        </li>
                                     </ul>
                                <!-- </li> -->
                         ...
                         <li>
                                    <a class="Lnk Arr Slct" href="#" onclick="menushow(570)" id="cat558"><img src="<?php echo site_url() ?>asset/admin/images/SoftIntegration.png" width="20px"/> <span id="dsh" class="Lnk Arr Slct Dshbrd">Soft Integration</span></a>
                                     <ul class="ScndLvl" id="subcat570" style="display: none;">
                                         <li>
                                             <a href="<?php echo site_url('Admin/Home/air/')?>#airqua" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/Lifts.png" width="22px"/> <span class="Txt">Lifts </span></a>
                                        </li>
                                        <li>
                                             <a href="<?php echo site_url('Admin/Home/air/')?>#airqua" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/DG.png" width="22px"/> <span class="Txt">DG </span></a>
                                        </li>
                                        <li>
                                             <a href="<?php echo site_url('Admin/Home/air/')?>#airqua" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/Invertor.png" width="22px"/> <span class="Txt">Invertor </span></a>
                                        </li>
                                         <li>
                                             <a href="<?php echo site_url('Admin/Home/air/')?>#airqua" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/Chillers.png" width="22px"/> <span class="Txt">Chillers </span></a>
                                        </li>
                                        <li>
                                             <a href="<?php echo site_url('Admin/Home/air/')?>#airqua" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/FireAlarm.png" width="22px"/> <span class="Txt">Fire Alarm System </span></a>
                                        </li>
                         ...
                         <li>
                                    <a class="Lnk Arr Slct" href="#" onclick="menushow(571)" id="cat558"><img src="<?php echo site_url() ?>asset/admin/images/SpeacilizedSolutions.png" width="20px"/> <span id="dsh" class="Lnk Arr Slct Dshbrd">Specialized Solution</span></a>
                                     <ul class="ScndLvl" id="subcat571" style="display: none;">
                                         <li>
                                             <a href="<?php echo site_url('Admin/Home/air/')?>#airqua" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/WashrromMonitoring.png" width="22px"/> <span class="Txt">Washroom Monitoring </span></a>
                                        </li>
                                        <li>
                                             <a href="<?php echo site_url('Admin/Home/air/')?>#airqua" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/ColdRoom.png" width="22px"/> <span class="Txt">Cold Room </span></a>
                                        </li>
                                        <li>
                                             <a href="<?php echo site_url('Admin/Home/air/')?>#airqua" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/FloorWet.png" width="22px"/> <span class="Txt">Floor Wetness </span></a>
                                        </li>
                                         <li>
                                             <a href="<?php echo site_url('Admin/Home/air/')?>#airqua" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/WashrromMonitoring.png" width="22px"/> <span class="Txt">Door -Open/Close </span></a>
                                        </li>
