...
function generateCard(data){
 ...
 //console.log(d);
  ...
  div +="<h3>"+d['meter']+"</h3><div class='b-value'><div>Yesterday</div><div>Today</div><div>Last Week(Cum/Avg)</div><div>Last Month(Cum/Avg)</div><div>This Month till Date(Cum/Avg)</div></div>";
