...
<body onload="initialize()">
    <div class="AppMenu">
        ...
        <ul class="MenuList">
            <li>
                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/dashboard" class="AppMenuLnk Map Actv">
                    <span class="LnkTxt">Map</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="AppMenuLnk Dshbrd">
                ...
                <div class="accordion-item">
                  ...
                  <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <ul class="MenuList">
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering" class="AppMenuLnk Engnrng">
                                    <span class="LnkTxt">BMS</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/machinery" class="AppMenuLnk Mchnry">
                                    <span class="LnkTxt">Machinery</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/resources" class="AppMenuLnk Rsrcs">
                                    <span class="LnkTxt">Resources</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/sanitation" class="AppMenuLnk Snttn">
                ...
                <div class="accordion-item">
                  ...
                  <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <ul class="MenuList">
                        <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/attendence" class="AppMenuLnk Attndnc">
                                    <span class="LnkTxt">Attendance</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/checklist" class="AppMenuLnk Chcklsts">
                                    <span class="LnkTxt">Checklists</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/pPM" class="AppMenuLnk PPM">
                                    <span class="LnkTxt">PPM</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/aMC" class="AppMenuLnk PPM">
                                    <span class="LnkTxt">AMC</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/complaintFeedback" class="AppMenuLnk CmplntsFdbck">
                                    <span class="LnkTxt">Complaints & Feedback</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/bedsOccupancy" class="AppMenuLnk BdsOccpncy">
                                    <span class="LnkTxt">Beds & Occupancy</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/manpowerUtilization" class="AppMenuLnk MnpwrUtlztn">
                                    <span class="LnkTxt">Manpower Utilization</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/inventoryManagement" class="AppMenuLnk InvntryMngmnt">
                                    <span class="LnkTxt">Inventory Management</span>
                                </a>
                            </li>
                            
                           <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/repairMaintenance" class="AppMenuLnk ReprMntnnc">
                                    <span class="LnkTxt">Repairs & Maintenance</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/billingSoftware" class="AppMenuLnk BllngSftwr">
                ...
                <div class="accordion-item">
                  ...
                  <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <ul class="MenuList">
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/audits" class="AppMenuLnk Adts">
                                    <span class="LnkTxt">Audits</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/benchmarking" class="AppMenuLnk Bnchmrkng">
                                    <span class="LnkTxt">Benchmarking</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/recommendations" class="AppMenuLnk Rcmmndtns">
                                    <span class="LnkTxt">Recommendations</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/comparisions" class="AppMenuLnk Cmprsns">
                                    <span class="LnkTxt">Comparisions</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/carbonFootprint" class="AppMenuLnk CrbnFtprnt">
                                    <span class="LnkTxt">Carbon Footprint</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/plans" class="AppMenuLnk Plns">
        ...
        <div class="ContainerRight">
            <div class="AppUsrLnks">
                <ul class="PrflHdrLnk">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/notifications" class="HdrIcoLnk Ntfctns Updts"></a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/settings" class="HdrIcoLnk Sttngs"></a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/login" class="HdrIcoLnk Lgout"></a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseCOne" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <ul class="HsptlLst">
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic Koyambedu<span
                                                    class="Ntfctns"><span class="Val">0</span></span></a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic Velechary<span
                                                    class="Ntfctns"><span class="Val">0</span></span></a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseCTwo" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <ul class="HsptlLst">
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic Pitam Pura<span
                                                    class="Ntfctns"><span class="Val">0</span></span></a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic Chandini
                                                Chowk<span class="Ntfctns"><span class="Val">3</span></span></a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic Bhajanpura<span
                                                    class="Ntfctns"><span class="Val">0</span></span></a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic Karol Bagh<span
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseCThree" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <ul class="HsptlLst">
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic Kukatpally<span
                                                    class="Ntfctns"><span class="Val">1</span></span></a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic Kompally<span
                                                    class="Ntfctns"><span class="Val">0</span></span></a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic Banjara
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseCFour" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <ul class="HsptlLst">
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic Khardaha<span
                                                    class="Ntfctns"><span class="Val">2</span></span></a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic
                                        ...
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic Tangra<span
                                                    class="Ntfctns"><span class="Val">0</span></span></a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic Chakpra<span
                                                    class="Ntfctns"><span class="Val">0</span></span></a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseCFive" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <ul class="HsptlLst">
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic Nav Pada<span
                                                    class="Ntfctns"><span class="Val">0</span></span></a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic Sundar
                                                Nagar<span class="Ntfctns"><span class="Val">0</span></span></a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic Dadar<span
                                                    class="Ntfctns"><span class="Val">0</span></span></a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="HsptlLnk">FirstMedic Chembur<span
                                                    class="Ntfctns"><span class="Val">0</span></span></a>
                                        </li>
                                    </ul>
                                </div>
