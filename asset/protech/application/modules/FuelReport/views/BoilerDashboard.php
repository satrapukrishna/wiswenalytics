...
<head>
  ...
  <!-- jvectormap -->
  <link rel="stylesheet" href="../../asset/common-utilits/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
  <!-- Date Picker -->
...
<div class="row" style="margin: 0 0px;margin-top: 9px;">
  <!-- meter-first -->
        ...
        <div class="col-md-12"> <!-- meter-first -->
          ...
          <div class="col-md-2 col-md-3">
            <div class="meter"><img src="../../asset/common-utilits/dist/img/old-boiler.png"></div>
            <div class="value1">
              <div>Running Hours (<small>Hrs</small>)</div>
              <div>Fuel Consumption (<small>Ltrs</small>)</div>
              <div>Fuel Added (<small>Ltrs</small>)</div>
          ...
          <div class="horizotal row-horizon" id="cardparent"> <!-- horizotal row-horizon -->
            <!--<div class="col-md-4 col-md-7 boil-card1">
              <h3>Boiler 1</h3>
              <div class="b-value">
                <div>Today</div>
...
<!-- jvectormap -->
<script src="../../asset/common-utilits/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="../../asset/common-utilits/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
...
<!-- Bootstrap WYSIHTML5 -->
<script src="../../asset/common-utilits/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
...
function generateCard(data){
 ...
 //console.log(d);
  var div= "<div class='col-md-12 col-lg-7 boil-card1'>";
