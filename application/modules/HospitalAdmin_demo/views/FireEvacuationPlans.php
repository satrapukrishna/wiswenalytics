...
<head>
    ...
    <title>Fire Evacuation Plans</title>
        ...
        <div class="ContainerLeft">
            ...
            <div class="SctnInnerLnks">
                <ul class="InnrLnksHldr">
                    <li>
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/floorPlans" class="LnkTxt FlrPln Icn">Floor Plan</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/fireEvacuationPlans" class="LnkTxt FrExPln Icn Actv">Fire Evacuation Plan</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="SctnDtlsTtlHldr">
                <div class="BrcmnbHldr">
                    <ul class="DtlsBrdCrmb">
                        <li>
                            <span class="PgTtl">Fire Evacuation Plans</span>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="TableHldr">
                    <table class="AppDataTbl">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Fire Evacuation 01</span>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Fire Evacuation 02</span>
                            </td>
                            <td>
                                <span class="DataTxt">1.0</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Fire Evacuation 03</span>
                            </td>
                            <td>
                                <span class="DataTxt">1.0</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Fire Evacuation 04</span>
                            </td>
                            <td>
                                <span class="DataTxt">1.0</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Fire Evacuation 05</span>
                            </td>
                            <td>
                                <span class="DataTxt">1.0</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Fire Evacuation 06</span>
                            </td>
                            <td>
                                <span class="DataTxt">1.0</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Fire Evacuation 07</span>
                            </td>
                            <td>
                                <span class="DataTxt">1.0</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Fire Evacuation 08</span>
                            </td>
                            <td>
                                <span class="DataTxt">1.0</span>
                            </td>
