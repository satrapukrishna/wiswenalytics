...
$(function() {
  ...
  function fetchSodexoData()
  {
    ...
    console.log(today);
      ...
      var urlString = "<?php echo base_url(); ?>JNTUWashroom/getWashroomDashboardData";
      $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
  ...
  function displaySodexoData(data)
  {
      ...
      for (let d = 0; d < washroom_data.length; d++) {
        ...
        var urlString_water = "<?php echo base_url(); ?>JNTUWashroom/getWaterReportLive";
        $.ajaxQueue({
          url:urlString_water,
          type : 'GET',
          data:{
        ...
        var urlString_water = "<?php echo base_url(); ?>JNTUWashroom/getPowerDataLive";
        $.ajaxQueue({
          url:urlString_water,
          type : 'GET',
          data:{
        ...
        var urlStringOdour = "<?php echo base_url(); ?>JNTUWashroom/getOudorLevelMaleReportLiveDashboard";
        $.ajaxQueue({
          url:urlStringOdour,
          type : 'GET',
          data:{
        ...
        var urlStringOdour = "<?php echo base_url(); ?>JNTUWashroom/getOudorLevelFemaleReportLiveDashboard";
        $.ajaxQueue({
          url:urlStringOdour,
          type : 'GET',
          data:{
        ...
        var urlStringFootfall = "<?php echo base_url(); ?>JNTUWashroom/getFootfallMaleFemaleLive";
        $.ajaxQueue({
        ...
        var urlStringFeedback = "<?php echo base_url(); ?>JNTUWashroom/getFeedbackReportLive";
        $.ajax({
