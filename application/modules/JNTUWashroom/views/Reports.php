    ...
    <?php if($id==1){ ?>
     ...
     if(g==1){
      //document.getElementById("loading").style.display="block";
        ...
        var urlString = "<?php echo base_url(); ?>JNTUWashroom/getSodexoReport";
        $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
   ...
   if(fromdate == ""){
    ...
    return true;
      ...
      //document.getElementById("loading").style.display="block";
        ...
        var urlString = "<?php echo base_url(); ?>JNTUWashroom/getSupervisorDayData";
        $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
        ...
        var urlString = "<?php echo base_url(); ?>JNTUWashroom/getFootfalReport";
        $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
      ...
      if(mtype=='Footfall Analysis Report'){
        ...
        var urlString = "<?php echo base_url(); ?>JNTUWashroom/getFootfalAnalysisReport";
        $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
      ...
      if(mtype=='Odour Graph Report'){
        ...
        var urlString = "<?php echo base_url(); ?>JNTUWashroom/getOudorLevelReport";
        $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
       ...
       var valid=validate();
        ...
        var urlString = "<?php echo base_url(); ?>JNTUWashroom/getFeedbackReport";
        $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
      ...
      if(mtype=='Water Leakage Report'){
        ...
        var urlString = "<?php echo base_url(); ?>JNTUWashroom/getWaterLekageReport";
        $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
      ...
      if(mtype=='Water Consumption Report'){
          ...
          var urlString = "<?php echo base_url(); ?>JNTUWashroom/getWaterConsReport";
          $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
      ...
      if(mtype=='High Odour Report'){
        ...
        var urlString = "<?php echo base_url(); ?>JNTUWashroom/getHighOdourReport";
        $.ajax({
        url:urlString,
        type : 'GET',
        async: true,
        ...
        if(mtype=='Consolidate Report Tabular'){
          ...
          var urlString = "<?php echo base_url(); ?>JNTUWashroom/consolidatedReportTabular";
          $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
          ...
          var urlString = "<?php echo base_url(); ?>JNTUWashroom/consolidatedFootfallTabular";
          $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
          ...
          if(mtype=='Consolidate Footfall Odour Report'){
            ...
            var urlString = "<?php echo base_url(); ?>JNTUWashroom/consolidatedFootfallWithpowerTabular";
            $.ajax({
            url:urlString,
            type : 'GET',
            async: true,
          ...
          var urlString = "<?php echo base_url(); ?>JNTUWashroom/consolidatedReportDatewise";
          $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
      ...
      for (var i1 = 0; i1 < c.length; i1++) {
        document.getElementById("dateid"+i1).innerHTML = c[i1];
          var urlStringfoot = "<?php echo base_url(); ?>JNTUWashroom/consolidateReport?date="+c[i1]+"&location="+location;
...
function appendData_consolidated(obj){
  ...
  function appendData_consolidated_footfall_power(obj){
    $("#consolidated_tab_cfootpower tbody").empty();
       ...
       for (var i = 0; i < obj.length; i++) 
       {
          rows += "<tr><td>" + j + "</td><td>" +obj[i]['location'] + "</td><td>" +obj[i]['fromdate'] + "</td><td>" + obj[i]['todate'] + "</td><td>" + obj[i]['totaldays'] + "</td><td>" + obj[i]['male_footfall'] + "</td><td>" + obj[i]['female_footfall'] + "</td><td>" + obj[i]['total_footfall'] + "</td><td>" + obj[i]['unaccept']['od_male_count'] + "</td><td>" + obj[i]['unaccept']['od_female_count'] + "</td><td>" + obj[i]['sms']['count'] + "</td></tr>"; 
            ...
            <div class="DshbrdHdr" style="border-bottom:#fff">
              <div class="row SctnSlctr" style="width: 100%;">
                <div class="col-md-1" style="width: 10%;" id="links">
                  <span class="SctnNm">
                    <a href="<?php echo site_url('JNTUWashroom/demoData') ?>" class="Lnk">Dashboard</a>
                  </span>
                </div>
                <div class="col-md-1" style="width: 10%;" id="links">
                  <span class="SctnNm">
                    <a href="<?php echo site_url('JNTUWashroom/getReport') ?>" class="Lnk">Reports</a>
                  </span>
                </div>
                <!-- <div class="col-md-1" style="width: 10%;" id="links">
                  <span class="SctnNm">
                    <a href="<?php //echo site_url('JNTUWashroom/map') ?>" class="Lnk">MapView</a>
                  </span>
                </div> -->
  ...
  function getReports(){
    //alert("h");
       ...
       document.getElementById("odourright").style.display="block";
        ...
        var urlString = "<?php echo base_url(); ?>JNTUWashroom/getSodexoReportLive";
        $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
