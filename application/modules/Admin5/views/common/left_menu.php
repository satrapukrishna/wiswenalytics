		...
		<li class="treeview" id="hardware">
         ...
         <ul class="treeview-menu">
			...
			<?php }else{
				...
				<?php  /*?><li><a href="<?php echo site_url('Admin/Hardware/create_hardware'); ?>"><i class="fa fa-circle-o"></i> Add Hardware</a></li><?php */ ?>
				<li><a href="<?php echo site_url('Admin/Firepump'); ?>"><i class="fa fa-circle-o"></i>Manage Firepump</a></li>
			<?php  /*?>	<li><a href="<?php echo site_url('Admin/Firepump/create_firepump'); ?>"><i class="fa fa-circle-o"></i>Add Firepump</a></li><?php */ ?>
