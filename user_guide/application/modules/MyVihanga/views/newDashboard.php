...
function displayDomesticData(data)
{
  ...
  { 
    if(i>d.length-1)
    {
      ...
      {
        var dateobj=GetTime(d[j]['ToTime']);
        time=d[j]['ToTime'];
        if(j==0)
        {
          time1=d[j]['ToTime'];
        ...
        if(d[j]['UtilityName']=='Volume_CT 1-6' || d[j]['UtilityName']=='Volume_CT 8-10' || d[j]['UtilityName']=='Volume_CT 11-12' || d[j]['UtilityName']=='Volume_CT 13-16' || d[j]['UtilityName']=='Volume_CT 17-20')
        {
          if(l%5==0)
          {  
          ...
          appendContent2 += "<tr>";
          if(d[j]['UtilityName']=='Volume_CT 1-6')
          {
            l++;
        ...
        var filldata1= Math.round((additionalData/150)*100); 
          ...
          else if(d[j]['UtilityName']=='Volume_CT 8-10')
          {
            var clevel=Math.round((d[j]['Consumption']/1000)+(d[j]['Consumption']/10000));
        ...
        if(clevel>10 && clevel<37){
          ...
          else if(d[j]['UtilityName']=='Volume_CT 11-12')
          {
            l++;
            var clevel=Math.round((d[j]['Consumption']/1000)+(d[j]['Consumption']/10000));
        ...
        if(clevel>10 && clevel<37){
          ...
          else if(d[j]['UtilityName']=='Volume_CT 13-16')
          {
            l++;
            var clevel=Math.round((d[j]['Consumption']/1000)+(d[j]['Consumption']/10000));
        ...
        if(clevel>10 && clevel<37){
          ...
          else if(d[j]['UtilityName']=='Volume_CT 17-20')
          {
            l++;
