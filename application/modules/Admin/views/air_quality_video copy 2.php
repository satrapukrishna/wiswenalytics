...
<body>
<?php $this->load->view('protech/header1')?>
<?php $this->load->view('protech/footer1')?>
    <div class="AppMstrCntnr" style="top:0px !important;">
        <div class="GnPgCntntDvHldr DashboardView FullView">
            <div id="InnrCntntHldrDv" class="InnrCntntHldr" style="margin-bottom: -5% !important;">
                <div class="FormHldr">
                    <div id="IAQLnkDv" class="row NoBrdr NoBG">
                        <div class="col-1 NoPd">
                            ...
                            <div class="DshHdrHldr TmpltTwo Brdr">
                                    <div class="TtlHldr">
                                        <span class="TtlTxt Icn">Room KPI Dashboard</span>
                                    </div>
                                ...
                                <div class="DshDtlHldr TmpltTwo">
                                    ...
                                    <div class="DshInnrAccrdn" style="margin-bottom: 0px !important;margin-top: -10px !important;">
                                        ...
                                        <div class="DshInnrAccrdnDtlHldr">
                                            <div class="FormHldr">
                                                <div class="row NoBrdr NoBG" style="margin-left: 20%;">
                                                                                ...
                                                                                <div class="row NoBrdr NoBG">
                                                                                    <div class="col-1 NoPd">
                                                                                        <div class="BMSDshbrdDtlDv ThemeOne">
                                                                                            <div class="TxtDv">
                                                                                                <span class="VluTtl">Max.</span>
                                                                                                <span class="VluTxt"><?php echo $iaq_data[$i]['humMax']?>%RH<sup></sup>																								</sup></span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-1 NoPd">
                                    ...
                                    <div class="DshInnrAccrdn" style="margin-bottom: 80px !important">
                                    <div style="left: 0; width: 100%; height: 0; position: relative; padding-bottom: 26.25%;">
                                        <iframe src="https://www.youtube.com/embed/Gqn9Ctwk-f8?rel=0" style="top: 0; left: 25%; width: 40%; height: 80%; position: absolute; border: 0;" allowfullscreen scrolling="no" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share;">
