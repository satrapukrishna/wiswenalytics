...
<script type="text/javascript">
  ...
  function displayFlushData(data)
  {
    ...
    for (var i = 0; i < d.length; i++)
    {
      ...
      {
        var div="<div class='tank waterTankHere7'></div><div class='tank waterTankHere8'></div><div class='tanker-details'><h4 class='card-flush'>Flush Tank 5-10/11-16</h4><ul><li><label>TotalCapacity</label><div></div><span>380KL</span></li><li><label>CurrentLevel</label><div></div><span>"+Math.round(d[i]['Consumption']/1000)*4+'KL'+"</span></li><li><label>Filled</label><div></div><span>"+Math.round(((d[i]['Consumption']*4)/380000)*100)+"%</span></li></ul></div></div> ";

        document.getElementById("flush2").innerHTML +=div;
        // document.getElementById("domesticall2").innerHTML +=div;
        var domeval=parseInt(document.getElementById("FlushTotal").innerHTML)+parseInt(Math.round(d[i]['Consumption']/1000)*4);
