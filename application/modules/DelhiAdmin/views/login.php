...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo base_url(); ?>asset/admin_vegas/Images/Web-Icon.png" />
    <link rel="icon" sizes="192x192" href="<?php echo base_url(); ?>asset/admin_vegas/Images/Web-Icon.png">
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800&display=swap" rel="stylesheet">
    <link href="<?php echo base_url(); ?>asset/admin_vegas/CSS/StyleSheet.css" rel="stylesheet" />
    ...
    <div class="LoginBgHldr">
        <div class="LoginHldr">
            ...
            <div class="LoginTtlHldr">
                <div class="LogoHldr">
                    <img src="<?php echo base_url(); ?>asset/admin_vegas/Images/delhi_logo1.jpg" class="Logo" />
                </div>
                <span class="LoginTtlNm">Login</span><span class="LoginTtlNmee"></span>
            </div>
			
			<div class="LoginBx tabs">
				<ul class="nav nav-tabs tab-group LoginType">
				 
				  <li class="Lnk active"><a data-toggle="tab" href="#employee"><b>Login Page</b></a></li>
				...
				<div class="tab-content">
				  ...
				  <div id="employee" class="tab-pane fade in active">
					...
					<form action="<?php echo base_url('DelhiAdmin/employee_login_user'); ?>" method="post">
                    <ul class="LoginFlds">
                        <li>
