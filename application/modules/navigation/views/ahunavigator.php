      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active">
              <a href="<?php echo site_url();?>AHU/tomotherapy"><i class="fa fa-circle-o"></i>AHU Dashboard</a>
            </li>
            <!-- <li class="active">
        ...
        <li class="treeview">
         ...
         <ul class="treeview-menu">
             <li class="active">
               <a href="<?php echo site_url();?>AHU/hvacReport"><i class="fa fa-circle-o"></i>AHU Graph Report</a>
              </li>
          </ul>
        </li>
      </ul>
