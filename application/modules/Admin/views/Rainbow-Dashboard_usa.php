        ...
        <div class="DshBrdCtnr">
            <div class="DtClndrHldr">
                <div class="DtSlctrHldr">
                    <div class="DtTxtHldr">
                        <span class="TxtTp">Date</span>
                        <span class="TxtDte">September 14 2022</span>
                    </div>
            ...
            <?php for ($i=0; $i < count($rainbow_main_data); $i++){?>
                <div class="DtlsFllHld">
                    ...
                    <div class="LocationDtls">
                        <?php if(ucwords($rainbow_main_data[$i]['location'])=='Vikrampuri'){ ?>
                            <span class="LocaitonName">Embassy Suits,  River walk, San Antonio.</span>
                            <span class="LocaitonBscDtls">250 Rooms.</span>
                        <?php }else{?>
                            <span class="LocaitonName">Hotel Marriott Fairfield, Irving Texas.</span>
                            <span class="LocaitonBscDtls">110 Rooms.</span>
                            <?php }?>
                    ...
                    <div class="LcFllDtlsHldr">
                        <ul class="LcLst">
                            <li>
                                <div class="SrvcNm">
                                    <span class="NmeHldr_head Water">Utility Consumption</span>
                                </div>
                            </li>
                            <li>
                                <div class="SrvcNm">
                                ...
                                <div class="SrvcVluDtls">
                                    <span class="VluNmb"><?php echo $rainbow_main_data[$i]['water'] ?> gl</span>
                            ...
                            <li>
                                ...
                                <div class="SrvcVluDtls">
                                    <span class="VluNmb"><?php echo $rainbow_main_data[$i]['fuel'] ?> gl</span>
                            ...
                            <li>
                                <div class="SrvcNm">
                                    <span class="NmeHldr MedicalGas">LPG</span>
                                </div>
                                <div class="SrvcVluDtls">
                                    <span class="VluNmb"><?php echo $rainbow_main_data[$i]['gas'] ?> gl</span>
                            ...
                            <li>
                                <div class="SrvcNm">
                                    <span class="NmeHldr_head Water" style="margin-left: -68px;">Utility Cost Per Available Room($)</span>
                                </div>
                            </li>
                            
                            <li>
                                <div class="SrvcNm">
                                    <span class="NmeHldr"><?php echo $rainbow_main_data[$i]['inpatient'] ?></span>
                                </div>
                                <div class="SrvcVluDtls">
                                    <span class="VluNmb"> $/room</span>
                ...
                <div class="DtlsFllHld Offline">
                    <div class="LocationHldr">
                    <div class="LocationDtls">
                        <span class="LocaitonName">Hotel 3</span>
                        <span class="LocaitonBscDtls">133 Rooms.</span>
                    </div>
                    <div class="LocationLnkHldr">
                    ...
                    <div class="LcFllDtlsHldr">
                        ...
                        <li>
                            ...
                            <li>
                                <div class="SrvcNm">
                                    <span class="NmeHldr InPatient">66</span>
                                </div>
                                <div class="SrvcVluDtls">
                                    <span class="VluNmb"></span>
                                    <span class="VluDsc">$/room</span>
                                </div>
                                <div class="TtlTp">
                                    <div class="TtlTpLft">
                                        <span class="TxtHldr">
                ...
                <div class="DtlsFllHld Offline">
                    ...
                    <div class="LcFllDtlsHldr">
                        ...
                        <li>
                            ...
                            <li>
                                <div class="SrvcNm">
                                    <span class="NmeHldr">In Patient</span>
                                </div>
                                <div class="SrvcVluDtls">
