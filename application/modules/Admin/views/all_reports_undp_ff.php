				...
				<div class="FullReportDtlsHldr" id="content">
					...
					<?php 	
						...
						if($data['device']==41 && $data['report_type']==0){
							$this->load->view('reportcommon/energyconsumptionreport_undp_ff');						
					...
					<?php
						...
						if($data['device']==41 && $data['report_type']==1){							
							$this->load->view('graphreportcommon/energyconsumptiongraph_undp_ff');
							
							}
							if($data['device']==57 && $data['report_type']==1){							
								
								$this->load->view('graphreportcommon/energy_current_undp_ff');
								
								}
								if($data['device']==58 && $data['report_type']==1){							
									
									$this->load->view('graphreportcommon/energy_voltage_undp_ff');
									}
								if($data['device']==51 && $data['report_type']==1){
									$this->load->view('graphreportcommon/energypowerfactor_undp_ff');
