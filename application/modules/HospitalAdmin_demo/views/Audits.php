                ...
                <div class="TableHldr">
                    <table class="AppDataTbl">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/audit_Observations" class="DataLnk">View Observations</a>
                            </td>
                            <td>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/audit_Recommendations" class="DataLnk">View Recommendations</a>
                            </td>
                            <td>
