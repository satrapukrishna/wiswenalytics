...
<body>
    <div class="Header">
        ...
        <div class="LanguageOptns">
            <a href="<?php echo base_url(); ?>Hospital/washroom/1" class="LanguageOptns Actv">English</a>
            <a href="<?php echo base_url(); ?>Hospital/washroom/2" class="LanguageOptns Tel">తెలుగు</a>
    ...
    <div class="Container">
        <div class="ComplaintSelection">
            ...
            <div class="ComplaintCategories">
                ...
                <div class="CategoryHolder">
                    <a href="<?php echo base_url(); ?>Hospital/water" class="CatLink">
                        <img src="<?php echo base_url(); ?>asset/hospital/Images/Icn-Water.svg" class="CatImg" />
                        <span class="CatName">Water</span>
                    </a>
                </div>
                <div class="CategoryHolder">
                    <a href="<?php echo base_url(); ?>Hospital/equipment" class="CatLink">
                ...
                <div class="CategoryHolder">
                    <a href="<?php echo base_url(); ?>Hospital/tissue" class="CatLink">
                        <img src="<?php echo base_url(); ?>asset/hospital/Images/Icn-Tissues.svg" class="CatImg" />
                        <span class="CatName">Tissues</span>
                    </a>
                </div>
                <div class="CategoryHolder">
                    <a href="<?php echo base_url(); ?>Hospital/soap" class="CatLink">
                        <img src="<?php echo base_url(); ?>asset/hospital/Images/Icn-Soap.svg" class="CatImg" />
                        <span class="CatName">Soap</span>
                    </a>
                </div>
            </div>
        </div>
