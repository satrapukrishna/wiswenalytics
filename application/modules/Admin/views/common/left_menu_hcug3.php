            ...
            <div class="DshBrdLnkCntr" id="root" data-simplebar>
                ...
                <ul class="LnkHldr FrstLvl">
                    ...
                    <?php } ?>
						...
						<li>
							<a class="Lnk Arr Slct" href="#" onclick="menushow(509)" id="cat509"><img src="<?php echo site_url() ?>asset/admin/images/Switch-Control.png" width="20px"/> <span id="dsh" class="Lnk Arr Slct Dshbrd">Switch Control</span></a>
							<ul class="ScndLvl" id="subcat509" style="display: none;">
                            <?php if(modules::run('Admin/Site/authlink','switch status_Switch-Status')){ ?>
								 <li>
								 <a href="<?php echo site_url('Admin/Home/switchcontrol/')?>#swtch" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/Motor-SwitchControl.png" width="35px" style="margin-right:0px"/> <span class="Txt">Motor Switch Control</span></a>
								 </li>
                             <?php } ?> 
