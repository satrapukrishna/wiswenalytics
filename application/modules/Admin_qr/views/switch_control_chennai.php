    ...
    <div id="MnCtnr" class="DshMnCtnr">
        ...
        <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
				...
				<div class="bxslider556" id="bxid">
					...
					<span class="SctnTtl">Switch Status 01 </span>
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl">Switch Status 02 </span>
					<ul class="SctnDtlsGrdTbl">
						<li><div class="ClLft">Switch Status</div><div class="ClRgt">
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl">Switch Status 03 </span>
					<ul class="SctnDtlsGrdTbl">
						<li><div class="ClLft">Switch Status</div><div class="ClRgt">
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl">Switch Control 05 </span>
					<ul class="SctnDtlsGrdTbl">
						<li><div class="ClLft">Switch Status</div><div class="ClRgt">
