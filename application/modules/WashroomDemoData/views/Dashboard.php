        ...
        <div id="DshBrd" class="DshbordCntr">
            <div class="DshbrdHdr">
                <div class="row SctnSlctr" style="width: 100%;">
                    ...
                    <span class="SctnNm">
                        <a href="<?php echo site_url('WashroomDemoData/demoData') ?>" class="Lnk">Dashboard</a>
                    </span>
                    </div>
                    <div class="col-md-3" style="width: 10%;" id="links">
                    <span class="SctnNm">
...
$(function() {
  ...
  function fetchSodexoData()
  {
    ...
    console.log(today);
      ...
      var urlString = "<?php echo base_url(); ?>WashroomDemoData/getWashroomDashboardData";
      $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
  ...
  function displaySodexoData(data)
  {
      ...
      for (let d = 0; d < washroom_data.length; d++) {
        ...
        var urlString_water = "<?php echo base_url(); ?>WashroomDemoData/getWaterReportLive";
        $.ajaxQueue({
          url:urlString_water,
          type : 'GET',
          data:{
        ...
        var urlString_water = "<?php echo base_url(); ?>WashroomDemoData/getPowerDataLive";
        $.ajaxQueue({
          url:urlString_water,
          type : 'GET',
          data:{
        ...
        var urlStringOdour = "<?php echo base_url(); ?>WashroomDemoData/getOudorLevelMaleReportLiveDashboard";
        $.ajaxQueue({
          url:urlStringOdour,
          type : 'GET',
          data:{
        ...
        var urlStringOdour = "<?php echo base_url(); ?>WashroomDemoData/getOudorLevelFemaleReportLiveDashboard";
        $.ajaxQueue({
          url:urlStringOdour,
          type : 'GET',
          data:{
        ...
        var urlStringFootfall = "<?php echo base_url(); ?>WashroomDemoData/getFootfallMaleFemaleLive";
        $.ajaxQueue({
        ...
        var urlStringFeedback = "<?php echo base_url(); ?>WashroomDemoData/getFeedbackReportLive";
        $.ajax({
...
myEl.addEventListener('click', function() {
  var urlString = "<?php echo base_url(); ?>WashroomDemoData/getSodexoReportLive";
        $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
