            ...
            <div class="DshBrdSctn">
                ...
                <div class="DshBrdSctnDtls WhtBkgrnd FrPmp" id="fpump">
                         ...
                         <tr>
                            ...
                            <td class="Col-2">
                                <span class="Txt MblTtl">Running Status</span>
                                 <span class="Txt Stts Na" id="hjss"></span>
                               
                            </td>
                            <td class="Col-3">
                                <span class="Txt MblTtl">Switch Status</span>
                                <span class="Txt Stts Na" ></span>
                    ...
                    <div class="EnrgyMtrGuge">
                        <!-- <span class="Ttl" style=" float: center">Line Pressure</span> -->
...
function appendFirepumpDataData(data){
        ...
        $("#sjrht").text(d[0]["TodayRunn"]+(' Min'));
        $("#sjrhy").text(d[0]["YesterdayRunn"]+(' Min'));
        $("#sjrhl").text(d[0]["LastWeekRunn"]+(' Min'));

        $("#mhrht").text(d[1]["TodayRunn"]+(' Min'));
        $("#mhrhy").text(d[1]["YesterdayRunn"]+(' Min'));
        $("#mhrhl").text(d[1]["LastWeekRunn"]+(' Min'));

        $("#msrht").text(d[2]["TodayRunn"]+(' Min'));
        $("#msrhy").text(d[2]["YesterdayRunn"]+(' Min'));
        $("#msrhl").text(d[2]["LastWeekRunn"]+(' Min'));
