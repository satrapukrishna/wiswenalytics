                        ...
                        <ul class="ScndLvl" id="reportsInnerId">
                            <li>
                                ...
                                <ul class="ThrdLvl" id="dgsetinnerid">
                                    <li>
                                        <a href="<?php echo base_url(); ?>SpInfocityClient/chillerRunReport" class="Lnk Actv act"><span class="Txt">Running Hours Report</span></a>
                                    </li>
                                    <li>
