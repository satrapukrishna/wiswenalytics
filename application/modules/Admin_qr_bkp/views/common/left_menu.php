      ...
      <ul class="sidebar-menu">
		...
		<li class="treeview" id="hardware">
         ...
         <ul class="treeview-menu">
            ...
            <li><a href="<?php echo site_url('Admin_qr/Hardware_category'); ?>"><i class="fa fa-circle-o"></i> Manage Hardware Category</a></li>
			<li><a href="<?php echo site_url('Admin_qr/Hardware_category/device'); ?>"><i class="fa fa-circle-o"></i>Manage Hardware Device</a></li>
			<li><a href="<?php echo site_url('Admin_qr/Hardware_template'); ?>"><i class="fa fa-circle-o"></i>Manage Hardware Template</a></li>
			<?php }else{
				?>
