        ...
        <div id="DshbrdRgtCtnr" class="DshBrdCtnr">
			<div class="DshBrdSctn">
				<div class="DshBrdSctnDtls">
					<form name="reports" id="myForm" action="<?php echo site_url("Admin/Home/all_reports_lonavala")?>" method="post" onSubmit="return formValidation();">
						<div class=SrchFullBx>
							...
							<div class="SrchBtnHldr">
								...
								<a href="<?php echo site_url('Admin/Home/all_reports_lonavala') ?>" class="btn btn-info reset">Reset</a></span>
								...
								<input type="button" class="btn btn-info" name="exporttbl" id="exporttbl" onclick="exportTableToExcel('content')" value="ExportToExcel" />
				...
				<div class="FullReportDtlsHldr" id="content">
					...
					<?php
						...
						if($data['device']==36 && $data['report_type']==1){						
							$this->load->view('graphreportcommon/dgtrip')	;
...
function getsolutions(){
    ...
    $.ajax({
        ...
        url: BASE_URL+'Admin/Home/ajax_hardware_device_dropdown_lona/',
