...
<body onload="initialize()">
    <div class="AppMenu">
        ...
        <ul class="MenuList">
            <li>
                <a href="<?php echo base_url(); ?>HospitalAdmin/dashboard" class="AppMenuLnk Map">
                    <span class="LnkTxt">Map</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url(); ?>HospitalAdmin/complaintList" class="AppMenuLnk CmplntsFdbck Actv">
