...
$(function() {
  ...
  function fetchSodexoData()
  {
    ...
    console.log(today);
      ...
      var urlString = "<?php echo base_url(); ?>WashroomDemo2Data/getWashroomDashboardData";
      $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
  ...
  function displaySodexoData(data)
  {
      ...
      for (let d = 0; d < washroom_data.length; d++) {
        ...
        var urlString_water = "<?php echo base_url(); ?>WashroomDemo2Data/getWaterReportLive";
        $.ajaxQueue({
          url:urlString_water,
          type : 'GET',
          data:{
        ...
        var urlString_water = "<?php echo base_url(); ?>WashroomDemo2Data/getPowerDataLive";
        $.ajaxQueue({
          url:urlString_water,
          type : 'GET',
          data:{
        ...
        var urlStringOdour = "<?php echo base_url(); ?>WashroomDemo2Data/getOudorLevelMaleReportLiveDashboard";
        $.ajaxQueue({
          url:urlStringOdour,
          type : 'GET',
          data:{
        ...
        var urlStringOdour = "<?php echo base_url(); ?>WashroomDemo2Data/getOudorLevelFemaleReportLiveDashboard";
        $.ajaxQueue({
          url:urlStringOdour,
          type : 'GET',
          data:{
        ...
        var urlStringFootfall = "<?php echo base_url(); ?>WashroomDemo2Data/getFootfallMaleFemaleLive";
        $.ajaxQueue({
        ...
        var urlStringFeedback = "<?php echo base_url(); ?>WashroomDemo2Data/getFeedbackReportLive";
        $.ajax({
