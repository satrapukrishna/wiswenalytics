  ...
  <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="<?php echo site_url('Admin/Holiday_shift/create_shifts') ?>">Back</a></li>
                    </ol>
                </section>
                <!-- Main content -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                              ...
                              <form>
                                    ...
                                    <label class="col-md-2">Upload Shift List <span class="required_fields"></span></label>
                                        ...
                                        <div class="form-group">
                                             <div class="col-md-12 text-center"><br/><br/><br/><br/>
                                                ...
                                                <a data-toggle="tooltip"  title="Cancle" href="<?php echo site_url('Admin/Holiday_shift/create_shifts'); ?>" class="btn btn-default">Cancel</a>
                                             </div>
                                        </div>
                                </form>
