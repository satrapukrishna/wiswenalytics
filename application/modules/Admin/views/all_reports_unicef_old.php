        ...
        <div id="DshbrdRgtCtnr" class="DshBrdCtnr">
			<div class="DshBrdSctn">
				<div class="DshBrdSctnDtls">
					<form name="reports" id="myForm" action="<?php echo site_url("Admin/Home/all_reports_unicef_old")?>" method="post" onSubmit="return formValidation();">
						<div class=SrchFullBx>
							<h2 class="report-text">Reports(Please Select Date Before July 1st 2025)</h2>
							...
							<div class="SrchBtnHldr">
								...
								<a href="<?php echo site_url('Admin/Home/all_reports_unicef_old') ?>" class="btn btn-info reset">Reset</a></span>
