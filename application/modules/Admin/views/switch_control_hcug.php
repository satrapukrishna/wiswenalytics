...
<body >	
    <div id="MnCtnr" class="DshMnCtnr">
		...
		<?php if(modules::run('Admin/Site/authlink','switch status_Switch-Status9999')){ ?>
		<!-- energy meter -->
        <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
            ...
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
				...
				<?php for($k=0;$k<count($switch_status_data);$k++){ ?>
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl"><?php echo $switch_status_data[$k]['meter'] ?> </span>
					<ul class="SctnDtlsGrdTbl">
						<li><div class="ClLft">Status</div><div class="ClRgt">
                        <?php if($switch_status_data[$k]['status']==1){ ?>
							<span class="status-<?php echo $switch_status_data[$k]['status'] ?>">ON</span>
							<?php }else{ ?>
								<span class="status-<?php echo $switch_status_data[$k]['status'] ?>">OFF</span>
                        <?php }?>
                                      
                        </div></li>
						<li><div class="ClLft">Today Running Hours</div><div class="ClRgt"><?php echo $switch_status_data[$k]['todayrunn'] ?></div></li>
						<li><div class="ClLft">Yesterday Running Hours</div><div class="ClRgt"><?php echo $switch_status_data[$k]['yestrunn'] ?></div></li>
