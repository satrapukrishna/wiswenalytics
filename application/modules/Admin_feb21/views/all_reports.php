       ...
       <input type="hidden" id="page" value="runninggg" />
		...
		<div class="DshBrdSctn">
			...
			<div class="DshBrdSctnDtls"  style="background:#f3f3f3;height:50%">
				<form name="reports" id="myForm" action="<?php echo site_url("Admin_feb21/Home/all_reports")?>" method="post" onSubmit="return formValidation();">
              ...
              <option value="0">Sunday
						  ...
						  <button type="submit" id="filter" class="btn  filter-success">Filter</button>
							<a href="<?php echo site_url('Admin_feb21/Home/all_reports') ?>" class="btn btn-info reset">Reset</a>
