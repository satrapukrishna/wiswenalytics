    ...
    <section class="content">
     ...
     <div class="lds-ellipsis" id="loading" style="display: none;"><div></div><div></div><div></div><div></div></div>
      ...
      <div class="row" style="display: block;" id="report">
          ...
          <div class="row">
            ...
            <div class="col-md-6 text-center">
              ...
              <div class="delta">
                 ...
                 <div class="height-max">
              <div class="mini animated fadeInUp">
                <i class="fa fa-clock-o" aria-hidden="true"></i> <span class="total"> Consumption Runtime</span> :  <span id="consumption_run_1" class="count"></span>
              </div>
              <div class="mini animated fadeInUp">
          ...
          <div class="row">
            ...
            <div class="col-md-6 text-center">
              ...
              <div class="delta">
                 ...
                 <div class="height-max">
              <div class="mini animated fadeInUp">
                <i class="fa fa-clock-o" aria-hidden="true"></i> <span class="total"> Consumption Runtime</span> :  <span id="consumption_run_2" class="count"></span>
              </div>
              <div class="mini animated fadeInUp">
          ...
          <div class="row">
            ...
            <div class="col-md-6 text-center">
              ...
              <div class="delta">
                 ...
                 <div class="height-max">
              <div class="mini animated fadeInUp">
                <i class="fa fa-clock-o" aria-hidden="true"></i> <span class="total"> Consumption Runtime</span> :  <span id="consumption_run_3" class="count"></span>
              </div>
              <div class="mini animated fadeInUp">
          ...
          <div class="row">
            ...
            <div class="col-md-6 text-center">
              ...
              <div class="delta">
                 ...
                 <div class="height-max">
              <div class="mini animated fadeInUp">
                <i class="fa fa-clock-o" aria-hidden="true"></i> <span class="total"> Consumption Runtime</span> :  <span id="consumption_run_4" class="count"></span>
              </div>
              <div class="mini animated fadeInUp">
        ...
        <!-- fifth temp end -->
        <div class="col-md-5 hvac" id="hvac_4" style="display: none; padding: 15px;background: #fff;margin:7px 10px !important;">
          ...
          <div class="row">
            ...
            <div class="col-md-6 text-center">
              ...
              <div class="delta">
                 ...
                 <div class="height-max">
              <div class="mini animated fadeInUp">
                <i class="fa fa-clock-o" aria-hidden="true"></i> <span class="total"> Consumption Runtime</span> :  <span id="consumption_run_5" class="count"></span>
              </div>
              <div class="mini animated fadeInUp">
          ...
          <div class="row">
            ...
            <div class="col-md-6 text-center">
              ...
              <div class="delta">
                 ...
                 <div class="height-max">
              <div class="mini animated fadeInUp">
                <i class="fa fa-clock-o" aria-hidden="true"></i> <span class="total"> Consumption Runtime</span> :  <span id="consumption_run_6" class="count"></span>
              </div>
              <div class="mini animated fadeInUp">
