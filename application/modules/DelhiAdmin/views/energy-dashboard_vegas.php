...
<body >	
    <div id="MnCtnr" class="DshMnCtnr">
		...
		<!-- energy meter -->
            ...
            <!-- energy meter ends -->
            <?php } ?>
            <?php if(modules::run('DelhiAdmin/Site/authlink','energy_btu_meters')){ ?>
			<!-- Btu -->
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
			...
			<!---btu end --->
			<?php } ?>
			<?php if(modules::run('DelhiAdmin/Site/authlink','energy_Power-Supply')){ ?>
		<!-- energy meter -->
        <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
            ...
            <!-- energy meter ends -->
            <?php } ?>
            <?php if(modules::run('DelhiAdmin/Site/authlink','energy_DG')){ ?>
			<!-- dg start -->
				<div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
...
<!-- dg end -->
<?php } ?>
<?php if(modules::run('DelhiAdmin/Site/authlink','DG_Trip_Status')){ ?>
		<!-- energy meter -->
        <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
            ...
            <!-- energy meter ends -->
            <?php } ?>
<?php if(modules::run('DelhiAdmin/Site/authlink','energy_ups')){ ?>
<!-- UPS Start -->
            ...
            <!-- UPS End -->
            <?php } ?>
             <?php if(modules::run('DelhiAdmin/Site/authlink','lpg')){ ?>
			<!-- lpg -->
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
            ...
            <!-- LPG code -->
            <?php } ?>
			<?php if(modules::run('DelhiAdmin/Site/authlink','trip_status')){ ?>
             <!-- energy meter -->
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
            ...
            <!-- energy meter ends -->
            <?php } ?>
			<?php if(modules::run('DelhiAdmin/Site/authlink','diesel_tank')){ ?>
            <!-- energy meter -->
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
            ...
            <!-- energy meter ends -->
             <?php } ?>
			<?php if(modules::run('DelhiAdmin/Site/authlink','diesel_meters')){ ?>
            <!-- energy meter -->
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
...
<?php if(modules::run('DelhiAdmin/Site/authlink','energy_lpg')){ ?>
for (var i = 1; i < 2; i++) {
	var cnt='llpg'+i;
