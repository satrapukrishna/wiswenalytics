    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="active treeview">
          <a href="#"><a href="<?php echo site_url();?>Dashboard/dashboardView">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo site_url();?>HVACReports/tomotherapy"><i class="fa fa-circle-o"></i>HVAC Dashboard</a></li>
       ...
       <!--  <li class="treeview">
          <a href="#">
            <i class="fa fa-spinner"></i> <span>Reports</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
         <ul class="treeview-menu">
            <li class="active"><a href="<?php echo site_url();?>HVACTemperature/hvacTempView"><i class="fa fa-circle-o"></i>HVAC Report</a></li>
            <li class="active"><a href="<?php echo site_url();?>"><i class="fa fa-circle-o"></i>Boiler Report</a></li>
        ...
        <li class="treeview">
         ...
         <ul class="treeview-menu">
            ...
            <!-- <li class="active"><a href="<?php echo site_url();?>FuelReport/FuelReport/fuelConsumptionReport"><i class="fa fa-circle-o"></i>Consumption Report</a></li> -->
             ...
             <li class="active"><a href="<?php echo site_url();?>FuelReport/getFuelAddedView"><i class="fa fa-circle-o"></i>Fuel Added Report</a></li>
             <li class="active"><a href="<?php echo site_url();?>HVACReports/hvacReport"><i class="fa fa-circle-o"></i>HVAC Graph Report</a></li>
          </ul>
        </li>
