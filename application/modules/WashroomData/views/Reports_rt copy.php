...
function appendData_consolidated(obj){
  ...
  function appendData_consolidated_footfall(obj){
    $("#consolidated_tab_cfootfall tbody").empty();
       ...
       for (var i = 0; i < obj.length; i++) 
       {
        for (let b = 0; b < obj[i].length; b++) {
          rows += "<tr><td>" + b + "</td><td>" +obj[i][b]['location'] + "</td><td>" +obj[i][b]['date'] + "</td><td>" + obj[i][b]['open'] + "</td><td>" + obj[i][b]['time'] + "</td><td>NN</td><td>NN</td></tr>"; 
  ...
  function appendData_consolidated_footfall_bkp2(obj){
    $("#consolidated_tab_cfootfall tbody").empty();
