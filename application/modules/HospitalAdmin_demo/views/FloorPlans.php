        ...
        <div class="ContainerLeft">
            ...
            <div class="SctnInnerLnks">
                <ul class="InnrLnksHldr">
                    <li>
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/floorPlans" class="LnkTxt FlrPln Icn Actv">Floor Plan</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/fireEvacuationPlans" class="LnkTxt FrExPln Icn">Fire Evacuation Plan</a>
                    </li>
                </ul>
            </div>
        </div>
