        ...
        <div class="DshBrdLnk">
            ...
            <div class="DshBrdLnkCntr">
                <ul class="LnkHldr FrstLvl">
                    <li>
                        <a href="" class="Lnk Arr Slct Dshbrd"><span id="leftsideNavCollapseAll" class="Txt">Dashboard</span></a>
                        <ul class="ScndLvl Active" id="expandAll">
                            <li>
                                <a href="<?php echo base_url(); ?>/PRKHospital/getRunningHours" class="Lnk Arr Slct WtrTnk"><span class="Txt">Water Tank</span></a>
                            </li>
                            <li>
...
<script type="text/javascript">
    ...
    $('#leftsideNavCollapseAll').click(function(event) {
        $('#expandAll').hide();
            // alert("hello");   
    });
