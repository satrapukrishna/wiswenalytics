				...
				<?php /*for ($i=0; $i < count($dg_data['chk']); $i++) 
					...
					<div class="SldrCntnr">
						<div class="SctnDtls DGGnrtrHldr">
							...
							<div class="DGCol-1">
							<div class="SctnTtl_main">
							<span class="SctnTtl"><?php echo $dg_data['chk'][$i]['dgname']; ?></span><br>
							<span style="font-size:12px;color:#ab9f9f;padding:10px">Diesel Generator
							<span class="SctnTtl_buttn">
							<button>AUTO</button>
														
							<button class="button_red"><?php echo $dg_data['chk'][$i]['status']; ?></button>
							...
							<ul class="SctnDtlsGrdTbl">
							<li><div class="ClLft">Running Hours</div><div class="ClRgt"><?php echo $dg_data['chk'][$i]['run']; ?></div></li>
							<li><div class="ClLft">Fuel Consumption</div><div class="ClRgt"><?php echo $dg_data['chk'][$i]['fconsume']; ?></div></li>
							<li><div class="ClLft">Available Fuel </div><div class="ClRgt"><?php echo $dg_data['chk'][$i]['availableFuel']; ?></div></li>
							<li><div class="ClLft">Filled % </div><div class="ClRgt"><?php echo $dg_data['chk'][$i]['filledper']; ?></div></li>
							<li><div class="ClLft">Fuel Added</div><div class="ClRgt"><?php echo $dg_data['chk'][$i]['fadd']; ?></div></li>
							<li><div class="ClLft">Fuel Removed</div><div class="ClRgt"><?php echo $dg_data['chk'][$i]['fremove']; ?></div></li>
							 <li><div class="ClLft">Economy</div><div class="ClRgt"><?php echo $dg_data['chk'][$i]['economy']; ?></div></li>
							 <li><div class="ClLft">Voltage</div><div class="ClRgt"><?php echo $dg_data['chk'][$i]['voltage']; ?></div></li>
							</ul>
							</div>
							...
							<div class="LiquidTank Smll">
								...
								<div class="Liquid l-<?php echo round($dg_data['chk'][$i]['filledper']); ?>"></div>
							...
							<div>
							<div id="chkdg<?php echo $i; ?>" style="width:400px"></div>
							</div>
