                                    ...
                                    <form role="form" class="form-horizontal" action="" method="get">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3 seach-button">
                                                ...
                                                &nbsp;<a href="<?php echo site_url('Admin_qr/Hardware_category/device') ?>" class="btn btn-default">Clear</a>
                                            ...
                                            <?php //if(modules::run('admin/site/authlink','client_edit')){ ?>
                                                ...
                                                <div class="seach-button">
													...
													<a href="<?php echo site_url('Admin_qr/Hardware_category/create_category') ?>" class="btn btn-success">Add Hardware Device</a>
                                        ...
                                        if (!empty($hardware_category1)) {
                                            ...
                                            foreach ($hardware_category1 as $row) {  ?>
                                                ...
                                                <tr id="sp<?php echo $row->device_id; ?>">
													...
													if($row->status==1){ 
													?>
													<a href="<?php echo site_url('Admin_qr/Hardware_category/status_change1/' . $row->device_id.'/0') ?>" title="Active" class="btn btn-success btn-xs"><span>Active</span></a>
													<?php 
													}else{
														?>
														<a href="<?php echo site_url('Admin_qr/Hardware_category/status_change1/' . $row->device_id.'/1') ?>" title="Inactive" class="btn btn-warning btn-xs"><span>Inactive</span></a>
														<?php
														}
														?></td>
                                                    ...
                                                    <td>
                                                            ...
                                                            <?php //if(modules::run('admin/site/authlink','employee_modify')){ ?>
																...
																<a href="<?php echo site_url('Admin_qr/Hardware_category/view_device/' . $row->device_id) ?>" title="View Device" class="btn btn-info btn-xs"><span class="fa fa-eye"></span></a>


                                                                <a href="<?php echo site_url('Admin_qr/Hardware_category/edit_device/' . $row->device_id) ?>" title="Edit Device" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-pencil"></span></a>
...
<script>
	function removeCategory(categoryId){
		...
		if(ans){
			$.ajax({
				url: BASE_URL+'Admin_qr/Hardware_category/remove_category/'+categoryId,
				dataType: 'text',
	...
	function removeDevice(deviceId){
		...
		if(ans){
			$.ajax({
				url: BASE_URL+'Admin_qr/Hardware_category/remove_device/'+deviceId,
				dataType: 'text',
				success: function(data){
					if(data == 1){
						$("#dp"+deviceId).fadeOut();
