...
class Upload_model extends CI_Model {    
    ...
    function buildAmazonUploadConfig($f_type) {
        ...
        switch ($f_type) {
		 ...
		 case "partner_doc" :
            ...
            case "scheduled_doc" :
                    ...
                    $config_upload['upload_to'] = 'asset/admin/scheduled_doc';
    
    
                    $config_upload['upload_path'] = 'asset/admin/scheduled_doc';
		...
		case "device_icon" :
				...
				$config_upload['upload_to'] = 'asset/admin/img';


                $config_upload['upload_path'] = 'asset/admin/img';
			...
			case "installation_pic":
                 ...
                 $config_upload['upload_to'] = 'asset/admin/installation_pic';


                $config_upload['upload_path'] = 'asset/admin/installation_pic';
