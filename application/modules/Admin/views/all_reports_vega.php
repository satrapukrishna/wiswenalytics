        ...
        <div id="DshbrdRgtCtnr" class="DshBrdCtnr">
			<div class="DshBrdSctn">
				<div class="DshBrdSctnDtls">
					<form name="reports" id="myForm" action="<?php echo site_url("Admin/Home/all_reports_vega")?>" method="post" onSubmit="return formValidation();">
						<div class=SrchFullBx>
							...
							<div class="SrchBtnHldr">
								...
								<a href="<?php echo site_url('Admin/Home/all_reports_vega') ?>" class="btn btn-info reset">Reset</a></span>
						...
						if($data['device']==41 && $data['report_type']==1){							
							...
							if($data['device']==57 && $data['report_type']==1){							
								...
								if($data['device']==16 && $data['report_type']==1){
									$this->load->view('graphreportcommon/ahugraph_vega');
