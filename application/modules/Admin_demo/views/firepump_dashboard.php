			...
			<div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
                ...
                <div class="DshBrdSctnDtls WhtBkgrnd FrPmp device devicebox1111" id="devicebox1111">
					...
					<div class="fire_sub">
						...
						<li><div class="ClLft">Current Level</div><div class="ClRgt">200KL</div></li>
						<li><div class="ClLft">Filled</div><div class="ClRgt">100%</div></li>
						</ul>
						</div>
						</div>
						</div>
 ...
 -->                </div>
            ...
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
                <div class="DshBrdSctnTtl" id="borewell">
                    <span class="TxtTtl imageadd"><img src="<?php echo site_url() ?>asset/demoforall/Images/borewell_s.png" width="40" />BOREWELLS</span>
				...
				<div class="bxslider556" id="bxid">
					...
					<ul class="SctnDtlsGrdTbl">
						<?php /*<li><div class="ClLft">Motor Status</div><div class="ClRgt">
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl">Borewell 03 </span>
					<ul class="SctnDtlsGrdTbl">
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl">Borewell 04 </span>
					<ul class="SctnDtlsGrdTbl">
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl">Borewell 05 </span>
					<ul class="SctnDtlsGrdTbl">
