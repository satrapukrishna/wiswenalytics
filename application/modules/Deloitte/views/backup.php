...
<body onload="fetchSodexoData()">
    <div class="Wrapper">
        ...
        <div id="DshBrd" class="DshbordCntr">
            <div class="DshbrdHdr">
                ...
                <div class="SctnSrch" style="display: none;" id="reportsid">
                    <ul class="SrchLst">
                        ...
                        <li>
                            <input type="button" class="Btn" value="Go" onclick="getSodexoReport()";/>
                        </li>
                    </ul>
            ...
            <!-- reports ui hari code starts -->
            <!-- <div id="reportsid" style="display: none;">
               Select Location:<input type="text" name="loc" id="loc" />
            </div> -->
            <!-- reports ui hari code ends  -->
        </div>
