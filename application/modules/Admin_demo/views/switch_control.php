    ...
    <div id="MnCtnr" class="DshMnCtnr">
        ...
        <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
                <div class="DshBrdSctnTtl" id="swtch">
                    <span class="TxtTtl imageadd"><img src="<?php echo site_url() ?>asset/admin/images/Switch-Control-Clr.png" width="40" />Switch Controls</span>
				...
				<h4 class="head-h4">Tower A</h4>
				<div class="bxslider556" id="bxid">
				<?php foreach($switchcontrol_data['Tower-A'] as $rec){ ?>
					<div style="width:320px">
					<div class="SctnDtlsHldr">
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl"><?php echo $rec['hardware_name']; ?> <br> Emergency DB</span>
					<!-- <span class="SctnTtl">Emergency DB </span> -->
					<ul class="SctnDtlsGrdTbl">
						<li><div class="ClLft">Switch Status</div><div class="ClRgt">
                        
                            <span class="status-<?php echo $rec['emergency_status']; ?>"><?php echo strtoupper($rec['emergency_status']); ?></span>
                                      
                        </div></li>
						<!-- <li><div class="ClLft">On Hours</div><div class="ClRgt"><?php echo $rec['onhours']; ?></div></li>
						<li><div class="ClLft">Off Hours</div><div class="ClRgt"><?php echo $rec['offhours']; ?></div></li> -->
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl"><?php echo $rec['hardware_name']; ?> <br>Non Emergency DB</span>
					<ul class="SctnDtlsGrdTbl">
						<li><div class="ClLft">Switch Status</div><div class="ClRgt">
                        
						<span class="status-<?php echo $rec['non_emergency_status']; ?>"><?php echo strtoupper($rec['non_emergency_status']); ?></span>
				...
				<h4 class="head-h4">Tower B</h4>
				<div class="bxslider556" id="bxid">
				<?php foreach($switchcontrol_data['Tower-B'] as $rec){ ?>
					<div style="width:320px">
					<div class="SctnDtlsHldr">
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					...
					<h4 class="head-h4">Tower C</h4>
				<div class="bxslider556" id="bxid">
				<?php foreach($switchcontrol_data['Tower-C'] as $rec){ ?>
					<div style="width:320px">
					<div class="SctnDtlsHldr">
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
            ...
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
                <div class="DshBrdSctnTtl" id="swimm">
                    <span class="TxtTtl imageadd"><img src="<?php echo site_url() ?>asset/admin/images/Swimming-Pool-Clr.png" width="40" />Swimming Pool Controls</span>
				...
				<div class="bxslider555" id="bxid">
					...
					<ul class="SctnDtlsGrdTbl">
						...
						<li><div class="ClLft">On Hours</div><div class="ClRgt">12:20:40</div></li>
						<li><div class="ClLft">Off Hours</div><div class="ClRgt">11:40:00</div></li>
					...
					<ul class="SctnDtlsGrdTbl">
						...
						<li><div class="ClLft">On Hours</div><div class="ClRgt">13:25:40</div></li>
						<li><div class="ClLft">Off Hours</div><div class="ClRgt">10:35:00</div></li>
            ...
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
                <div class="DshBrdSctnTtl" id="msc">
                    <span class="TxtTtl imageadd"><img src="<?php echo site_url() ?>asset/admin/images/Motor-SwitchControl-Clr.png" width="40" />Motor Switch Controls</span>
				...
				<div class="bxslider555" id="bxid">
					...
					<ul class="SctnDtlsGrdTbl">
						...
						<li><div class="ClLft">On Hours</div><div class="ClRgt">13:30:00</div></li>
						<li><div class="ClLft">Off Hours</div><div class="ClRgt">10:30:00</div></li>
					...
					<ul class="SctnDtlsGrdTbl">
						...
						<li><div class="ClLft">On Hours</div><div class="ClRgt">15:25:00</div></li>
						<li><div class="ClLft">Off Hours</div><div class="ClRgt">8:35:0</div></li>
...
<div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
                <div class="DshBrdSctnTtl" id="lac">
                    <span class="TxtTtl imageadd"><img src="<?php echo site_url() ?>asset/admin/images/Lighting-Automation-Clr.png" width="40" />Lighting Automation</span>
				...
				<div class="bxslider555" id="bxid">
					...
					<ul class="SctnDtlsGrdTbl">
						...
						<li><div class="ClLft">On Hours</div><div class="ClRgt">05:40:40</div></li>
						<li><div class="ClLft">Off Hours</div><div class="ClRgt">18:20:00</div></li>
					...
					<ul class="SctnDtlsGrdTbl">
						...
						<li><div class="ClLft">On Hours</div><div class="ClRgt">10:00:00</div></li>
						<li><div class="ClLft">Off Hours</div><div class="ClRgt">14:00:00</div></li>
