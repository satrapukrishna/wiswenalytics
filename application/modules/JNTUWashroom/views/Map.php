...
var branhurl = "<?php echo base_url(); ?>JNTUWashroom/getBranches";
            $.ajax({
            url:branhurl,
            type : 'GET',
            async: true,
...
function showLocation(stationid,lat,lng){
    var today = new Date();
        ...
        today = yyyy + '-' + mm + '-' + dd;
    var urlString = "<?php echo base_url(); ?>JNTUWashroom/getWashroomDataIndividual";
        $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
...
function addpopup(data,lat,lng){
    ...
    function LoadMap() {
        ...
        function add(t) {
            var urlString = "<?php echo base_url(); ?>JNTUWashroom/getBranches";
            $.ajax({
            url:urlString,
            type : 'GET',
            async: true,
