  ...
  var selectedVal = $("#multiselect").val();
	...
	<?php //$rep=$data['report']; ?>
	 ...
	 //alert(type);
		...
		if(category==4){
			var div='<select name="device" class="form-control chosen-select" id="device" name="device"><option value="" >Select Report</option><option value="61" <?php echo ($sol=='61'?'selected':'');?>>Fuel Consumption</option>		<option value="62" <?php echo ($sol=='62'?'selected':'');?>>Fuel Added</option></select>';
			 $("#solution").html(div);
             $("#solution").trigger("chosen:updated");
...
function getSolution(){
		...
		if(category==4){
			var div='<select name="device" class="form-control chosen-select" id="device" name="device"><option value="" >Select Report</option><option value="61" >Fuel Consumption</option>		<option value="62" >Fuel Added</option></select>';
			 $("#solution").html(div);
             $("#solution").trigger("chosen:updated");
