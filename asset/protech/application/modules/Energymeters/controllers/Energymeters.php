...
class Energymeters extends CI_Controller
{
    ...
    {
        //$this->load->model('EnergyMeterModel');
        $meters = $this->Energymetermodel->getEnergymetersList();
        //print($meters);die();
    ...
    {
        $meters = $this->Energymetermodel->getEnergymetersLoadList();
                   ...
                   // print_r($res);die();
                    ...
                    foreach ($data['meters'] as $meters) 
                    {
                        ...
                        foreach ($days as  $value) {
                            ...
                            //print_r($final);die();
                            if(isset($final[0])){
                                $maxarray['values'][$k] =  $final[0]->Consumption;
