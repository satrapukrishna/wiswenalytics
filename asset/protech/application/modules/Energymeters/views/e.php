  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div style="margin-bottom: 12px;">
        ...
        <select  id="fromtime" style="height: 30px;border: 1px solid #ccc;border-radius: 3px;">
        ...
        <select  id="totime" style="height: 30px;border: 1px solid #ccc;border-radius: 3px;">
        ...
        <input type="date" name="" id="fromdate" placeholder="from" style="height: 30px;border: 1px solid #ccc;border-radius: 3px;">
        <input type="date" name="" id="todate" placeholder="to" style="height: 30px;border: 1px solid #ccc;border-radius: 3px;">
        <button type="button" onclick="getEnergyMeterLoadReport()"; class="btn btn-success">Filter</button>
...
<script type="text/javascript">
  ...
  function drawgraph(data,c){
    ...
    var chartdata = "<div class='col-md-12' id="+"'"+repdiv+"'"+" style='display: block'>";
    chartdata += "<div class='box box-info'><div class='box-header with-border'><h3 class='box-title'>Report :<span id="+"'"+metername+"'"+"></span></h3></div>";
    chartdata += "<div class='vl box-body'><i class='fa fa-chevron-up' aria-hidden='true'></i><p>Load</p></div>";
    chartdata += "<div class='chart'><canvas id="+"'"+canvasname+"'"+" style='height:290px !important'></canvas></div";
    chartdata += "<div class='hl'><i class='fa fa-chevron-right' aria-hidden='true'></i><p>Time</p></div></div></div>";
  ...
  function getEnergyMeterLoadReport(){
    ...
    if(valid){
      ...
      for (var j = 0; j < noofmeters; j++) {
        ...
        var urlString = "getenergyMeterLoadReport";
        $.ajaxQueue({
          url:urlString,
          type : 'GET',
          async: true,
