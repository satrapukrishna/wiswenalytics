	...
	function get_hardwares_device_data_hydro($data){
       ...
       // $todayDate='2020-07-11';
		...
		for ($p=0; $p < count($firepumps); $p++) { 
			...
			$pressure="SELECT round(CurReading*Multiplier,2) as pressure,TxnTime FROM $table_name_live where UtilityName='PressureMonitor' and LocationName='Hyd.Pneu.System' and StationId='".$station_id."' and TxnDate='".$todayDate."'  ORDER BY TxnTime desc limit 1 ";
			$pressuredata = $this->db->query($pressure)->result_array();
