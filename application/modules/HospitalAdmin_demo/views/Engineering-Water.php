        ...
        <div class="ContainerLeft">
            ...
            <div class="SctnInnerLnks">
                <ul class="InnrLnksHldr">
                    <li>
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_Water" class="LnkTxt Icn EnggWtr Actv">Water</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_AirQuality" class="LnkTxt Icn EnggArQlty">Air Quality</a>
                    </li>
                    <li>
            ...
            <div class="SctnDtlsTtlHldr">
                <div class="BrcmnbHldr">
                    <ul class="DtlsBrdCrmb">
                        <li>
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering" class="BrdCrmLnk">All Engineering</a>
                        </li>
                        <li>
