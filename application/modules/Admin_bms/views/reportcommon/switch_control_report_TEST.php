...
<table class="RprtTbl" id="list">
			...
			<th colspan='11' >Switch Control Twoer A Running Report</th> 
			</tr>
	<tr>
		<th>S. No.</th>
		<th>Meter</th>
	...
	<?php for($k=0;$k<count($switchcontrol_data['Tower-A']);$k++){ 
		...
		<tr>
			...
			<!-- <td>Tower A</td> -->
			<td><?php echo $switchcontrol_data['Tower-A'][$k][$i]['date']."/".date('l', strtotime($switchcontrol_data['Tower-A'][$k][$i]['hardware_name'])); ?></td>
	...
	<tr> 
			...
			<th colspan='11' >Switch Control Twoer B Running Report</th> 
			</tr>
	...
	<?php for($k=0;$k<count($switchcontrol_data['Tower-B']);$k++){ 
		...
		<tr>
			...
			<!-- <td>Tower A</td> -->
			<td><?php echo $switchcontrol_data['Tower-B'][$k][$i]['date']."/".date('l', strtotime($switchcontrol_data['Tower-B'][$k][$i]['hardware_name'])); ?></td>
	...
	<tr> 
			...
			<th colspan='11' >Switch Control Twoer C Running Report</th> 
			</tr>
	...
	<?php for($k=0;$k<count($switchcontrol_data['Tower-C']);$k++){ 
		...
		<tr>
			...
			<!-- <td>Tower A</td> -->
			<td><?php echo $switchcontrol_data['Tower-C'][$k][$i]['date']."/".date('l', strtotime($switchcontrol_data['Tower-C'][$k][$i]['hardware_name'])); ?></td>
