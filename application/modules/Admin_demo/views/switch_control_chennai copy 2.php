    ...
    <div id="MnCtnr" class="DshMnCtnr">
        ...
        <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
				...
				//echo json_encode($res1[0]);die();
					...
					<span class="SctnTtl">Power Supply</span>
					
					<ul class="SctnDtlsGrdTbl">
						<li><div class="left"></div><div class="right">Main Supply</div> <div class="right">DG Supply</div></li>
						<li><div class="left">R Phase</div>
						    <div class="right">                        
                            <span class="status-<?php echo $res['Mains']['rphase'] ?>"><?php echo strtoupper($res['Mains']['rphase']) ?></span>
                        	</div>
							<div class="right"><span class="status-<?php echo $res['DG Room']['rphase'] ?>"><?php echo strtoupper($res['DG Room']['rphase']) ?></span></div>
						</li>
						<li>
							<div class="left">Y Phase</div>
							<div class="right">
								<span class="status-<?php echo $res['Mains']['yphase'] ?>"><?php echo strtoupper($res['Mains']['yphase']) ?></span>
							</div>
							<div class="right"><span class="status-<?php echo $res['DG Room']['yphase'] ?>"><?php echo strtoupper($res['DG Room']['yphase']) ?></span></div>
						</li>
						<li><div class="left">B Phase</div>
						    <div class="right">
								<span class="status-<?php echo $res['Mains']['bphase'] ?>"><?php echo strtoupper($res['Mains']['bphase']) ?></span>
							</div>
							<div class="right"><span class="status-<?php echo $res['DG Room']['bphase'] ?>"><?php echo strtoupper($res['DG Room']['bphase']) ?></span></div>
						</li>
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl"><?php echo $res1[$i]['meter'] ?> </span>
					<ul class="SctnDtlsGrdTbl">
