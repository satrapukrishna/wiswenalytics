              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  ...
                  <div id="div_0" style="display: none">
                    <h3 class="box-title">Status :<span id="status_0"></span></h3>
                  </div>
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  ...
                  <div id="div_1" style="display: none">
                   <h3 class="box-title">Status :<span id="status_1"></span></h3>
                 </div>
                </div>
                <div class="vl box-body">
                    <i class="fa fa-chevron-up" aria-hidden="true">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  ...
                  <div id="div_2" style="display: none">
                   <h3 class="box-title">Status :<span id="status_2"></span></h3>
                 </div>
                </div>
                <div class="vl box-body">
                    <i class="fa fa-chevron-up" aria-hidden="true">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  ...
                  <div id="div_3" style="display: none">
                   <h3 class="box-title">Status :<span id="status_3"></span></h3>
                 </div>
                </div>
                <div class="vl box-body">
                    <i class="fa fa-chevron-up" aria-hidden="true">
            ...
            <div class="col-md-12" id="rep_4" style="display: none">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title">Status :<span id="status_4"></span></h3>
                </div>
                </div>
                <div class="vl box-body">
                    <i class="fa fa-chevron-up" aria-hidden="true">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  ...
                  <div id="div_5" style="display: none">
                   <h3 class="box-title">Status :<span id="status_5"></span></h3>
                 </div>
                </div>
                <div class="vl box-body">
                    <i class="fa fa-chevron-up" aria-hidden="true">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  ...
                  <div id="div_6" style="display: none">
                   <h3 class="box-title">Status :<span id="status_6"></span></h3>
                 </div>
                </div>
                <div class="vl box-body">
                    <i class="fa fa-chevron-up" aria-hidden="true">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  ...
                  <div id="div_7" style="display: none">
                   <h3 class="box-title">Status :<span id="status_7"></span></h3>
                 </div>
                </div>
                <div class="vl box-body">
                    <i class="fa fa-chevron-up" aria-hidden="true">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  ...
                  <div id="div_8" style="display: none">
                   <h3 class="box-title">Status :<span id="status_8"></span></h3>
                 </div>
                </div>
                <div class="vl box-body">
                    <i class="fa fa-chevron-up" aria-hidden="true">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  ...
                  <div id="div_9" style="display: none">
                   <h3 class="box-title">Status :<span id="status_9"></span></h3>
                 </div>
                </div>
                <div class="vl box-body">
                    <i class="fa fa-chevron-up" aria-hidden="true">
  ...
  function drawgraph(data,c){
    ...
    span.innerHTML = repData['input']['meter'];
     ...
     if(minvalues.length>1){
      ...
      var span1 = document.getElementById(status);
      span1.innerHTML ="No Data";
    }
       ...
       tooltips: {
                ...
                callbacks: {
                    beforeFooter: function(tooltipItems, data) { 
                      return 'MaxLoadTime: ' + footerLine1[tooltipItems[0].index];
                    },
                    footer: function(tooltipItems, data) { 
                      return 'MinLoadTime: ' + footerLine2[tooltipItems[0].index];
                    }
                }
            },
      scales: {
