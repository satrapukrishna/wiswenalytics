        ...
        <div id="DshbrdRgtCtnr" class="DshBrdCtnr">
			<div class="DshBrdSctn">
				<div class="DshBrdSctnDtls">
					<form name="reports" id="myForm" action="<?php echo site_url("DelhiAdmin/Home/all_reports_vega")?>" method="post" onSubmit="return formValidation();">
						<div class=SrchFullBx>
							...
							<div class="SrchBtnHldr">
								...
								<a href="<?php echo site_url('DelhiAdmin/Home/all_reports_vega') ?>" class="btn btn-info reset">Reset</a></span>
								...
								<input type="button" class="btn btn-info" style="margin-left:3px;" onclick="exportTableToExcel('list','')" value="Export TO Excel" id="tblexport" name="tblexport" />
							</div>
						</div>
					</form>
				</div>
				...
				<div class="FullReportDtlsHldr" id="content">
					...
					<?php 	
						...
						if($data['device']==41 && $data['report_type']==0){
							$this->load->view('reportcommon/energyconsumptionreport_vegas');						
					...
					<?php
						...
						if($data['device']==41 && $data['report_type']==1){							
							$this->load->view('graphreportcommon/energyconsumptiongraph_vegas');
...
function getsolutions(){
    ...
    $.ajax({
        ...
        url: BASE_URL+'DelhiAdmin/Home/ajax_hardware_device_dropdown_vega/',
...
function getdevices(){
    ...
    $.ajax({
        ...
        url: BASE_URL+'DelhiAdmin/Home/ajax_hardware_dropdown/',
        success: function (data){
...
function getreports7(){
	...
	$.ajax({
        ...
        url: BASE_URL+'DelhiAdmin/Home/ajax_report_dropdown/',
        success: function (data){
			//alert(data);return false;
            $("#report").html(data);
