                                        ...
                                        <div class="SctnDtls IOQFtr">
                                            ...
                                            <div class="FtrDts">
                                                ...
                                                <div class="FtrDrtn">
                                                    ...
                                                    <input class="FtrInpt" id="cot" value="" readonly />
...
var d = JSON.parse(data);
$("#temp").text(d[0]["temp"]+(' ℃'));
$("#hmd").text(d[0]["humidity"]+(' %RH'));
$("#co").text(('350 ppm'));
//$("#co").text(d[0]["co2"]+('ppm'));
$("#temptext").val(d[0]["temp"]+(' ℃'));
$("#hmdtext").val(d[0]["humidity"]+(' %RH'));
$("#cot").val(('350 ppm'));
   ...
   // var ydataco = new Array();
    var ydataco=[300,321,344,350,360,380,400.6, 400.8, 380.5,350]
    ...
    { 
        ...
        ydatahmd[i] = parseFloat(d[1]['hmd'][i]['CurReading'])/10; 
...
Highcharts.chart('container_hmd1', {
        chart: {
            type: 'line'
        },
        title: {
...
var d = JSON.parse(data);
var t=parseFloat(d[0]["Consumption"])*10;
