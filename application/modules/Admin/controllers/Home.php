...
// print_r($hardwares);die();
	...
	public function energy_terotam()
	{
		...
		// echo json_encode($hardwares['Energy Meter']['hardaware_list']);die();
			if(isset($hardwares['Energy Meter']['hardaware_list'][0])){
				...
				$data['energydat_over_consumption_monthly']=$this->Api_data_model_tero->get_hardwares_device_data_energymeter_report_terotam_overconsumption_dashboard_monthly($hardwares['Energy Meter']['hardaware_list'][0],date("Y-m-d"),date("Y-m-d"));
			...
			// echo json_encode($data['energydat_over_consumption_monthly']);die();
	...
	function all_reports_chennai(){
		...
		$this->load->model('Hardware_category_model');
		$this->load->model('Api_reports_data_model');
		$data['category'] = array('' => 'Select Category') + $this->Hardware_category_model->get_hardware_category_dropdown_all();
		$device_id=$this->input->post('report');
		$data['radio']=$this->input->post('report_type');
		$data['m1']=$device_id;
