...
<body onload="fetchSodexoData()">
    <div class="Wrapper">
        <div class="Header">
            ...
            <div class="UserMenu">
            <a href="<?php echo base_url(); ?>Login/wshrmmntrlogout"><img class="SgnOt" src="<?php echo base_url(); ?>/asset/ambienceasset/images/MenuLogout-W.png"></a>
 ...
 <div class="lds-ellipsis" id="loading1" style="display: none;"><div></div><div></div><div></div><div></div></div>
            ...
            <!-- head -->
            <div class="CntntDtls Hdr" id="sodexodatahead"><div class="Frst Hdr"><span class="MnTtl">Dashboard</span></div><div class="Dtls Hdr"><img src="<?php echo base_url(); ?>/asset/ambienceasset/asset/Images/Blank.png" class="HdrImg RFID" /><span class="HdrTtl">RFID Janitor Attendance</span></div><div class="Dtls Hdr"><img src="<?php echo base_url(); ?>/asset/ambienceasset/asset/Images/Blank.png" class="HdrImg Stink" /><span class="HdrTtl">Odour Right</span></div><div class="Dtls Hdr"><img src="<?php echo base_url(); ?>/asset/ambienceasset/asset/Images/Blank.png" class="HdrImg Stink" /><span class="HdrTtl">Odour Left</span></div><div class="Dtls Hdr"><img src="<?php echo base_url(); ?>/asset/ambienceasset/asset/Images/Blank.png" class="HdrImg Footfall" /><span class="HdrTtl">Footfall Sensor</span></div><div class="Dtls Hdr Lst"><img src="<?php echo base_url(); ?>/asset/ambienceasset/asset/Images/Blank.png" class="HdrImg Feedback" /><span class="HdrTtl">Feedback Buttons</span></div></div>
            <div id="sodexodata"></div>
            <!-- end head -->
