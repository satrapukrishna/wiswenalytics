        ...
        <div class="ContainerLeft">
            ...
            <div class="SctnInnerLnks">
                ...
                <ul class="InnrLnksHldr">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/complaintList" class="LnkTxt">Complaints Admin</a>
                    </li>
                    <!-- <li>
                        <a href="<?php //echo base_url(); ?>HospitalAdmin_demo/complaintReports" class="LnkTxt">Complaints Reports</a>
                    </li> -->
                    <li>
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/complaintAttendence" class="LnkTxt Actv">Attendence</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="InnrPgBgHldr">
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/complaintDetReports" class="FtrTtl"><span class="LnkTxt">Engineering Staff</span></a>
                    </div>
                ...
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/complaintDetReports" class="FtrTtl"><span class="LnkTxt">HVAC</span></a>
                    </div>
                    <div class="StffAttndDshbHldr">
                        <div class="StffBscDtls">
                            <div class="StffImgHldr">
                ...
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/complaintDetReports" class="FtrTtl"><span class="LnkTxt">Plumber</span></a>
                    </div>
                    <div class="StffAttndDshbHldr">
                        <div class="StffBscDtls">
                            <div class="StffImgHldr">
                ...
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/complaintDetReports" class="FtrTtl"><span class="LnkTxt">Electrician</span></a>
                    </div>
                    <div class="StffAttndDshbHldr">
                        <div class="StffBscDtls">
                            <div class="StffImgHldr">
                ...
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/complaintDetReports" class="FtrTtl"><span class="LnkTxt">Janitors</span></a>
                    </div>
                    <div class="StffAttndDshbHldr">
                        <div class="StffBscDtls">
                            <div class="StffImgHldr">
