		...
		<!-- Bore Wells code starts -->
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
				...
				<?php for ($i=0; $i < count($waterlevel_data); $i++) 
						...
						<div class="Liquid Liquidhigh l-75"></div>
						<span class="LiquidStatus">75%</span>
						</div>
						</div>
						...
						<li><div class="ClLft">Total Capacity</div><div class="ClRgt">350 KL</div></li>
						<li><div class="ClLft">Current Level</div><div class="ClRgt">245 KL</div></li>
						<li><div class="ClLft">Filled</div><div class="ClRgt">75%</div></li>
						</ul>
						</div>
						</div>
						</div>
            ...
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
                ...
                <?php for ($i=0; $i < count($water_meter_data); $i++) 
					...
					<ul class="SctnDtlsGrdTbl">
						...
						<li><div class="ClLft">Weekly Average</div><div class="ClRgt"><?php echo $water_meter_data[$i]['weeklyavg']; ?>KL</div></li>
			...
			<div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
                ...
                <div class="DshBrdSctnTtl" id="fire">
                    <span class="TxtTtl imageadd"><img src="<?php echo site_url() ?>asset/demoforall/Images/Fire-Pump-C.png" width="40" />OLD FIREPUMP</span>
                    <?php /*<span class="SctnVw Cllps" id="fpcollapse"></span>*/?>
                ...
                <div class="DshBrdSctnDtls WhtBkgrnd FrPmp device devicebox1111" id="devicebox1111">
                    <table class="SctnDtlsDualGrd">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="Txt">3 Min</span>
                            </td>
                            <td>
                                <span class="Txt MblTtl">Yesterday</span>
                                <span class="Txt">5 Mins</span>
                            </td>
                            <td>
					...
					<div class="fire_sub">
						<div class="fire_dgset">
							...
							<li><div class="ClLft">Running Time</div><div class="ClRgt">0 Hours 0 Min</div></li>
						...
						<table class="SctnDtlsDualGrd">
							<tr>
								...
								<tr>
									...
									<td class="Col-3">
										<span class="Txt" id="mhrs">9.55Kg/cm2</span>
									</td>
									<td class="Col-4">
										<span class="Txt" id="mhrht">9.55Kg/cm2</span>
									</td>
									<td class="Col-5">
										
										<span class="Txt Stts cutoff_color" id="mhrhy">9.55Kg/cm2</span>
			...
			<div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
                ...
                <div class="DshBrdSctnTtl" id="fire1">
                    <span class="TxtTtl imageadd"><img src="<?php echo site_url() ?>asset/demoforall/Images/Fire-Pump-C.png" width="40" />NEW FIREPUMP</span>
                    <?php /*<span class="SctnVw Cllps" id="fpcollapse"></span>*/?>
			...
			<div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">          
                ...
                <span class="status-off">OFF</span>
                            ...
                            <td>
                                <span class="Txt MblTtl">Today</span>
                                <span class="Txt">9 Hours 5 Min</span>
                            </td>
                            <td>
                                <span class="Txt MblTtl">Yesterday</span>
                                <span class="Txt">10 Hours 6 Mins</span>
                            </td>
                            <td>
                                <span class="Txt MblTtl">Last Week</span>
                                <span class="Txt">9 hours 30 Mins</span>
                            </td>
            ...
            <tr>
                ...
                <span class="status-off">OFF</span>
                            ...
                            <td>
                                <span class="Txt MblTtl">Today</span>
                                <span class="Txt">8 Hours 55 Min</span>
                            </td>
                            <td>
                                <span class="Txt MblTtl">Yesterday</span>
                                <span class="Txt">9 Hours 35 Mins</span>
                            </td>
                            <td>
                                <span class="Txt MblTtl">Last Week</span>
                                <span class="Txt">9 Hours 44 Mins</span>
                            </td>
