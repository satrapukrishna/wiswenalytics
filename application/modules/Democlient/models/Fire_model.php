...
class Fire_model extends CI_Model{
    ...
    function getjllwaterdata($data)
    {
        ...
        $query="select id, LocationWithUtility as UtilityName,TxnDate, FromTime, ToTime, Consumption ,UomScale from protech_bms.hardware_station_consumption_data_jll where TxnDate=".$date."  and StationId='2020000003' and UtilityName='UG Flush Tank'  order by ToTime desc limit 1";
        // echo $query;die();
