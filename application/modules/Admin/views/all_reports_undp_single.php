        ...
        <div id="DshbrdRgtCtnr" class="DshBrdCtnr">
			<div class="DshBrdSctn">
				<div class="DshBrdSctnDtls">
					<form name="reports" id="myForm" action="<?php echo site_url("Admin/Home/all_reports_undp_single")?>" method="post" onSubmit="return formValidation();">
						<div class=SrchFullBx>
							...
							<div class="SrchBtnHldr">
								...
								<a href="<?php echo site_url('Admin/Home/all_reports_undp_single') ?>" class="btn btn-info reset">Reset</a></span>
				...
				<div class="FullReportDtlsHldr" id="content">
					...
					<?php 	
						...
						if($data['device']==41 && $data['report_type']==0){
							$this->load->view('reportcommon/energyconsumptionreport_tero');						
					...
					<?php
						...
						if($data['device']==41 && $data['report_type']==1){							
							$this->load->view('graphreportcommon/energyconsumptiongraph_tero');
...
// if(diffDays >=7 && sort==2){
// 	$('#error').html("Limit Range to 7 Days");
// 	$('.search_box').show();
// 	$('.show_button').show();
// 	$('.change_search').hide();
// 	$("#content").empty();
...
function getsolutions(){
    ...
    $.ajax({
        ...
        url: BASE_URL+'Admin/Home/ajax_hardware_device_dropdown_terotam/',
