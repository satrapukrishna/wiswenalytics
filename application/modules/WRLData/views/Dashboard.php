        ...
        <div id="DshBrd" class="DshbordCntr">
            <div class="DshbrdHdr">
                <div class="row SctnSlctr" style="width: 100%;">
                    ...
                    <span class="SctnNm">
                        <a href="<?php echo site_url('WRLData/demoData') ?>" class="Lnk">Dashboard</a>
                    </span>
                    </div>
                    <div class="col-md-3" style="width: 10%;" id="links">
                    <span class="SctnNm">
                        <a href="<?php echo site_url('WRLData/getReport') ?>" class="Lnk">Reports</a>
                    </span>
                    </div>
                    <div class="col-md-2" style="width: 10%;margin-left:10%;margin-top:7px;">
            ...
            <div class="CntntHldr table-responsive">            
                <div class="CntntDtls Hdr" id="sodexodatahead">
                    <div class="Dtls Hdr"  id="Hdrname">
                        <img src="/asset/ambienceasset/asset/Images/Blank.png" class="HdrImg RFID" />
                        <span class="HdrTtl">Water Level</span>
                    </div><div class="Dtls Hdr"  id="Hdrname">
                        <img src="/asset/ambienceasset/asset/Images/Blank.png" class="HdrImg RFID" />
                        <span class="HdrTtl">RFID Janitor Attendance</span>
                    </div><div class="Dtls Hdr"  id="Hdrname">
                        <img src="/asset/ambienceasset/asset/Images/Blank.png" class="HdrImg Stink" />
                        <span class="HdrTtl">Odour Male</span>
                    </div>
                    <div class="Dtls Hdr"  id="Hdrname">
                        <img src="/asset/ambienceasset/asset/Images/Blank.png" class="HdrImg Stink" />
                        <span class="HdrTtl">Odour Female</span></div><div class="Dtls Hdr"  id="Hdrname">
                            <img src="/asset/ambienceasset/asset/Images/Blank.png" class="HdrImg Footfall" />
                            <span class="HdrTtl">Footfall Sensor</span>
                        </div>
                        <div class="Dtls Hdr Lst">
                            <img src="/asset/ambienceasset/asset/Images/Blank.png" class="HdrImg Feedback" />
