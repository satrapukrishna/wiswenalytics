		...
		<!-- Bore Wells code starts -->
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
				...
				<div class="bxslider555" id="bxid">
						...
						<span class="SctnTtl tank-title">Tank 01</span>
						</div>
					...
					<div class="fire_waterpump">
						...
						<span class="SctnTtl tank-title">Tank 02</span>
						</div>
                    ...
                    <div class="fire_waterpump">
						...
						<span class="SctnTtl tank-title">Tank 03</span>
						</div>
					...
					<div class="fire_waterpump">
						...
						<span class="SctnTtl tank-title">Tank 04</span>
						</div>
            ...
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
				...
				<div class="bxslider9" id="bxid">
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl" style="line-height: 45px;">Borewell 1 (50 mm) <img style="float:right"src="<?php echo site_url() ?>asset/demoforall/Images/Flow-Meter-C.png" width="60" /></span>
					<ul class="SctnDtlsGrdTbl">
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl" style="line-height: 45px;">Borewell 2 (65 mm) <img style="float:right"src="<?php echo site_url() ?>asset/demoforall/Images/Flow-Meter-C.png" width="60" /></span>
					<ul class="SctnDtlsGrdTbl">
				...
				<div class="bxslider9" id="bxid">
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl" style="line-height: 45px;">North A4 (100 mm) <img style="float:right"src="<?php echo site_url() ?>asset/demoforall/Images/Flow-Meter-C.png" width="60" /></span>
					<ul class="SctnDtlsGrdTbl">
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl" style="line-height: 45px;">North A4 2 (100 mm) <img style="float:right"src="<?php echo site_url() ?>asset/demoforall/Images/Flow-Meter-C.png" width="60" /></span>
					<ul class="SctnDtlsGrdTbl">
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl" style="line-height: 45px;">TPA A11 (150 mm) <img style="float:right"src="<?php echo site_url() ?>asset/demoforall/Images/Flow-Meter-C.png" width="60" /></span>
					<ul class="SctnDtlsGrdTbl">
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl" style="line-height: 45px;">TPA A11 2 (150 mm) <img style="float:right"src="<?php echo site_url() ?>asset/demoforall/Images/Flow-Meter-C.png" width="60" /></span>
					<ul class="SctnDtlsGrdTbl">
			...
			<div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
                ...
                <div class="DshBrdSctnTtl" id="fire1">
                    <span class="TxtTtl imageadd"><img src="<?php echo site_url() ?>asset/demoforall/Images/Fire-Pump-C.png" width="40" />FIREPUMP 1</span>
                    <?php /*<span class="SctnVw Cllps" id="fpcollapse"></span>*/?>
					<span class="SctnVw Cllps dev" onclick="device(1111)" id="device1111"></span>
                </div>
                <div class="DshBrdSctnDtls WhtBkgrnd FrPmp device devicebox1111" id="devicebox1111">
