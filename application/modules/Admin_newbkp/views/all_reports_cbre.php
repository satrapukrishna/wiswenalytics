    ...
    <div id="MnCtnr" class="DshMnCtnr">
       ...
       <input type="hidden" id="page" value="runninggg" />
		...
		<div class="DshBrdSctn" style="padding: 10px 10px 10px 15px;">
			...
			<form name="reports" id="myForm" action="<?php echo site_url("Admin/Home/all_reports_cbre")?>" method="post" onSubmit="return formValidation();">
			...
			<?php //echo "<pre>";print_r($_POST);?>
				<?php /*<form name="reports" id="myForm" action="<?php echo site_url("Admin/Home/all_reports_search")?>" method="post" onSubmit="return formValidation();">*/?>
					...
					<div class="col-md-12" style="background: #f3f3f3;margin-top: -13px;padding-bottom:20px;border-bottom:#ccc 1px solid">
							...
							<?php
							$category1 = array('' => 'Select Catagory', '17' => 'Water');
                            echo form_dropdown('category', $category1, $this->input->post('category'), 'class="form-control chosen-select"  name="cat" id="category"'); ?>
							</div>
							<div class="form-control1">
							<!-- <label class="label-name">Solution</label> -->
                            <?php
							$options11 = array('0' => 'Select Solution','1' => 'Firepump');
                            echo form_dropdown('device', $options11, $this->input->post('device'), 'class="form-control chosen-select" id="solution" onchange="getdevices()"'); ?>
							</div>
							<div class="form-control1">
              ...
              <option value="0">Sunday
						  ...
						  <div class="col-md-11 no-leftpad" ><br/>
							...
							<a href="<?php echo site_url('Admin/Home/all_reports_chennai') ?>" class="btn btn-info reset">Reset</a>
							</span>
					...
					<div class="DshBrdSctnDtls tablular-data"  style="background:#fff">
                        ...
                        if($data['device']==1 && $data['report_type']==0){
					...
					<?php 
						...
						if($data['device']==1 && $data['report_type']==1){
