					...
					<div class="SldrCntnr">
						<div class="SctnDtls DGGnrtrHldr">
							...
							<li><div class="ClLft">Fuel Removed</div><div class="ClRgt"><?php echo $dg_data[$i]['fremove']; ?></div></li>
							 <li><div class="ClLft">Economy</div><div class="ClRgt"><?php echo $dg_data[$i]['economy']; ?></div></li>
							 <li><div class="ClLft">Voltage</div><div class="ClRgt"><?php echo $dg_data[$i]['voltage']; ?></div></li>
							</ul>
							</div>
							...
							<div class="LiquidTank Smll">
								...
								<div class="Liquid l-<?php echo round($dg_data[$i]['availableFuel']); ?>"></div>
