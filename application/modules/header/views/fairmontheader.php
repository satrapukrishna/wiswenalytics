...
if($login){
  ...
  redirect(base_url().'Fairmontlogin');
...
<div id="DshbrdRgt" class="DshBrdHdr">
            <ul class="HdrLstng">
                ...
                <li>
                   <!--  <span class="UsrDtls"><?php echo $this->session->userdata('ProfileName'); ?></span> -->
                   <span class="UsrDtls">Fairmont Mumbai Demo</span>
                </li>
                <li>
                    <span class="Sttngs"></span>
                </li>
                <li>
                    <a href="../Fairmontlogin/logout"><span class="SgnOt" ></span></a>
                </li>
            </ul>
        </div>