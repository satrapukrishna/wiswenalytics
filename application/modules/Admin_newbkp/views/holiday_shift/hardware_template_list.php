                                ...
                                <div>
                                    ...
                                    <form role="form" class="form-horizontal" action="" method="get">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-2 seach-button">
                                            ...
                                            <div class="col-xs-3 seach-button">
                                        ...
                                        if (!empty($hardware_category1)) {
                                            ...
                                            foreach ($hardware_category1 as $row) {  ?>
                                                ...
                                                <tr id="sp<?php echo $row->device_id; ?>">
													...
													if($row->status==1){ 
													?>
													<a href="<?php echo site_url('Admin/Hardware_template/status_change/' . $row->device_id.'/0') ?>" title="Active" style="width:50px !important;" class="btn btn-success btn-xs"><span>Active</span></a>
													<?php 
													}else{
														?>
														<a href="<?php echo site_url('Admin/Hardware_template/status_change/' . $row->device_id.'/1') ?>" style="width:50px !important;" title="Inactive" class="btn btn-warning btn-xs"><span>Inactive</span></a>
														<?php
														}
														?></td>
