                        ...
                        <ul class="ScndLvl Show" id="reportsInnerId">
                            <li>
                                ...
                                <ul class="ThrdLvl" id="dgsetinnerid">
                                    ...
                                    <li>
                                        <a href="<?php echo base_url(); ?>SpInfocityClient/chillerGraphReport" class="Lnk act"><span class="Txt">Graph Report</span></a>
                                    </li>
                                </ul>
                            </li>
                             <li>
