...
<body > 
    ...
    <!-- Tomotherephy starts -->
           <div class="DshBrdSctn" style="padding: 10px 30px 25px 38px;">
                <div class="DshBrdSctnTtl" id="tomo">
                    <span class="TxtTtl imageadd"><img src="<?php echo site_url() ?>asset/demoforall/Images/ahu.png" width="45" />Tomo Therapy</span>
        ...
        <div class="devicebox5555">
                ...
                <div class="bxslider10" id="bxid">    
                    ...
                    <div class="box">
						...
						<div class="SldrCntnr">
						<div class="SctnDtls BorewellHldr">
							<span class="SctnTtl" style="line-height: 30px;border-bottom:1px solid #ccc;font: 600 16px 'Open Sans';color:#3c8dbc">Tomo Therapy </span>
							<div>
							<div class="small-box">
							<span class="status-working">ON</span><br/>
							<h5>Status</h5>
							...
							<div class="small-box">
							<h3><img src='<?php echo base_url(); ?>asset/admin/images/heat.png' width='25'> </h3>
							<h5>Not Cooling</h5>
							</div>
							<div class="small-box no-border-right">
							<h3><img src='<?php echo base_url(); ?>asset/admin/images/cool22.png' width='10'> 19&#8451;</h3>
							<h5>Set Temp.</h5>
							</div>
							<div style="clear:both"></div>
							...
							<div class="ahu-list">
							<h5><img src='<?php echo base_url(); ?>asset/admin/images/air.png' width='20'> Air Flow</h5>
							<span class="inner_collaps1" onclick="device2(188)"><i class="fa fa-angle-down "></i></span>								
							</div>
								<div class="devicebox188" style="display:none;background-color:#fff">
								<div class="small-box">
								<h3>12&#8451;</h3>
								<h5>Supply Air Temp.</h5>
								</div>
								...
								<div class="small-box no-border-right">
								<h3><img src='<?php echo base_url(); ?>asset/admin/images/cool22.png' width='10'> 7&#8451;</h3>
								<h5>Delta T </h5>
								</div>
								<div style="clear:both"></div>
								</div>
							...
							<div class="ahu-list">
							<h5><img src='<?php echo base_url(); ?>asset/admin/images/water.png' width='20'> Water Flow</h5>
							<span class="inner_collaps1" onclick="device2(198)"><i class="fa fa-angle-down "></i></span>
							</div>
								<div class="devicebox198" style="display:none;background-color:#fff">
								<div class="small-box">
								<h3>13&#8451;</h3>
								<h5>Supply Water Temp.</h5>
								</div>
								...
								<div class="small-box no-border-right">
								<h3><img src='<?php echo base_url(); ?>asset/admin/images/cool22.png' width='10'> 3&#8451;</h3>
								<h5>Delta T </h5>
								</div>
								<div style="clear:both"></div>
								</div>
							<div class="ahu-list no-border-bottom no-radius-bottom">
							<h5>&nbsp;<img src='<?php echo base_url(); ?>asset/admin/images/more.png' width='15'> Filter Details</h5>
							<span class="inner_collaps1" onclick="device2(208)"><i class="fa fa-angle-down "></i></span>
							</div>
								<div class="devicebox208" style="display:none;background-color:#fff">
								<div class="small-box" style="width:50%">
								<h3>1.1 Pa.</h3>
								<h5>Filter Pressure</h5>
								</div>
                    ...
                    <div class="box">
						...
						<div class="SldrCntnr">
						<div class="SctnDtls BorewellHldr">
							<span class="SctnTtl" style="line-height: 30px;border-bottom:1px solid #ccc;font: 600 16px 'Open Sans';color:#3c8dbc">Waiting Hall </span>
							<div>
							<div class="small-box">
							<span class="status-working">ON</span><br/>
							<h5>Status</h5>
							...
							<div class="small-box">
							<h3><img src='<?php echo base_url(); ?>asset/admin/images/cool2.png' width='25'> </h3>
							<h5>Cooling</h5>
							</div>
							<div class="small-box no-border-right">
							<h3><img src='<?php echo base_url(); ?>asset/admin/images/cool22.png' width='10'> 19&#8451;</h3>
							...
							<div class="ahu-list">
							<h5><img src='<?php echo base_url(); ?>asset/admin/images/air.png' width='20'> Air Flow</h5>
							<span class="inner_collaps1" onclick="device2(189)"><i class="fa fa-angle-down "></i></span>								
							</div>
								<div class="devicebox189" style="display:none;background-color:#fff">
								<div class="small-box">
								<h3>15.5&#8451;</h3>
								<h5>Supply Air Temp.</h5>
								</div>
								...
								<div class="small-box no-border-right">
								<h3><img src='<?php echo base_url(); ?>asset/admin/images/cool22.png' width='10'> 4.5&#8451;</h3>
								<h5>Delta T </h5>
								</div>
								<div style="clear:both"></div>
								</div>
							...
							<div class="ahu-list">
							<h5><img src='<?php echo base_url(); ?>asset/admin/images/water.png' width='20'> Water Flow</h5>
							<span class="inner_collaps1" onclick="device2(199)"><i class="fa fa-angle-down "></i></span>
							</div>
								<div class="devicebox199" style="display:none;background-color:#fff">
								<div class="small-box">
								<h3>15&#8451;</h3>
								<h5>Supply Water Temp.</h5>
								</div>
								...
								<div class="small-box no-border-right">
								<h3><img src='<?php echo base_url(); ?>asset/admin/images/cool22.png' width='10'> 5&#8451;</h3>
								<h5>Delta T </h5>
								</div>
								<div style="clear:both"></div>
								</div>
							<div class="ahu-list no-border-bottom no-radius-bottom">
							<h5>&nbsp;<img src='<?php echo base_url(); ?>asset/admin/images/more.png' width='15'> Filter Details</h5>
							<span class="inner_collaps1" onclick="device2(209)"><i class="fa fa-angle-down "></i></span>
							</div>
								<div class="devicebox209" style="display:none;background-color:#fff">
								<div class="small-box" style="width:50%">
								<h3>37 Pa.</h3>
								<h5>Filter Pressure</h5>
								</div>
    ...
    <!-- Cancer Blocks -->
           <div class="DshBrdSctn" style="padding: 10px 30px 25px 38px;">
                <div class="DshBrdSctnTtl" id="cancr">
                    <span class="TxtTtl imageadd"><img src="<?php echo site_url() ?>asset/demoforall/Images/ahu.png" width="45" />Cancer Block</span>
                    
                    <?php /*<span class="SctnVw Cllps" id="Bwcollapse"></span>*/?>
                    <span class="SctnVw Cllps dev" onclick="device(5556)" id="device5555"></span>
                    <span class="Cllps FA SctnVwAll deviceall col" onclick="deviceall()"></span>
        ...
        <div class="devicebox5556">
                ...
                <div class="bxslider10" id="bxid">    
                    <?php for ($i=0; $i <count($ahudata) ; $i++) { 
                    	if($ahudata[$i]['meter']=='Novalis Ch WD-2' || $ahudata[$i]['meter']=='Novalis Ch WD-1'){
                    		if($ahudata[$i]['Set_Temp']<$ahudata[$i]['Return Air Temp']){
					...
					<div class="box bxc1 bxheight box-com">    
						...
						<div class="SctnDtls BorewellHldr">
							...
							<div class="ahu-list">
							<h5><img src='<?php echo base_url(); ?>asset/admin/images/water.png' width='20'> Water Flow</h5>
							<span class="inner_collaps1" onclick="device2(7)"><i class="fa fa-angle-down "></i></span>
							</div>
								<div class="devicebox7" style="display:none;background-color:#fff">
								<div class="small-box">
								<h3><?php echo $ahudata[$i]['CW Sup Temp'] ?>&#8451;</h3>
								<h5>Supply Water Temp.</h5>
								</div>
							...
							<div class="ahu-list no-border-bottom no-radius-bottom">
							<h5>&nbsp;<img src='<?php echo base_url(); ?>asset/admin/images/more.png' width='15'> Filter Details</h5>
							<span class="inner_collaps1" onclick="device2(8)"><i class="fa fa-angle-down "></i></span>
							</div>
								<div class="devicebox8" style="display:none;background-color:#fff">
								<div class="small-box" style="width:50%">
								<h3><?php echo $ahudata[$i]['Filter Pressure'] ?></h3>
								<h5>Filter Pressure</h5>
								</div>
                    ...
                    <?php }else{
						...
						<div class="SctnDtls BorewellHldr">
							...
							<div class="ahu-list">
							<h5><img src='<?php echo base_url(); ?>asset/admin/images/air.png' width='20'> Air Flow</h5>
							<span class="inner_collaps1" onclick="device2(9)"><i class="fa fa-angle-down "></i></span>								
							</div>
								<div class="devicebox9" style="display:none;background-color:#fff">
								<div class="small-box">
								<h3><?php echo $ahudata[$i]['Supply Air Temp'] ?>&#8451;</h3>
								<h5>Supply Air Temp.</h5>
								</div>
							...
							<div class="ahu-list">
							<h5><img src='<?php echo base_url(); ?>asset/admin/images/water.png' width='20'> Water Flow</h5>
							<span class="inner_collaps1" onclick="device2(10)"><i class="fa fa-angle-down "></i></span>
							</div>
								<div class="devicebox10" style="display:none;background-color:#fff">
								<div class="small-box">
								<h3><?php echo $ahudata[$i]['CW Sup Temp'] ?>&#8451;</h3>
								<h5>Supply Water Temp.</h5>
								</div>
							...
							<div class="ahu-list no-border-bottom no-radius-bottom">
							<h5>&nbsp;<img src='<?php echo base_url(); ?>asset/admin/images/more.png' width='15'> Filter Details</h5>
							<span class="inner_collaps1" onclick="device2(11)"><i class="fa fa-angle-down "></i></span>
							</div>
								<div class="devicebox11" style="display:none;background-color:#fff">
								<div class="small-box" style="width:50%">
								<h3><?php echo $ahudata[$i]['Filter Pressure'] ?></h3>
								<h5>Filter Pressure</h5>
								</div>
    ...
    <!-- Cancer Blocks -->
           <div class="DshBrdSctn" style="padding: 10px 30px 25px 38px;">
                <div class="DshBrdSctnTtl" id="opl">
                    <span class="TxtTtl imageadd"><img src="<?php echo site_url() ?>asset/demoforall/Images/ahu.png" width="45" />Operation Theater</span>
                    
                    <?php /*<span class="SctnVw Cllps" id="Bwcollapse"></span>*/?>
                    <span class="SctnVw Cllps dev" onclick="device(5557)" id="device5555"></span>
                    <span class="Cllps FA SctnVwAll deviceall col" onclick="deviceall()"></span>
        ...
        <div class="devicebox5557">
                ...
                <div class="bxslider10" id="bxid">    
					...
					<div class="box bxc1 bxheight box-com">    
						...
						<div class="SldrCntnr">
						<div class="SctnDtls BorewellHldr">
							<span class="SctnTtl" style="line-height: 30px;border-bottom:1px solid #ccc;font: 600 16px 'Open Sans';color:#3c8dbc">OT #01 </span>
							<div>
							<div class="small-box">
							<span class="status-working">ON</span><br/>
							<h5>Status</h5>
							...
							<div class="small-box no-border-right">
							<h3><img src='<?php echo base_url(); ?>asset/admin/images/cool22.png' width='10'> 18&#8451;</h3>
							<h5>Set Temp.</h5>
							</div>
							<div style="clear:both"></div>
							...
							<div class="ahu-list">
							<h5><img src='<?php echo base_url(); ?>asset/admin/images/air.png' width='20'> Air Flow</h5>
							<span class="inner_collaps1" onclick="device2(12)"><i class="fa fa-angle-down "></i></span>								
							</div>
								<div class="devicebox12" style="display:none;background-color:#fff">
								<div class="small-box">
								<h3>16.6&#8451;</h3>
								<h5>Supply Air Temp.</h5>
								</div>
								...
								<div class="small-box no-border-right">
								<h3><img src='<?php echo base_url(); ?>asset/admin/images/cool22.png' width='10'> 4.2&#8451;</h3>
								<h5>Delta T </h5>
								</div>
								<div style="clear:both"></div>
								</div>
							...
							<div class="ahu-list">
							<h5><img src='<?php echo base_url(); ?>asset/admin/images/water.png' width='20'> Water Flow</h5>
							<span class="inner_collaps1" onclick="device2(13)"><i class="fa fa-angle-down "></i></span>
							</div>
								<div class="devicebox13" style="display:none;background-color:#fff">
								<div class="small-box">
								<h3>15.2&#8451;</h3>
								<h5>Supply Water Temp.</h5>
								</div>
								...
								<div class="small-box no-border-right">
								<h3><img src='<?php echo base_url(); ?>asset/admin/images/cool22.png' width='10'> 5.3&#8451;</h3>
								<h5>Delta T </h5>
								</div>
								<div style="clear:both"></div>
								</div>
							<div class="ahu-list no-border-bottom no-radius-bottom">
							<h5>&nbsp;<img src='<?php echo base_url(); ?>asset/admin/images/more.png' width='15'> Filter Details</h5>
							<span class="inner_collaps1" onclick="device2(14)"><i class="fa fa-angle-down "></i></span>
							</div>
								<div class="devicebox14" style="display:none;background-color:#fff">
								<div class="small-box" style="width:50%">
								<h3>37 Pa.</h3>
								<h5>Filter Pressure</h5>
								</div>
                    ...
                    <div class="box">
						...
						<div class="SldrCntnr">
						<div class="SctnDtls BorewellHldr">
							<span class="SctnTtl" style="line-height: 30px;border-bottom:1px solid #ccc;font: 600 16px 'Open Sans';color:#3c8dbc">OT #02 </span>
							<div>
							<div class="small-box">
							<span class="status-working">ON</span><br/>
							<h5> Status</h5>
							...
							<div class="small-box no-border-right">
							<h3><img src='<?php echo base_url(); ?>asset/admin/images/cool22.png' width='10'> 23&#8451;</h3>
							<h5>Set Temp.</h5>
							</div>
							<div style="clear:both"></div>
							...
							<div class="ahu-list">
							<h5><img src='<?php echo base_url(); ?>asset/admin/images/air.png' width='20'> Air Flow</h5>
							<span class="inner_collaps1" onclick="device2(15)"><i class="fa fa-angle-down "></i></span>								
							</div>
								<div class="devicebox15" style="display:none;background-color:#fff">
								<div class="small-box">
								<h3>17.2&#8451;</h3>
								<h5>Supply Air Temp.</h5>
								</div>
								...
								<div class="small-box no-border-right">
								<h3><img src='<?php echo base_url(); ?>asset/admin/images/cool22.png' width='10'> 4.3&#8451;</h3>
								<h5>Delta T </h5>
								</div>
								<div style="clear:both"></div>
								</div>
							...
							<div class="ahu-list">
							<h5><img src='<?php echo base_url(); ?>asset/admin/images/water.png' width='20'> Water Flow</h5>
							<span class="inner_collaps1" onclick="device2(16)"><i class="fa fa-angle-down "></i></span>
							</div>
								<div class="devicebox16" style="display:none;background-color:#fff">
								<div class="small-box">
								<h3>16.8&#8451;</h3>
								<h5>Supply Water Temp.</h5>
								</div>
								...
								<div class="small-box no-border-right">
								<h3><img src='<?php echo base_url(); ?>asset/admin/images/cool22.png' width='10'> 4.7&#8451;</h3>
								<h5>Delta T </h5>
								</div>
								<div style="clear:both"></div>
								</div>
							<div class="ahu-list no-border-bottom no-radius-bottom">
							<h5>&nbsp;<img src='<?php echo base_url(); ?>asset/admin/images/more.png' width='15'> Filter Details</h5>
							<span class="inner_collaps1" onclick="device2(17)"><i class="fa fa-angle-down "></i></span>
							</div>
								<div class="devicebox17" style="display:none;background-color:#fff">
								<div class="small-box" style="width:50%">
								<h3>37 Pa.</h3>
								<h5>Filter Pressure</h5>
								</div>
                    ...
                    <div class="box bxc1 bxheight box-com">    
						...
						<div class="SldrCntnr">
						<div class="SctnDtls BorewellHldr">
							<span class="SctnTtl" style="line-height: 30px;border-bottom:1px solid #ccc;font: 600 16px 'Open Sans';color:#3c8dbc">OT #03 </span>
							<div>
							<div class="small-box">
							<span class="status-working">ON</span><br/>
							<h5>Status</h5>
                    ...
                    <div class="box bxc1 bxheight box-com">    
						...
						<div class="SldrCntnr">
						<div class="SctnDtls BorewellHldr">
							<span class="SctnTtl" style="line-height: 30px;border-bottom:1px solid #ccc;font: 600 16px 'Open Sans';color:#3c8dbc">OT #04 </span>
							<div>
							<div class="small-box">
							<span class="status-working">ON</span><br/>
							<h5>Status</h5>
							...
							<span class="inner_collaps1" onclick="device2(12)"><i class="fa fa-angle-down "></i></span>								
								...
								<div class="small-box no-border-right">
								<h3><img src='<?php echo base_url(); ?>asset/admin/images/cool22.png' width='10'> 4.6&#8451;</h3>
								<h5>Delta T </h5>
								</div>
								<div style="clear:both"></div>
								</div>
