...
var energy_data_c1=<?php echo json_encode($energydata['unicef']);?>;
    ...
    series: [{
      name: 'Central Wing UNDP',
      data: xdata,
    }]
  
});
    }
    var energy_quarter_data=<?php echo json_encode($energydat_quarterly_weekday_wise_consumption['tero']['data']);?>;
...
var energy_monthly_data=<?php echo json_encode($energydat_monthly_weekday_wise_consumption['tero']['mdata']);?>;
    ...
    categories: ['<b>June</b>', 'Sun','Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat','<b>July</b>', 'Sun','Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat','<b>Aug</b>', 'Sun','Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat','<b>Sept</b>', 'Sun','Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],
...
var energy_weekday_data=<?php echo json_encode($energydat_weekday_wise_consumption['tero']['mdata']);?>;
    Highcharts.chart('container_energy3', {
    chart: {
        type: 'column'
    },
    title: {
...
var energy_day_night_data_monthly=<?php echo json_encode($energydat_day_night_consumption_monthly);?>;

Highcharts.chart('container_energy_monthly', {
    chart: {
        type: 'column',
        custom: {}
    },
    ...
    enabled: false
        ...
        categories: energy_day_night_data_monthly['date'],
        accessibility: {
    ...
    series: [
        {
            name: 'day',
            data: energy_day_night_data_monthly['day']
        },
        {
            name: 'night',
...
Highcharts.chart('container_energy8', {
    chart: {
        type: 'spline'
    },
    title: {
    ...
    series: [{
        ...
        data: energy_year_to_year_data['this_yaer_data']

    }, {
        name: '2024',
    
        data: energy_year_to_year_data['last_yaer_data']
    }]
});
Highcharts.chart('container_energy9', {
    chart: {
        type: 'column'
    },
    title: {
...
Highcharts.chart('container_energy10', {
    chart: {
        type: 'column'
    },
    title: {
    ...
    series: [
        {
            ...
            data: energy_year_to_year_data['this_yaer_data_avg'],
