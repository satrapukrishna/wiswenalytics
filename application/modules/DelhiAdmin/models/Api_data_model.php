   ...
   return $resdata;
	...
	function get_hardwares_device_data_waterlevelmeter($data){
		...
		if($locationName=='Fire Water Sump'){
			...
			$waterlevel=$datawaterlevel[0]['CurReading']*1.1;
			...
			$waterlevel=$datawaterlevel[0]['CurReading']*1.39;
		...
		}else if($locationName=='Domestic Tank-A' ||$locationName=='Domestic Tank-C'){
			$waterlevel=$datawaterlevel[0]['CurReading'];
