        ...
        <div class="ContainerRight">
            <div class="SctnDtlsTtlHldr">
                ...
                <div class="SlctDrpdwnHldr">
                    ...
                    <li>
                            <span class="TbLnk Grphvw" onclick="location.href='<?php echo base_url(); ?>HospitalAdmin/listView'">List</span>
                        </li>
                        <li>
            ...
            <div class="InnrPgBgHldr">
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin/attendenceDeptDetail" class="FtrTtl Icn MdclStff"><span class="LnkTxt">Medical Staff</span></a>
                    </div>
                ...
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin/attendenceDeptDetail" class="FtrTtl Icn NursngStff"><span class="LnkTxt">Nursing Staff</span></a>
                    </div>
                    <div class="StffAttndDshbHldr">
                        <div class="StffBscDtls">
                            <div class="StffImgHldr">
                ...
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin/attendenceDeptDetail" class="FtrTtl Icn ScrtyStff"><span class="LnkTxt">Security Staff</span></a>
                    </div>
                    <div class="StffAttndDshbHldr">
                        <div class="StffBscDtls">
                            <div class="StffImgHldr">
                ...
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin/attendenceDeptDetail" class="FtrTtl Icn EnggStff"><span class="LnkTxt">Engineering Staff</span></a>
                    </div>
                    <div class="StffAttndDshbHldr">
                        <div class="StffBscDtls">
                            <div class="StffImgHldr">
                ...
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin/attendenceDeptDetail" class="FtrTtl Icn AdmnStff"><span class="LnkTxt">Administrative Staff</span></a>
                    </div>
                    <div class="StffAttndDshbHldr">
                        <div class="StffBscDtls">
                            <div class="StffImgHldr">
