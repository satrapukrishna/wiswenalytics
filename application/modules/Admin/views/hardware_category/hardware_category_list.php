                                        ...
                                        if (!empty($hardware_category)) {
                                            ...
                                            foreach ($hardware_category as $row) {  ?>
                                                ...
                                                <tr id="cp<?php echo $row->category_id; ?>">
													...
													if($row->status==1){ 
													?>
													<a href="<?php echo site_url('Admin/Hardware_category/status_change/' . $row->category_id.'/0') ?>" title="Active" style="width:50px !important;" class="btn btn-success btn-xs"><span>Active</span></a>
													<?php 
													}else{
														?>
														<a href="<?php echo site_url('Admin/Hardware_category/status_change/' . $row->category_id.'/1') ?>" title="Inactive" style="width:50px !important;" class="btn btn-warning btn-xs"><span>Inactive</span></a>
														<?php
														}
														?></td>
