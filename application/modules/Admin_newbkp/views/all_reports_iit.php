        ...
        <div id="DshbrdRgtCtnr" class="DshBrdCtnr">
			<div class="DshBrdSctn">
				<div class="DshBrdSctnDtls">
					<form name="reports" id="myForm" action="<?php echo site_url("Admin/Home/all_reports_iithyd")?>" method="post" onSubmit="return formValidation();">
						<div class=SrchFullBx>
							...
							<div class="SrchBtnHldr">
								...
								<a href="<?php echo site_url('Admin/Home/all_reports_iithyd') ?>" class="btn btn-info reset">Reset</a></span>
				...
				<div class="FullReportDtlsHldr" id="content">
					...
					<?php 	
						...
						if($data['device']==40 && $data['report_type']==0){							
							$this->load->view('reportcommon/switch_status_report',$data);
					...
					<?php
						...
						if($data['device']==40 && $data['report_type']==1){
						$this->load->view('graphreportcommon/switchstatusreport');								
						}
						//end water
						//start energy
...
function getsolutions(){
    ...
    $.ajax({
        ...
        url: BASE_URL+'Admin/Home/ajax_hardware_device_dropdown_iit/',
