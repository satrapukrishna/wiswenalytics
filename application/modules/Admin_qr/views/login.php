        ...
        <div class="LoginHldr">
			...
			<div class="LoginBx tabs">
				<ul class="nav nav-tabs tab-group LoginType">
				  <li class="Lnk"><a data-toggle="tab" href="#client"><b>Client</b></a></li>
				  <li class="Lnk active"><a data-toggle="tab" href="#employee"><b>Employee</b></a></li>
				...
				<div class="tab-content">
				  <div id="client" class="tab-pane fade">
                    ...
                    <ul class="LoginFlds">
                        ...
                        <li>
                         ...
                         <li>
                            <span class="FrgtPssd">Client / Employee Login?<a href="<?php echo site_url('Admin')?>" class="Lnk"> Click Here</a></span>
                        </li> 
                    </ul>
                </form>
				  ...
				  <div id="employee" class="tab-pane fade in active">
                    ...
                    <ul class="LoginFlds">
                       ...
                       <li>
                            <span class="FrgtPssd">Super Admin Login?<a href="<?php echo site_url('SuperAdmin')?>" class="Lnk"> Click Here</a></span>
                        </li> 
                    </ul>
                </form>
				  </div>
