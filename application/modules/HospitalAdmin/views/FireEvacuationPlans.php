        ...
        <div class="ContainerLeft">
            ...
            <div class="SctnInnerLnks">
                <ul class="InnrLnksHldr">
                    <li>
                        <a href="<?php echo base_url(); ?>HospitalAdmin/floorPlans" class="LnkTxt FlrPln Icn">Floor Plan</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>HospitalAdmin/fireEvacuationPlans" class="LnkTxt FrExPln Icn Actv">Fire Evacuation Plan</a>
                    </li>
                </ul>
            </div>
        </div>
