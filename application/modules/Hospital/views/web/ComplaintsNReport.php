...
<body>
    <div class="AppMenu">
        ...
        <ul class="MenuList">
            ...
            <li>
                <a href="ComplaintsList.html" class="AppMenuLnk CmplntsFdbck Actv">
    ...
    <div class="AppFllContainer FllScrn">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseFive" class="accordion-collapse" aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul class="SbLnk">
                                    <li>
                                        <a href="ComplaintsNEReport.html" class="SbLnk">Employee Performance Report</a>
                                    </li>
                                    <li>
                                        <a href="ComplaintsNCReport.html" class="SbLnk Actv">Complaints Report Overview</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="ContainerRight">
            ...
            <div class="SctnGrphDsh">
                    ...
                    <div class="GraphHldr ">
                        ...
                        <script>
                            ...
                            var myChart = new Chart(ctx, {
                                type: 'doughnut', // line, bar, radar, doughnut, polarArea, bubble, scatter
                                data: {
                                    labels: ['Created', 'In Process', 'Completed'],
                                    datasets: [
                                        {
                                            label: 'Male',
                                            data: [64, 45, 50],
                ...
                <div class="GrphCol CRReport LnGrph">
                    <div class="GraphHldr ">
                        <span class="GrphTtl">Complaints Time</span>
                        <canvas id="OpThChartC" height="100"></canvas>
                        <script>
                            var ctx = document.getElementById('OpThChartC').getContext('2d');
                            var myChart = new Chart(ctx, {
                                type: 'bar', // line, bar, radar, doughnut, polarArea, bubble, scatter
                                data: {
                                    labels: ['09:00 AM - 11:00 AM', '11:00 AM - 01:00 PM', '01:00 PM - 03:00 PM', '03:00 PM - 05:00 PM', '05:00 PM - 07:00 PM', '07:00 PM - 09:00 PM', '09:00 PM - 11:00 PM', '11:00 PM - 01:00 AM'],
                                    datasets: [
                                        {
                                            label: 'Male',
                                            data: [5, 20, 49, 45, 50, 19, 15, 8],
                                            borderWidth: 0,
                                            hoverBorderColor: 'rgba(255,255,255,1)',
                                            hoverBackgroundColor: [
                                                'rgba(13, 110, 253, 1)',
