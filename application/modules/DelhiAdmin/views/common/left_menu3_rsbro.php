            ...
            <div class="DshBrdLnkCntr" id="root" data-simplebar>
                ...
                <ul class="LnkHldr FrstLvl">
                        ...
                        <?php if(modules::run('Admin/Site/authlink','energy_Energy-Meter')){ ?>
                            <li>
                                <a href="<?php echo site_url('Admin/Home/energy_rsbrother/')?>#energy" class="Lnk"><img src="<?php echo site_url() ?>asset/demoforall/Images/Electric-Meter-W.png" width="22px"/> <span class="Txt">Energy Meter</span></a>
                            </li>
                        <?php } ?>
                         <?php if(modules::run('Admin/Site/authlink','energy_btu_meters')){ ?>
                            ...
                            <li>
                            <a href="<?php echo site_url('Admin/Home/energy_rsbrother/')?>#dg" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/DG.png" width="22px"/> <span class="Txt">DG</span></a>
                            </li>
                            <?php } ?>
