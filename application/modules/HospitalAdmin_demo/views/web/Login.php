...
<body>
    <div class="LoginBxHldr">
        <div class="ClntLogoHldr">
            <img src="<?php echo base_url(); ?>asset/hospital_web/Images/ClientLogo-Big.png" class="ClntLogo" />
        </div>
        <div class="LoginBox">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-12">
                    <input type="text" class="form-control" id="staticEmail" placeholder="Enter Username or Email ID" />
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <button type="button" onclick="location.href='<?php echo site_url('Hospital/HospitalAdmin_demo/dashboard'); ?>'" class="btn btn-primary">Submit</button>
