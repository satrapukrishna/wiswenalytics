...
<body>
    <div class="Header">
        ...
        <div class="LanguageOptns">
            <a href="<?php echo base_url(); ?>Hospital/room/1" class="LanguageOptns">English</a>
            <a href="<?php echo base_url(); ?>Hospital/room/2" class="LanguageOptns">తెలుగు</a>
            <a href="<?php echo base_url(); ?>Hospital/room/3" class="LanguageOptns Actv Hin">हिंदी</a>
        </div>
    </div>
    <div class="Container Hin">
        <div class="ComplaintSelection">
            <span class="PgTtl">शिकायत दर्ज करने के लिए कृपया नीचे से चुनें</span>
            <div class="ComplaintCategories">
                <div class="CategoryHolder">
                    <a href="<?php echo base_url(); ?>Hospital/heat_cool_room" class="CatLink">
                        ...
                        <span class="CatName">गर्म/ ठंडा</span>
                    </a>
                </div>
                <div class="CategoryHolder">
