				...
				<div class="bxslider600" id="bxid">
					...
					<div class="SldrCntnr">
						<div class="SctnDtls DGGnrtrHldr">
							...
							<div class="SctnTtl_main">
							<span class="SctnTtl"><?php echo $dg_data[$i]['dgname']; ?></span><br>
							<span style="font-size:12px;color:#ab9f9f;padding:10px">Diesel Generator 2
							<span class="SctnTtl_buttn">
							<!-- <button>AUTO</button> -->
							...
							<div>
							<div id="ddg2<?php echo $i; ?>" style="width:400px"></div>
							</div>
					...
					<div class="SldrCntnr">
						<div class="SctnDtls DGGnrtrHldr">
							...
							<div class="SctnTtl_main">
							<span class="SctnTtl"><?php echo $dg_data[$i]['dgname']; ?></span><br>
							<span style="font-size:12px;color:#ab9f9f;padding:10px">Diesel Generator 3
							<span class="SctnTtl_buttn">
							<!-- <button>AUTO</button> -->
							...
							<div>
							<div id="ddg3<?php echo $i; ?>" style="width:400px"></div>
							</div>
...
<!-- UPS Start -->
            ...
            <!-- UPS End -->
            <?php } ?>
             <?php if(modules::run('Admin_demo/Site/authlink','energy_lpg')){ ?>
			<!-- lpg -->
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
            ...
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
				...
				<div class="bxslider601" id="bxid">
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl" style="line-height: 59px;">Diesel Tank - 01 <img style="float:right"src="<?php echo site_url() ?>asset/admin/images/DieselTank-Clr.png" width="70" />
					<br/>
					</span>
					...
					<ul class="SctnDtlsGrdTbl">
						...
						<li><div class="ClLft1">Month till date</div><div class="ClRgt1">1500 Lts</div><div class="ClRgt2">1530 Lts</div></li>
						<li><div class="ClLft1">Last Month</div><div class="ClRgt1">1649 Lts</div><div class="ClRgt2">1699 Lts</div></li>
						<li><div class="ClLft1">Year till date</div><div class="ClRgt1">49470 Lts</div><div class="ClRgt2">50970 Lts</div></li>
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl" style="line-height: 59px;">Diesel Tank - 02 <img style="float:right"src="<?php echo site_url() ?>asset/admin/images/DieselTank-Clr.png" width="70" />
					<br/>
					</span>
					...
					<ul class="SctnDtlsGrdTbl">
						...
						<li><div class="ClLft1">Today</div><div class="ClRgt1">Nil</div><div class="ClRgt2">Nil</div></li>
						<li><div class="ClLft1">Month till date</div><div class="ClRgt1">1580 Lts</div><div class="ClRgt2">1590 Lts</div></li>
						<li><div class="ClLft1">Last Month</div><div class="ClRgt1">1730 Lts</div><div class="ClRgt2">1780 Lts</div></li>
						<li><div class="ClLft1">Year till date</div><div class="ClRgt1">51900 Lts</div><div class="ClRgt2">53400 Lts</div></li>
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl" style="line-height: 59px;">Diesel Tank - 03 <img style="float:right"src="<?php echo site_url() ?>asset/admin/images/DieselTank-Clr.png" width="70" />
					<br/>
					</span>
					...
					<ul class="SctnDtlsGrdTbl">
						...
						<li><div class="ClLft1">Today</div><div class="ClRgt1">Nil</div><div class="ClRgt2">Nil</div></li>
						<li><div class="ClLft1">Month till date</div><div class="ClRgt1">1630 Lts</div><div class="ClRgt2">1650 Lts</div></li>
						<li><div class="ClLft1">Last Month</div><div class="ClRgt1">1700 Lts</div><div class="ClRgt2">1750 Lts</div></li>
						<li><div class="ClLft1">Year till date</div><div class="ClRgt1">51000 Lts</div><div class="ClRgt2">52500 Lts</div></li>
            ...
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
				...
				<div class="bxslider559" id="bxid">
					...
					<ul class="SctnDtlsGrdTbl">
						...
						<li><div class="ClLft">Current Reading </div><div class="ClRgt">56898 Lts</div></li><li><div class="ClLft">Avg. Reading/Day</div><div class="ClRgt">53.96 Lts</div></li>
						<li><div class="ClLft">Avg. Reading/Month</div><div class="ClRgt">54.96 Lts</div></li>
						<li><div class="ClLft">Avg. Reading/Year</div><div class="ClRgt">135.53 Lts</div></li>
					...
					<ul class="SctnDtlsGrdTbl">
						...
						<li><div class="ClLft">Current Reading </div><div class="ClRgt">54987 Lts</div></li><li><div class="ClLft">Avg. Reading/Day</div><div class="ClRgt">56 Lts</div></li>
						<li><div class="ClLft">Avg. Reading/Month</div><div class="ClRgt">57.66 Lts</div></li>
						<li><div class="ClLft">Avg. Reading/Year</div><div class="ClRgt">144.16 Lts</div></li>
					...
					<ul class="SctnDtlsGrdTbl">
						...
						<li><div class="ClLft">Current Reading </div><div class="ClRgt">53099 Lts</div></li><li><div class="ClLft">Avg. Reading/Day</div><div class="ClRgt">55 Lts</div></li>
						<li><div class="ClLft">Avg. Reading/Month</div><div class="ClRgt">56.66 Lts</div></li>
						<li><div class="ClLft">Avg. Reading/Year</div><div class="ClRgt">139.72 Lts</div></li>
				...
				<div class="bxslider559" id="bxid">
					...
					<ul class="SctnDtlsGrdTbl">
						...
						<li><div class="ClLft">Current Reading </div><div class="ClRgt">49998 Lts</div></li><li><div class="ClLft">Avg. Reading/Day</div><div class="ClRgt">68 Lts</div></li>
						<li><div class="ClLft">Avg. Reading/Month</div><div class="ClRgt">69.33 Lts</div></li>
						<li><div class="ClLft">Avg. Reading/Year</div><div class="ClRgt">139.64 Lts</div></li>
					...
					<ul class="SctnDtlsGrdTbl">
						...
						<li><div class="ClLft">Current Reading </div><div class="ClRgt">48977 Lts</div></li><li><div class="ClLft">Avg. Reading/Day</div><div class="ClRgt">57 Lts</div></li>
						<li><div class="ClLft">Avg. Reading/Month</div><div class="ClRgt">58.33 Lts</div></li>
						<li><div class="ClLft">Avg. Reading/Year</div><div class="ClRgt">146.30 Lts</div></li>
					...
					<ul class="SctnDtlsGrdTbl">
						...
						<li><div class="ClLft">Current Reading </div><div class="ClRgt">47000 Lts</div></li><li><div class="ClLft">Avg. Reading/Day</div><div class="ClRgt">58 Lts</div></li>
						<li><div class="ClLft">Avg. Reading/Month</div><div class="ClRgt">59.33 Lts</div></li>
						<li><div class="ClLft">Avg. Reading/Year</div><div class="ClRgt">143.83 Lts</div></li>
