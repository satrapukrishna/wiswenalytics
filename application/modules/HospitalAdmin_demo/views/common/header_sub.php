            ...
            <div class="PrprtyPnl">
                <div class="PrptyDrpDwn">
                    ...
                    <div class="DrpDwnHldr">
                        <ul class="DrpDwnLst">
                            <li>
                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="InnrPrptyNm">FirstMedic Banjara</a>
                ...
                <div class="PrptyMpLnkHldr">
                    <ul class="PrprtyBscDtlsLst RgtLnk">
                        <li class="IcHldr MpVw">
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/dashboard" class="BscDtlLnk">Map View</a>
                        </li>
                    </ul>
                </div>
