...
<body onload="fetchSodexoData()">
    <div class="Wrapper">
        ...
        <div class="col-md-6">
                    <span class="SctnNm"><a href="<?php echo base_url(); ?>WRLData/demoData">Dashboard</a></span>
        </div>
         
          <div class="col-md-6">
            <span class="SctnNm"><a href="<?php echo base_url(); ?>WRLData/getReport">Reports</a></span>
          </div>
                </div>
        ...
        <input type="date" value="<?php echo set_value('date') ?>" class="Inpt" name="date" id="date" />
          ...
          <div class="col-md-6">
          <input type="submit" class="InptBtn" value="Submit" onclick="fetchSodexoData()"  />
          </div>
                </div>
                <div class="row SctnSlctr">
        <div class="col-md-6">
      ...
      <div class="lds-ellipsis" id="loading1" style="display: none;"><div></div><div></div><div></div><div></div></div>
            ...
            <div class="CntntDtls Hdr" id="sodexodatahead"><div class="Dtls Hdr"  id="Hdrname"><img src="/asset/ambienceasset/asset/Images/Blank.png" class="HdrImg RFID" /><span class="HdrTtl">Water Level</span></div><div class="Dtls Hdr"  id="Hdrname"><img src="/asset/ambienceasset/asset/Images/Blank.png" class="HdrImg RFID" /><span class="HdrTtl">RFID Janitor Attendance</span></div><div class="Dtls Hdr"  id="Hdrname"><img src="/asset/ambienceasset/asset/Images/Blank.png" class="HdrImg Stink" /><span class="HdrTtl">Odour Male</span></div><div class="Dtls Hdr"  id="Hdrname"><img src="/asset/ambienceasset/asset/Images/Blank.png" class="HdrImg Stink" /><span class="HdrTtl">Odour Female</span></div><div class="Dtls Hdr"  id="Hdrname"><img src="/asset/ambienceasset/asset/Images/Blank.png" class="HdrImg Footfall" /><span class="HdrTtl">Footfall Sensor</span></div><div class="Dtls Hdr Lst"><img src="/asset/ambienceasset/asset/Images/Blank.png" class="HdrImg Feedback" /><span class="HdrTtl">Feedback Buttons</span></div></div>
...
$(function() {
  ...
  function fetchSodexoData()
  {
    ...
    console.log(today);
      ...
      var urlString = "<?php echo base_url(); ?>WRLData/getSodexoData";
      $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
  ...
  function displaySodexoData(data)
  {
      ...
      var div=''; 
      div+='<div class="div1">Collector Office,Warangal</div>';
     div+='<div class="CntntDtls"><div class="Scnd" style="width:100% !important"><div class="Dtls RFID" style="width:17% !important"><div id="Hldrh"><div class="Hldr"><span class="Txt">Current Level(KL)</span><span class="TxtHghlgt">'+d[0]['level']+'</span></div><div class="Hldr"><span class="Txt">Filled(%)</span><span class="TxtHghlgt">'+d[0]['percent']+'</span></div></div><div class="Hldr"><input type="button" class="Btn" value="Details"></div></div><div class="Dtls RFID" style="width:17% !important"><div id="Hldrh"><div class="Hldr"><span class="Txt">No. of times swiped</span><span class="TxtHghlgt">'+d[0]['swiped']+'</span></div><div class="Hldr"><span class="Txt">No.of times cleaning verified</span><span class="TxtHghlgt">'+d[0]['verified']+'</span></div></div><div class="Hldr"><input type="button" class="Btn" value="Details"></div></div><div class="Dtls Footfall" style="width:17% !important"><div id="Hldrh"> <div class="Hldr"><span class="Txt">Odour Level</span><span class="TxtHghlgt">'+d[0]['OdourMaleLeft']+' ppm</span></div></div><div class="Hldr"><input type="button" class="Btngreen" id="Btngreen" value="Acceptable"></div></div><div class="Dtls Footfall" style="width:17% !important"><div id="Hldrh"><div class="Hldr"><span class="Txt">Odour Level</span><span class="TxtHghlgt">'+d[0]['OdourMaleRight']+' ppm</span></div></div><div class="Hldr"><input type="button" class="Btngreenl" id="Btngreenl" value="Acceptable"></div></div><div class="Dtls RFID" style="width:16% !important"><div id="Hldrh"><div class="Hldr"><span class="Txt">Male Footfall</span><span class="TxtHghlgt">'+d[0]['footfallcountMale']+'</span></div><div class="Hldr"><span class="Txt">Female Footfall</span><span class="TxtHghlgt">'+d[0]['footfallcountfemale']+'</span></div></div><div class="Hldr"><input type="button" class="Btn" value="Details"></div></div><div class="Dtls Feedback" style="width:16% !important"><div class="Hldr"><span class="Txt">Feedback</span></div><div class="Hldr Fdbck Good"><span class="Grade">Good</span><span class="Value">'+d[0]['good']+'/'+d[0]['feedbacktotal']+'</span></div><div class="Hldr Fdbck Average"><span class="Grade">Average</span><span class="Value">'+d[0]['avg']+'/'+d[0]['feedbacktotal']+'</span></div><div class="Hldr Fdbck Bad"><span class="Grade">Bad</span><span class="Value">'+d[0]['poor']+'/'+d[0]['feedbacktotal']+'</span></div></div><div class="Dtls TltDtt" style="width:17% !important"><div class="InnrDtls TxtTtl">Hand Towel</div><div class="InnrDtls ImgHldr"><img src="<?php echo base_url(); ?>asset/ambienceasset/asset/Images/Blank.png" class="HndTwl Actv" /></div><div class="InnrDtls Stts"><span class="ATxt" id="handavl" style="display: visible;">Available</span><span class="Stext" id="handnoavl" style="display: none;">Not Available</span></div></div><div class="Dtls TltDtt" style="width:17% !important"><div class="InnrDtls TxtTtl">Toilet Rolls</div><div class="InnrDtls ImgHldr"><img src="<?php echo base_url(); ?>asset/ambienceasset/asset/Images/Blank.png" class="TltRlls Actv" /></div><div class="InnrDtls Stts"><span class="ATxt" id="toiletrollavl" style="display: none;">Available</span><span class="Stext" id="toiletrollnoavl" style="display: visible;">Not Available</span></div></div><div class="Dtls TltDtt" style="width:17% !important"><div class="InnrDtls TxtTtl">Dustbin</div><div class="InnrDtls ImgHldr"><img src="<?php echo base_url(); ?>asset/ambienceasset/asset/Images/Blank.png" class="DstBn Actv" /></div><div class="InnrDtls Stts"><span class="ATxt" id="dustbinavl" style="display: none;">Available</span><span class="Stext" id="dustbinnoavl" style="display: visible;">Not Available</span></div></div><div class="Dtls TltDtt" style="width:17% !important"><div class="InnrDtls TxtTtl">Floor</div><div class="InnrDtls ImgHldr"><img src="<?php echo base_url(); ?>asset/ambienceasset/asset/Images/Blank.png" class="Flr Actv" /></div><div class="InnrDtls Stts"><span class="ATxt" id="flooravl" style="display: visible;">Dry</span><span class="NATxt" id="floornoavl" style="display: none;">FloorWet</span></div></div><div class="Dtls TltDtt" style="width:16% !important"><div class="InnrDtls TxtTtl">Hand Soap</div><div class="InnrDtls ImgHldr"><img src="<?php echo base_url(); ?>asset/ambienceasset/asset/Images/Blank.png" class="HndSp Actv" /></div><div class="InnrDtls Stts"><span class="ATxt" id="handsoapavl" style="display: visible;">Available</span><span class="Stext" id="handsoapnoavl" style="display: none;">Not Available</span></div></div><div class="Dtls RFID" style="width:16% !important"><div id="Hldrh"><div class="Hldr"><span class="Txt" style="width:40% !important;font-weight:bold">Supervisor</span><span class="Txt" style="width:40% !important">: Krishna</span></div><div class="Hldr"><span class="Txt" style="width:40% !important;font-weight:bold">Date</span><span class="Txt" style="width:40% !important">: 2022-04-05</span></div></div></div><div class="Dtls TltDtt1" id="waterlevel" style="display: none;width:17% !important"></div><div class="Dtls TltDtt1" id="janitorsv" style="display: none;width:17% !important"></div><div class="Dtls TltDtt1" id="odourleftdashboard" style="display: none;width:17% !important"></div><div class="Dtls TltDtt1" id="odourrightdashboard" style="display: none;width:17% !important"></div><div class="Dtls TltDtt1" id="footfalllive" style="display: none;"></div><div class="Dtls TltDtt1" id="feedbacklive" style="display: none;"></div></div></div>';
     div+='<div class="div1">JP Nagar,Warangal</div>';
     div+='<div class="CntntDtls"><div class="Scnd" style="width:100% !important"><div class="Dtls RFID" style="width:17% !important"><div id="Hldrh"><div class="Hldr"><span class="Txt">Current Level(KL)</span><span class="TxtHghlgt">'+d[2]['level']+'</span></div><div class="Hldr"><span class="Txt">Filled(%)</span><span class="TxtHghlgt">'+d[2]['percent']+'</span></div></div><div class="Hldr"><input type="button" class="Btn" value="Details"></div></div><div class="Dtls RFID" style="width:17% !important"><div id="Hldrh"><div class="Hldr"><span class="Txt">No. of times swiped</span><span class="TxtHghlgt">'+d[2]['swiped']+'</span></div><div class="Hldr"><span class="Txt">No.of times cleaning verified</span><span class="TxtHghlgt">'+d[2]['verified']+'</span></div></div><div class="Hldr"><input type="button" class="Btn" value="Details"></div></div><div class="Dtls Footfall" style="width:17% !important"><div id="Hldrh"> <div class="Hldr"><span class="Txt">Odour Level</span><span class="TxtHghlgt">'+d[2]['OdourMaleLeft']+' ppm</span></div></div><div class="Hldr"><input type="button" class="Btngreen" id="Btngreen" value="Acceptable"></div></div><div class="Dtls Footfall" style="width:17% !important"><div id="Hldrh"><div class="Hldr"><span class="Txt">Odour Level</span><span class="TxtHghlgt">'+d[2]['OdourMaleRight']+' ppm</span></div></div><div class="Hldr"><input type="button" class="Btngreenl" id="Btngreenl" value="Acceptable"></div></div><div class="Dtls RFID" style="width:16% !important"><div id="Hldrh"><div class="Hldr"><span class="Txt">Male Footfall</span><span class="TxtHghlgt">'+d[2]['footfallcountMale']+'</span></div><div class="Hldr"><span class="Txt">Female Footfall</span><span class="TxtHghlgt">'+d[2]['footfallcountfemale']+'</span></div></div><div class="Hldr"><input type="button" class="Btn" value="Details"></div></div><div class="Dtls Feedback" style="width:16% !important"><div class="Hldr"><span class="Txt">Feedback</span></div><div class="Hldr Fdbck Good"><span class="Grade">Good</span><span class="Value">'+d[2]['good']+'/'+d[2]['feedbacktotal']+'</span></div><div class="Hldr Fdbck Average"><span class="Grade">Average</span><span class="Value">'+d[2]['avg']+'/'+d[2]['feedbacktotal']+'</span></div><div class="Hldr Fdbck Bad"><span class="Grade">Bad</span><span class="Value">'+d[2]['poor']+'/'+d[2]['feedbacktotal']+'</span></div></div><div class="Dtls TltDtt" style="width:17% !important"><div class="InnrDtls TxtTtl">Hand Towel</div><div class="InnrDtls ImgHldr"><img src="<?php echo base_url(); ?>asset/ambienceasset/asset/Images/Blank.png" class="HndTwl Actv" /></div><div class="InnrDtls Stts"><span class="ATxt" id="handavl" style="display: visible;">Available</span><span class="Stext" id="handnoavl" style="display: none;">Not Available</span></div></div><div class="Dtls TltDtt" style="width:17% !important"><div class="InnrDtls TxtTtl">Toilet Rolls</div><div class="InnrDtls ImgHldr"><img src="<?php echo base_url(); ?>asset/ambienceasset/asset/Images/Blank.png" class="TltRlls Actv" /></div><div class="InnrDtls Stts"><span class="ATxt" id="toiletrollavl" style="display: none;">Available</span><span class="Stext" id="toiletrollnoavl" style="display: visible;">Not Available</span></div></div><div class="Dtls TltDtt" style="width:17% !important"><div class="InnrDtls TxtTtl">Dustbin</div><div class="InnrDtls ImgHldr"><img src="<?php echo base_url(); ?>asset/ambienceasset/asset/Images/Blank.png" class="DstBn Actv" /></div><div class="InnrDtls Stts"><span class="ATxt" id="dustbinavl" style="display: none;">Available</span><span class="Stext" id="dustbinnoavl" style="display: visible;">Not Available</span></div></div><div class="Dtls TltDtt" style="width:17% !important"><div class="InnrDtls TxtTtl">Floor</div><div class="InnrDtls ImgHldr"><img src="<?php echo base_url(); ?>asset/ambienceasset/asset/Images/Blank.png" class="Flr Actv" /></div><div class="InnrDtls Stts"><span class="ATxt" id="flooravl" style="display: visible;">Dry</span><span class="NATxt" id="floornoavl" style="display: none;">FloorWet</span></div></div><div class="Dtls TltDtt" style="width:16% !important"><div class="InnrDtls TxtTtl">Hand Soap</div><div class="InnrDtls ImgHldr"><img src="<?php echo base_url(); ?>asset/ambienceasset/asset/Images/Blank.png" class="HndSp Actv" /></div><div class="InnrDtls Stts"><span class="ATxt" id="handsoapavl" style="display: visible;">Available</span><span class="Stext" id="handsoapnoavl" style="display: none;">Not Available</span></div></div><div class="Dtls RFID" style="width:16% !important"><div id="Hldrh"><div class="Hldr"><span class="Txt" style="width:40% !important;font-weight:bold">Supervisor</span><span class="Txt" style="width:40% !important">: Krishna</span></div><div class="Hldr"><span class="Txt" style="width:40% !important;font-weight:bold">Date</span><span class="Txt" style="width:40% !important">: 2022-04-05</span></div></div></div><div class="Dtls TltDtt1" id="waterlevel2" style="display: none;width:17% !important"></div><div class="Dtls TltDtt1" id="janitorsv2" style="display: none;width:17% !important"></div><div class="Dtls TltDtt1" id="odourleftdashboard2" style="display: none;width:17% !important"></div><div class="Dtls TltDtt1" id="odourrightdashboard2" style="display: none;width:17% !important"></div><div class="Dtls TltDtt1" id="footfalllive2" style="display: none;"></div><div class="Dtls TltDtt1" id="feedbacklive2" style="display: none;"></div></div></div>';
...
div_d.innerHTML += 'Date: '+today;
      ...
      var urlString_water = "<?php echo base_url(); ?>WRLData/getWaterReportLive";
        $.ajaxQueue({
          url:urlString_water,
          type : 'GET',
          data: {date:today},
        ...
        var urlString = "<?php echo base_url(); ?>WRLData/getJanitorReportLive";
        $.ajaxQueue({
          url:urlString,
          type : 'GET',
          data: {date:today},
        ...
        var urlStringOdour = "<?php echo base_url(); ?>WRLData/getOudorLevelReportLiveDashboard";
        $.ajaxQueue({
          url:urlStringOdour,
          type : 'GET',
          data: {date:today},
       ...
       var urlStringFootfall = "<?php echo base_url(); ?>WRLData/getSodexoReportLive";
        $.ajaxQueue({
         ...
         var urlStringFeedback = "<?php echo base_url(); ?>WRLData/getFeedbackReportLive";
        $.ajax({
     ...
     document.getElementById("feedbacklive2").style.display="block";
    document.getElementById("loading1").style.display="none";
       ...
       var ygood_jp = new Array();
       var yavg_jp= new Array();
       var ypoor_jp = new Array();
       var xdata_jp = new Array();
    for (i = 0; i < d['collector'].length; i++) 
        { 
            xdata[i] = d['collector'][i]['Time'];
            ygood[i] = parseInt(d['collector'][i]['good']); 
            yavg[i] = parseInt(d['collector'][i]['avg']); 
            ypoor[i] = parseInt(d['collector'][i]['poor']); 
           
            
          
        }
        for (i = 0; i < d['jp'].length; i++) 
        { 
            xdata_jp[i] = d['jp'][i]['Time'];
            ygood_jp[i] = parseInt(d['jp'][i]['good']); 
            yavg_jp[i] = parseInt(d['jp'][i]['avg']); 
            ypoor_jp[i] = parseInt(d['jp'][i]['poor']); 
...
Highcharts.chart('feedbacklive2', {
  chart: {
      type: 'column',
      height:200
  },
  ...
  responsive: {
    ...
    document.getElementById("odourleftdashboard2").style.display="block";
    document.getElementById("odourrightdashboard2").style.display="block";
      document.getElementById("tab").style.display='none';
   
    var xdata_male = d['collector']['xdata_male'];
    var ydata_male = d['collector']['ydata_male'];

    var xdata_female = d['collector']['xdata_female'];
    var ydata_female = d['collector']['ydata_female'];

    var xdata_jp_male = d['jp']['xdata_male'];
    var ydata_jp_male = d['jp']['ydata_male'];

    var xdata_jp_female = d['jp']['xdata_female'];
    var ydata_jp_female = d['jp']['ydata_female'];
    ...
    Highcharts.chart('odourleftdashboard2', {
        chart: {
            type: 'line',
        height:200
        },
    ...
    Highcharts.chart('odourrightdashboard2', {
        chart: {
            type: 'line',
        height:200
        },
...
function appendFootfallLive(obj)
      {
        var hoursxaxisarray = obj['collector']['hoursxaxisarray'];
        var footfallyaxisarray = obj['collector']['footfallyaxisarray'];
        var footfallyaxisarray_female = obj['collector']['footfallyaxisarray_female'];

        var hoursxaxisarray_jp = obj['jp']['hoursxaxisarray'];
        var footfallyaxisarray_jp = obj['jp']['footfallyaxisarray'];
        var footfallyaxisarray_female_jp = obj['jp']['footfallyaxisarray_female'];

        document.getElementById("footfalllive").style.display="block";
        document.getElementById("footfalllive2").style.display="block";

        Highcharts.chart('footfalllive', {
    chart: {
        type: 'column',
        height:200
    },
...
Highcharts.chart('footfalllive2', {
    chart: {
        type: 'column',
        height:200
    },
    ...
    series: [{
        name: 'Footfall Male',      
        data: footfallyaxisarray_jp

    }, {
       name: 'Footfall Female',
        data: footfallyaxisarray_female_jp
    ...
    //     });
      ...
      function watergraphLive(obj){
        var xdata = obj['water']['xdata'];
        var ydata = obj['water']['ydata'];

        var xdata_jp = obj['water_jp']['xdata'];
        var ydata_jp = obj['water_jp']['ydata'];
        //var footfallyaxisarray_female = obj['footfallyaxisarray_female'];
        document.getElementById("waterlevel").style.display="block";
        document.getElementById("waterlevel2").style.display="block";
