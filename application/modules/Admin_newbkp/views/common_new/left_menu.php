 ...
 <!-- Left side column. contains the logo and sidebar -->
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview" id="management">
          <a href="<?php echo site_url('Admin/Management'); ?>"><i class="fa fa-user-plus"></i> <span>Data Management  </span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
		...
		<?php } ?>
    <?php if($this->session->userdata('user_id')==4545){?>
      <li class="treeview" id="wmd">
          <a href="<?php echo site_url('Admin/Water_management'); ?>"><i class="fa fa-user-plus"></i> <span>Water Management</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
		  <ul class="treeview-menu">
            <li><a href="<?php echo site_url('Admin/Water_management'); ?>"><i class="fa fa-circle-o"></i> Manage Water Meter dashboard</a></li>
			<li><a href="<?php echo site_url('Admin/Partners/create_partner'); ?>"><i class="fa fa-circle-o"></i> Water Meter Settings</a></li>
      <li><a href="<?php echo site_url('Admin/WaterManagementApp/create_watermanagement'); ?>"><i class="fa fa-circle-o"></i> Add water meter</a></li>
		...
		<li class="treeview" id="accounts">
          <a href="<?php echo site_url('Admin/Accounts'); ?>"><i class="glyphicon glyphicon-list-alt"></i> <span>Documents</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
		  <ul class="treeview-menu">
            <li><a href="<?php echo site_url('Admin/Accounts'); ?>"><i class="fa fa-circle-o"></i> Manage Documents</a></li>
			<li><a href="<?php echo site_url('Admin/Accounts/create_account'); ?>"><i class="fa fa-circle-o"></i> Add Documents</a></li>
    ...
    <?php if($this->session->userdata('user_id')!=1){?>
		<li class="treeview">
          <a href="<?php echo site_url('Admin/Holiday_shift/create_holiday'); ?>"><i class="fa fa-arrows"></i> <span>Holiday Manager</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
    ...
    <?php if($this->session->userdata('user_id')!=1){?>
		<li class="treeview">
          <a href="<?php echo site_url('Admin/Holiday_shift/create_shifts'); ?>"><i class="fa fa-arrows-h"></i> <span>Shift Planner</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li><a href="<?php echo site_url('Admin/Hardware/Qrcodes'); ?>"><i class="fa fa-circle-o"></i> QR Code List</a></li>
