...
<body >
    <div id="MnCtnr" class="DshMnCtnr">
		...
		if(in_array($permission,explode(',',$permissions))){
			...
			$pumps=$firepumps;	
			// echo "<pre>";print_r($pumps->result());exit;
                ...
                <div class="DshBrdSctnDtls WhtBkgrnd FrPmp device" id="devicebox<?php echo $dev['device_id']?>">
                    ...
                    <div class="fire_sub">
						<div class="fire_dgset">
							...
							<ul class="SctnDtlsGrdTbl">
							<li><div class="ClLft">Fuel Consumption</div><div class="ClRgt"><?php echo $dgdata[0]['fuelConsumed']?>0Ltrs</div></li>
						...
						<span class="LiquidStatus"><?php echo $level+98?>%</span>
						</div>
						</div>
						</div>
						...
						<li><div class="ClLft">Current Level</div><div class="ClRgt">198KL</div></li>
						<li><div class="ClLft">Filled</div><div class="ClRgt"><?php echo $level+98?>%</div></li>
						</ul>
						</div>
						</div>
						</div>
