...
<head>
  ...
  <link rel="shortcut icon" type="imag/x-icon" href="<?php echo base_url(); ?>asset/common-utilits/dist/img/fav.ico">
   ...
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.7.0/animate.c<?php echo base_url(); ?>
...
<!-- jQuery Knob -->
<script src="<?php echo base_url(); ?>asset/common-utilits/bower_components/jquery-knob/js/jquery.knob.js"></script>
<!-- Sparkline -->
