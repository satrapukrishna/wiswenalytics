  ...
  <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
						...
						<a href="<?php echo site_url('Admin_qr/Hardware_category') ?>">Back</a>
						<?php }else{?>
						<a href="<?php echo site_url('Admin_qr/Hardware_category/device') ?>">Back</a>
						<?php } ?>
						</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php if (isset($category_name) && $category_name){ ?>
                                    <?php echo form_open_multipart('Admin_qr/Hardware_category/edit_category/' . $category_name['category_id'] . '/edit', array('id' => 'edit_category','class' => 'form-horizontal')); ?>
									...
									<div class="form-group">
                                        ...
                                        <div class="form-group">
                                             <div class="col-md-8 text-center">
                                                ...
                                                <a data-toggle="tooltip"  title="Cancle" href="<?php echo site_url('Admin_qr/Hardware_category'); ?>" class="btn btn-default">Cancel</a>
                                             </div>
                                        </div>
                                </form>
							<?php }else	if (isset($device) && $device){ ?>
								<?php echo form_open_multipart('Admin_qr/Hardware_category/edit_device/' . $device['device_id'] . '/edit', array('id' => 'edit_device','class' => 'form-horizontal')); ?>
									...
									<div class="form-group">
                                        ...
                                        <div class="form-group">
                                             <div class="col-md-8 text-center">
                                                 <button data-toggle="tooltip" title="Save" title="Save" type="submit" class="btn btn-success">Save</button> &nbsp;
                                                <a data-toggle="tooltip"  title="Cancle" href="<?php echo site_url('Admin_qr/Hardware_category/device'); ?>" class="btn btn-default">Cancel</a>
                                             </div>
                                        </div>
                                </form>
							<?php }else{ ?>
							<?php if($this->uri->segment(4)=='category'){?>
                                <p><?php echo validation_errors(); ?></p>
                                <?php echo form_open_multipart('Admin_qr/Hardware_category/create_category/', array('id' => 'create_category','class' => 'form-horizontal')); ?>
                                    <div class="form-group">
                                        <?php if (isset($msg)): ?>
										<p class="alert alert-success"><?php echo $msg; ?></p>
                                        <?php endif; ?>
							...
							<?php }else{ ?> 
								...
								<?php echo form_open_multipart('Admin_qr/Hardware_category/create_hardware_device/', array('id' => 'create_hardware_device','class' => 'form-horizontal')); ?>
