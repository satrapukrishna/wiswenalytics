...
<script type="text/javascript">
    ...
    $('#collapseall').click(function(event) 
    {
        ...
        // if($( "#alltank" ).is( ":visible" ) && $( "#flowmeters" ).is( ":visible" ) && $( "#dgset" ).is( ":visible" ) && $( "#emeter" ).is( ":visible" ) && $( "#fpump" ).is( ":visible" ) && $( "#lpg" ).is( ":visible" ) )
        // {
        //     $('#alltank').toggle();
        //     $('#flowmeters').toggle();
        //     $('#dgset').toggle();
...
function displayAlData(data)
{
    ...
    {
        // var maindiv='<div class="bxslider" id="bxid">';
        if(d[i]['UtilityName']=='Volume_DT 1-4/27-20')
        { 
             item+='<div><div class="SctnDtlsHldr"><div class="SldrCntnr"><div class="SctnDtls WtrTnkLvl"><div class="TnksHldr"><div class="LftHldr"><div class="LiquidTank"><div class="Liquid l-30"></div></div></div><div class="RgtHldr"><div class="LiquidTank Smll"><div class="Liquid l-30"></div><span class="LiquidStatus">'+Math.round(((d[i]['Consumption'])/142000)*100)+'%</span></div></div></div><span class="SctnTtl">Domestic Tank 1-4/17-20</span><ul class="SctnDtlsGrdTbl"><li><div class="ClLft">Total Capacity</div><div class="ClRgt">850KL</div></li><li><div class="ClLft">Current Level</div><div class="ClRgt">'+Math.round(d[i]['Consumption']/1000)*6+'KL</div></li><li><div class="ClLft">Filled</div><div class="ClRgt">'+Math.round(((d[i]['Consumption'])/142000)*100)+'%</div></li></ul></div></div></div></div>';
            
            
        }
        if(d[i]['UtilityName']=='Volume_DT 5-10/11-16')
        { 
            item+='<div class="SctnDtlsHldr"><div class="SldrCntnr"><div class="SctnDtls WtrTnkLvl"><div class="TnksHldr"><div class="LftHldr"><div class="LiquidTank"><div class="Liquid l-30"></div></div></div><div class="RgtHldr"><div class="LiquidTank Smll"><div class="Liquid l-30"></div><span class="LiquidStatus">'+Math.round(((d[i]['Consumption'])/142000)*100)+'%</span></div></div></div><span class="SctnTtl">Domestic Tank 5-10/11-16</span><ul class="SctnDtlsGrdTbl"><li><div class="ClLft">Total Capacity</div><div class="ClRgt">850KL</div></li><li><div class="ClLft">Current Level</div><div class="ClRgt">'+Math.round(d[i]['Consumption']/1000)*6+'KL</div></li><li><div class="ClLft">Filled</div><div class="ClRgt">'+Math.round(((d[i]['Consumption'])/142000)*100)+'%</div></li></ul></div></div></div>';   
        }

        if(d[i]['UtilityName']=='Volume_CT 1-6')
        { 
            item+='<div class="bxslider" id="bxid"><div class="SctnDtlsHldr"><div class="SldrCntnr"><div class="SctnDtls WtrTnkLvl"><div class="TnksHldr"><div class="LftHldr"><div class="LiquidTank"><div class="Liquid l-30"></div></div></div><div class="RgtHldr"><div class="LiquidTank Smll"><div class="Liquid l-30"></div><span class="LiquidStatus">'+Math.round(((d[i]['Consumption'])/142000)*100)+'%</span></div></div></div><span class="SctnTtl">Collection Tank 1-6</span><ul class="SctnDtlsGrdTbl"><li><div class="ClLft">Total Capacity</div><div class="ClRgt">850KL</div></li><li><div class="ClLft">Current Level</div><div class="ClRgt">'+Math.round(d[i]['Consumption']/1000)*6+'KL</div></li><li><div class="ClLft">Filled</div><div class="ClRgt">'+Math.round(((d[i]['Consumption'])/142000)*100)+'%</div></li></ul></div></div></div>';   
        }
