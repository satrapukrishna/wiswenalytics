...
class Prk_model extends CI_Model{
    ...
    function getChillerData(){
        $queryStatus="SELECT TxnDate,FromTime,ToTime,PrvReading,CurReading  FROM app_device_station_consumtion_cbre where UtilityName='Chiller Status_Chiller_4' and TxnDate='2020-01-21'";
        $dataStatus = $this->db->query($queryStatus)->result();
        $query="SELECT TxnDate,FromTime,ToTime,PrvReading,CurReading  FROM app_device_station_consumtion_cbre where UtilityName='Chiller Status_Chiller_4' and TxnDate='2020-01-21' and CurReading=1";
        $data = $this->db->query($query)->result(); 
    ...
    function getCoolingData(){
        $queryStatus="SELECT TxnDate,FromTime,ToTime,PrvReading,CurReading  FROM app_device_station_consumtion_cbre where UtilityName='CT Fan Status_CT Fan' and TxnDate='2020-01-21'";
        $dataStatus = $this->db->query($queryStatus)->result();
        $query="SELECT TxnDate,FromTime,ToTime,PrvReading,CurReading  FROM app_device_station_consumtion_cbre where UtilityName='CT Fan Status_CT Fan' and TxnDate='2020-01-21' and CurReading=1";
        $data = $this->db->query($query)->result(); 
