		...
		if($meterserial=='71'){
			...
			foreach($firepumpList as $list){
				...
				//    echo $runn_today;die();
		   		...
		   		$pressure="SELECT round(CurReading*Multiplier,2) as pressure,TxnTime FROM $table_name_live where UtilityName='Old Fire Pump' and LocationName='Fire Pump House' and MeterSerial='0068' and LineConnected='Pressure' and StationId='".$station_id."' and TxnDate='".$todayDate."'  ORDER BY TxnTime asc ";
				   //echo $pressure;die();
	...
	function get_hardwares_device_data_hydro($data){
       ...
       // $todayDate='2020-07-11';
		...
		$resultArray=array();
		   ...
		   $pressure="SELECT round(CurReading*Multiplier,2) as pressure,TxnTime FROM $table_name_live where UtilityName='PressureMonitor' and LocationName='Hyd.Pneu.System' and StationId='".$station_id."' and TxnDate='".$todayDate."'  ORDER BY TxnTime asc ";
		//  echo  $pressure;die(); 
		   $pressuredata = $this->db->query($pressure)->result_array();		  
		   $resultArray['pressure_data']=$pressuredata;
		   return $resultArray;
