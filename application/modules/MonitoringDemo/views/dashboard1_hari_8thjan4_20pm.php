...
<head>
    ...
    <script type="text/javascript">
      ...
      function appendData(obj)
      {
        ...
        var j=1;
        // alert(obj.length);
        // rows+='<table id = "list1" class="table table-bordered table-hover"><thead><tr><th>SNo</th><th>Meter</th><th>Date</th><th>Time</th><th>Footfall</th></tr></thead><tbody></tbody></table>';
                ...
                <div class="SctnSrch" style="display: none;" id="reportsid">
                    <ul class="SrchLst">
                        ...
                        <li>
                            ...
                            <input type="button" class="Btn1"  id="export"   onclick="exportTableToExcel('list1')" style="display: none;" value="Export">
                        </li>
                    </ul>
...
<script type="text/javascript">
  ...
  function displaySodexoData(data)
  {
      ...
      div+='<div class="CntntDtls"><div class="Frst"><span class="TlNm Bld Txt">Madhapur Clean Toilets</span><span class="Txt Bld">Address:</span><span class="Txt">'+d[0]['StationName']+'</span></div><div class="Scnd"><div class="Dtls RFID"><div class="Hldr"><span class="Txt">No. of times swiped</span><span class="TxtHghlgt">NA</span></div><div class="Hldr"><span class="Txt">No. of times cleaning verified</span><span class="TxtHghlgt">NA</span></div><div class="Hldr"><input type="button" class="Btn" value="Details"></div></div><div class="Dtls Stink Good"><div class="Hldr"><span class="Txt">Stink Level</span><span class="TxtHghlgt">NA</span></div><div class="Hldr"><input type="button" class="Btn" value="Acceptable"></div></div><div class="Dtls WaterLevel"><div class="Hldr"><span class="TxtTtl">Water Level</span><span class="TxtHghlgt">NA</span><span class="Txt">NA</span></div><div class="Hldr"><span class="TxtTtl">Water Consumed</span><span class="TxtHghlgt">NA</span><span class="Txt">NA</span></div></div><div class="Dtls Footfall"><div class="Hldr"><span class="Txt">No. of Persons Walked In</span><span class="TxtHghlgt">'+Math.round((d[0]['footfallcountMale']/2))+'</span></div><div class="Hldr"><input type="button" class="Btn" value="Details"></div></div><div class="Dtls Feedback"><div class="Hldr"><span class="Txt">Feedback</span></div><div class="Hldr Fdbck Good"><span class="Grade">Good</span><span class="Value">60/80</span></div><div class="Hldr Fdbck Average"><span class="Grade">Average</span><span class="Value">15/80</span></div><div class="Hldr Fdbck Bad"><span class="Grade">Bad</span><span class="Value">5/80</span></div></div><div class="Dtls TltDtt"><div class="InnrDtls TxtTtl">Hand Towel</div><div class="InnrDtls ImgHldr"><img src="<?php echo base_url(); ?>/asset/sodexoasset/asset/Images/Blank.png" class="HndTwl Actv" /></div><div class="InnrDtls Stts"><span class="ATxt" id="handavl" style="display: visible;">Available</span><span class="NATxt" id="handnoavl" style="display: none;">Not Available</span></div></div><div class="Dtls TltDtt"><div class="InnrDtls TxtTtl">Toilet Rolls</div><div class="InnrDtls ImgHldr"><img src="<?php echo base_url(); ?>/asset/sodexoasset/asset/Images/Blank.png" class="TltRlls Actv" /></div><div class="InnrDtls Stts"><span class="ATxt" id="toiletrollavl" style="display: none;">Available</span><span class="NATxt" id="toiletrollnoavl" style="display: visible;">Not Available</span></div></div><div class="Dtls TltDtt"><div class="InnrDtls TxtTtl">Dustbin</div><div class="InnrDtls ImgHldr"><img src="<?php echo base_url(); ?>/asset/sodexoasset/asset/Images/Blank.png" class="DstBn Actv" /></div><div class="InnrDtls Stts"><span class="ATxt" id="dustbinavl" style="display: none;">Available</span><span class="NATxt" id="dustbinnoavl" style="display: visible;">Not Available</span></div></div><div class="Dtls TltDtt"><div class="InnrDtls TxtTtl">Floor</div><div class="InnrDtls ImgHldr"><img src="<?php echo base_url(); ?>/asset/sodexoasset/asset/Images/Blank.png" class="Flr Actv" /></div><div class="InnrDtls Stts"><span class="ATxt" id="flooravl" style="display: visible;">Dry</span><span class="NATxt" id="floornoavl" style="display: none;">Wet</span></div></div><div class="Dtls TltDtt"><div class="InnrDtls TxtTtl">Hand Soap</div><div class="InnrDtls ImgHldr"><img src="<?php echo base_url(); ?>/asset/sodexoasset/asset/Images/Blank.png" class="HndSp Actv" /></div><div class="InnrDtls Stts"><span class="ATxt" id="handsoapavl" style="display: visible;">Available</span><span class="NATxt" id="handsoapnoavl" style="display: none;">Not Available</span></div></div></div></div>';
