    ...
    <div id="MnCtnr" class="DshMnCtnr">
        ...
        <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
                <div class="DshBrdSctnTtl" id="water">
                    <span class="TxtTtl imageadd"><img src="<?php echo site_url() ?>asset/demoforall/Images/water-level.png" width="30" />Water Levels</span>
				...
				<div class="bxslider555" id="bxid">
						...
						<div class="Liquid Liquidhigh l-75"></div>
						</div>
						...
						<span class="LiquidStatus"><?php echo $level+75?>%</span>
						</div>
						</div>
						<span class="SctnTtl tank-title">Domestic Tank</span>
						</div>
					   
						<ul class="SctnDtlsGrdTbl">
						<li><div class="ClLft">Total Capacity</div><div class="ClRgt">500 KL</div></li>
						<li><div class="ClLft">Current Level</div><div class="ClRgt">375 KL</div></li>
						<li><div class="ClLft">Filled</div><div class="ClRgt"><?php echo $level+75?>%</div></li>
						</ul>
						</div>
						</div>
						</div>
					...
					<div class="fire_waterpump">
						...
						<span class="LiquidStatus"><?php echo $level+20?>%</span>
						</div>
						</div>
						<span class="SctnTtl tank-title">Flush Tank</span>
						</div>
					   
						<ul class="SctnDtlsGrdTbl">
						<li><div class="ClLft">Total Capacity</div><div class="ClRgt">500 KL</div></li>
						<li><div class="ClLft">Current Level</div><div class="ClRgt">100 KL</div></li>
						<li><div class="ClLft">Filled</div><div class="ClRgt"><?php echo $level+20?>%</div></li>
						</ul>
						</div>
						</div>
						</div>
				...
				<div class="DshBrdSctnDtls device devicebox555"  style="background-color:#fff;padding:10px;border-bottom: 1px solid #d0cfcf;">
				<h4 class="head-h4">Basement - 2</h4>
				...
				<div class="bxslider555" id="bxid">
					...
					<div class="fire_waterpump">
						...
						<span class="LiquidStatus">100%</span>
						</div>
						</div>
						<span class="SctnTtl tank-title">Flush Tank</span>
						</div>
				...
				<div class="bxslider600" id="bxid">
					...
					<div class="SldrCntnr">
						<div class="SctnDtls DGGnrtrHldr">
							...
							<div class="Liquid High" style="height:50px !important;"></div>
            ...
            <div class="DshBrdSctnTtl" id="lpg">
                <span class="TxtTtl imageadd"><img src="<?php echo site_url() ?>asset/demoforall/Images/LPG-C.png" width="40" />Oxygen Plants</span>
            ...
            <h4 class="head-h4">Oxygen Plant - 1</h4>
            ...
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
                ...
                <?php for ($i=0; $i < count($water_meter_data); $i++) 
					...
					<div class="SldrCntnr">
					<div class="SctnDtls BorewellHldr">
					<span class="SctnTtl"><?php echo $water_meter_data[$i]['meter']; ?> </span>
					<ul class="SctnDtlsGrdTbl">
						
						<li><div class="ClLft">Today's Inflow</div><div class="ClRgt"><?php echo $water_meter_data[$i]['todayconsumption']; ?>KL</div></li>
						<li><div class="ClLft">Yesterday Inflow</div><div class="ClRgt"><?php echo $water_meter_data[$i]['yesterdayconsumption']; ?>KL</div></li>
                        <li><div class="ClLft">This Month`s Inflow</div><div class="ClRgt"><?php echo $water_meter_data[$i]['monthly_consumption']; ?>KL</div></li>
						<li><div class="ClLft">Average/day</div><div class="ClRgt"><?php echo $water_meter_data[$i]['weeklyavg']; ?>KL</div></li>
			...
			<div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
                ...
                <div class="DshBrdSctnDtls WhtBkgrnd FrPmp device devicebox1111" id="devicebox1111">
                    <table class="SctnDtlsDualGrd">
                        ...
                        <?php for ($i=0; $i < count($firepump_data['Phase-1 Fire Pump System']); $i++) 
         				 {
							  ?>
                        <tr>
                            <td>
                                <span class="Txt Ttl"><?php echo $firepump_data['Phase-1 Fire Pump System'][$i]['meter'] ?></span>
                            </td>
                            <td>
                            ...
                            <td>
								...
								<?php if($firepump_data['Phase-1 Fire Pump System'][$i]['running_status']){ ?>
								<span class="status-on">ON</span>
								<?php }else{ ?>
                            ...
                            <td>
                                ...
                                <span class="Txt"><?php echo $firepump_data['Phase-1 Fire Pump System'][$i]['today_running_hours'] ?> Min</span>
                            </td>
                            <td>
                                <span class="Txt MblTtl">Yesterday</span>
                                <span class="Txt"><?php echo $firepump_data['Phase-1 Fire Pump System'][$i]['yesterday_running_hours'] ?> Mins</span>
                            </td>
                            <td>
                                <span class="Txt MblTtl">Last Week</span>
                                <span class="Txt"><?php echo $firepump_data['Phase-1 Fire Pump System'][$i]['lastweek_running_hours'] ?> Mins</span>
                            </td>
                            <td>
                                <span class="Txt MblTtl">Monthly</span>
                                <span class="Txt"><?php echo $firepump_data['Phase-1 Fire Pump System'][$i]['monthly_running_hours'] ?> Mins</span>
                            </td>
						...
						<!-- <tr>
                            <td>
                                <span class="Txt Ttl">Main Pump</span>
                            </td>
                            <td>
                                <span class="Txt MblTtl">Running Status</span>
                            ...
                            <td>
                                <span class="Txt MblTtl">Today</span>
                                <span class="Txt">0 Min</span>
                            </td>
                            <td>
                                <span class="Txt MblTtl">Yesterday</span>
                                <span class="Txt">0 Mins</span>
                            </td>
                            <td>
                                <span class="Txt MblTtl">Last Week</span>
                                <span class="Txt">0 Mins</span>
					...
					<div class="fire_sub">
						<div class="fire_dgset">
							...
							<span class="SctnTtl_buttn">
							<button class="status-na">NA</button>
							...
							// $fuel=40;
							?>
								<!-- <div class="Liquid l-0" style="height:246px !important;"></div> -->
                                <div class="Liquid l-0" ></div>
			...
			<div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
                ...
                <div class="DshBrdSctnDtls WhtBkgrnd FrPmp device devicebox1116" id="devicebox1111">
                    <table class="SctnDtlsDualGrd">
						...
						<tr>
                            <td>
                                <span class="Txt Ttl">Diesel Engine Driven Pump</span>
                            </td>
                            <td>
                                <span class="Txt MblTtl">Running Status</span>
					...
					<div class="fire_sub">
						<div class="fire_dgset">
							...
							// $fuel=40;
							?>
								<div class="Liquid l-<?php echo $firepump_data['Phase-2 Fire Pump System']['dg_data']['filledper'] ?>" style="height:246px !important;"></div>
                ...
                <span class="status-na">NA</span>
					...
					<ul class="SctnDtlsGrdTbl lpgdiv">
                            <li>
                                ...
                                <div class="ClRgt liright">NA</div>
                            </li>
                            <li>
            ...
            <div class="DshBrdSctn" style="padding: 10px 30px 10px 38px;">
                <div class="DshBrdSctnTtl" id="borewell">
                    <span class="TxtTtl imageadd"><img src="<?php echo site_url() ?>asset/demoforall/Images/motor-c.png" width="40" />BOREWELL</span>
                ...
                <?php for ($i=0; $i < count($borewell_data); $i++) 
					...
					<ul class="SctnDtlsGrdTbl">
                        ...
                        <li><div class="ClLft">This Month`s Running Hours</div><div class="ClRgt"><?php echo $borewell_data[$i]['monthly_consumption']; ?></div></li>
...
var fdps1=[];
    var fdps2=[];      
    fdps1=[8.83, 8.83, 8.83, 8.83, 8.83, 8.83, 8.83, 8.83, 8.82, 8.82, 8.82, 8.82, 8.82, 8.82, 8.81, 8.81, 8.81, 8.81, 8.81, 8.81, 8.81, 8.81, 8.81, 8.81, 8.81, 8.80, 8.80, 8.95, 8.9, 8.94, 8.92, 8.92, 8.92, 8.92, 8.92, 8.91, 8.91, 8.91, 8.91, 8.91, 8.91, 8.91, 8.90, 8.90, 8.90, 8.90, 8.90, 8.90, 8.82, 8.82, 8.89, 8.89, 8.89, 8.89, 8.89, 8.89, 8.89, 8.88, 8.88, 8.88, 8.88, 8.88, 8.88, 8.88, 8.87, 8.87, 8.87, 8.87, 8.87, 8.87, 8.87, 8.87, 8.87, 8.86, 8.86, 8.86, 8.86, 8.86, 8.86, 8.86, 8.85, 8.85, 8.85, 8.85, 8.85, 8.85, 8.85, 8.85, 8.85, 8.84, 8.84, 8.84, 8.84, 8.84];
...
// var fdps1=[];
//     var fdps2=[];      
//     fdps1=[9.43, 9.43, 9.43, 9.43, 9.43, 9.43, 9.43, 9.43, 9.42, 9.42, 9.42, 9.42, 9.42, 9.42, 9.41, 9.41, 9.41, 9.41, 9.41, 9.41, 9.41, 9.41, 9.41, 9.41, 9.41, 9.40, 9.40, 9.55, 9.5, 9.54, 9.52, 9.52, 9.52, 9.52, 9.52, 9.51, 9.51, 9.51, 9.51, 9.51, 9.51, 9.51, 9.50, 9.50, 9.50, 9.50, 9.50, 9.50, 9.2, 9.2, 9.49, 9.49, 9.49, 9.49, 9.49, 9.49, 9.49, 9.48, 9.48, 9.48, 9.48, 9.48, 9.48, 9.48, 9.47, 9.47, 9.47, 9.47, 9.47, 9.47, 9.47, 9.47, 9.47, 9.46, 9.46, 9.46, 9.46, 9.46, 9.46, 9.46, 9.45, 9.45, 9.45, 9.45, 9.45, 9.45, 9.45, 9.45, 9.45, 9.44, 9.44, 9.44, 9.44, 9.44];
//     fdps2=["05:40:36", "05:52:10", "06:04:15", "06:16:20", "06:39:38", "06:50:52", "07:02:47", "07:13:50", "07:37:52", "07:49:52", "08:01:52", "08:13:31", "08:24:46", "08:35:59", "08:47:44", "08:58:57", "09:10:51", "09:22:41", "09:33:43", "09:44:35", "09:55:30", "10:06:47", "10:17:36", "10:28:53", "10:40:30", "10:51:39", "11:02:39", "11:13:56", "11:25:40", "11:36:55", "11:48:37", "12:10:38", "12:21:45", "12:32:37", "12:43:54", "12:55:56", "13:07:44", "13:18:34", "13:29:32", "13:40:49", "13:51:55", "14:03:43", "14:14:32", "14:25:48", "14:36:35", "14:47:38", "14:58:30", "15:09:46", "15:20:55", "15:32:51", "15:44:38", "15:55:34", "16:06:40", "16:17:34", "16:28:56", "16:40:40", "16:51:43", "17:02:35", "17:13:36", "17:24:29", "17:35:37", "17:46:57", "17:58:57", "18:10:50", "18:22:44", "18:33:53", "18:33:53", "18:45:36", "18:56:52", "19:08:42", "19:19:38", "19:30:57", "19:42:38", "19:53:36", "20:04:42", "20:15:46", "20:26:49", "20:38:34", "20:49:48", "21:00:51", "21:12:53", "21:24:48", "21:35:33", "21:46:46", "21:57:32", "22:08:44", "22:19:39", "22:30:32", "22:41:49", "22:52:47", "23:03:34", "23:14:53", "23:26:41", "23:37:57"]
...
var pdps1=[];
var pdps2=[];
   var data=<?php echo json_encode($hydro_data[0]['pressure_data']); ?>;
   for (let i = 0; i < data.length; i++) {
