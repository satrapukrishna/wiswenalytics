        ...
        <div id="DshbrdRgtCtnr" class="DshBrdCtnr">
			<div class="DshBrdSctn">
				<div class="DshBrdSctnDtls">
					<form name="reports" id="myForm" action="<?php echo site_url("Admin/Home/all_reports_rsbrother")?>" method="post" onSubmit="return formValidation();">
						<div class=SrchFullBx>
							...
							<div class="SrchBtnHldr">
								...
								<a href="<?php echo site_url('Admin/Home/all_reports_rsbrother') ?>" class="btn btn-info reset">Reset</a></span>
...
function getsolutions(){
    ...
    $.ajax({
        ...
        url: BASE_URL+'Admin/Home/ajax_hardware_device_dropdown_rsbro/',
