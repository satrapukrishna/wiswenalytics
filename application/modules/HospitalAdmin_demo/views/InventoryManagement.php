...
<head>
    <meta http-equiv="refresh" content="0;URL='<?php echo base_url(); ?>HospitalAdmin_demo/inventorySanitation'" />
    <meta charset="UTF-8" />
        ...
        <div class="ContainerLeft">
            ...
            <div class="SctnInnerLnks">
                <ul class="InnrLnksHldr">
                    <li>
                        <a href="#" class="LnkTxt Snttn Icn">Sanitation</a>
                    </li>
                    <li>
        ...
        <div class="ContainerRight">
            <div class="SctnDtlsTtlHldr">
                <div class="BrcmnbHldr">
                    <ul class="DtlsBrdCrmb">
                        <li>
                            <span class="PgTtl">All Inventory</span>
                        </li>
                    </ul>
                </div>
                <div class="SlctDrpdwnHldr">
                    <ul class="TbTtlLnkHldr">
                        <li>
                            <span class="TbLnk Grphvw">Graph View</span>
                        </li>
                        <li>
                            <span class="TbLnk Grdvw Actv">Grid View</span>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="InnrPgBgHldr">
                <div class="InvnthryDshbrdMnHldr">
                    <div class="ChcklstDshbrdHldr InvntyDshbrd">
                        <div class="FtrTtlHldr Icn Twr">
                            <a href="#" class="FtrTtl"><span class="LnkTxt">Tower 01</span></a>
                        </div>
                        ...
                        <div class="InventryBscDtls">
                            <span class="AraName">Sanitation</span>
                        ...
                        <div class="InventryBscDtls">
                            <span class="AraName">Medical Equipments</span>
                            <div class="BscDtlsHldr">
                                <span class="InvtryTypTtl">Toilet Paper</span>
                                <div class="InvtryDtl Icn TltPpr">
                                    <span class="VluTxt">212</span>
                        ...
                        <div class="InventryBscDtls">
                            <span class="AraName">Wheelchairs and Stretchers</span>
                            <div class="BscDtlsHldr">
                                <span class="InvtryTypTtl">Toilet Paper</span>
                                <div class="InvtryDtl Icn TltPpr">
                                    <span class="VluTxt">212</span>
                        ...
                        <div class="InventryBscDtls">
                            <span class="AraName">Engineering</span>
                            <div class="BscDtlsHldr">
                                <span class="InvtryTypTtl">Toilet Paper</span>
                                <div class="InvtryDtl Icn TltPpr">
                                    <span class="VluTxt">212</span>
                    ...
                    <div class="ChcklstDshbrdHldr InvntyDshbrd">
                        <div class="FtrTtlHldr Icn Twr">
                            <a href="#" class="FtrTtl"><span class="LnkTxt">Tower 02</span></a>
                        </div>
                        <div class="StckDtlsRprt">
                            <span class="RprtTxt">
                                <span class="DysTxt">08</span><span class="DtlTxt">days of stock remaining.</span>
                    ...
                    <div class="ChcklstDshbrdHldr InvntyDshbrd">
                        <div class="FtrTtlHldr Icn Twr">
                            <a href="#" class="FtrTtl"><span class="LnkTxt">Tower 03</span></a>
                        </div>
                        <div class="StckDtlsRprt">
                            <span class="RprtTxt">
                                <span class="DysTxt">08</span><span class="DtlTxt">days of stock remaining.</span>
