    ...
    <div class="ContainerLeft">
            ...
            <div class="SctnInnerLnks">
                ...
                <ul class="InnrLnksHldr">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/attendenceList" class="LnkTxt Actv">Attendence</a>
                    </li>
                </ul>
            </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-2 BttnHldr">
                            <button type="button" onclick="javascript:ModalPopup();" class="btn btn-primary SbmtBtn">Add Attendence</button>
                        </div>
                        ...
                        <div class="col-md-2 BttnHldr">
                            <a href="<?php echo base_url(); ?>asset/hospital_admin/Documents/Attendance_sheet.xlsx" class="btn" download><i class="fa fa-download"></i>Sample Attendence</a>                           
                        </div>
