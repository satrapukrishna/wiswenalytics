...
<style>
    a.MnDshbrdLnk {
        ...
        background: rgba(0,0,0,0.1) url(../../asset/loginasset/images/TeroTAM-Tm-Logo.svg) no-repeat left 10px center;
...
<div id="DshbrdLft" class="DshBrdLnk">
            <div class="BrndHldr"><span class="BrndNm"><?php echo $this->session->userdata('client_name')?></span></a>
            <!-- <img  width="100%" height="50%"  style="
    margin-top: 10px;" src="../../asset/loginasset/images/TeroTAM-Tm-Logo.svg"/> -->
                <!-- <a href="<?php //echo site_url('Admin/Home/water')?>" class="MnDshbrdLnk" ></a> -->
            </div>
                ...
                <ul class="LnkHldr FrstLvl">
                        ...
                        <?php if(modules::run('Admin/Site/authlink','energy_Energy-Meter')){ ?>
                            <li>
                                <?php if($this->session->userdata('created_by')==35){ ?>
                                    ...
                                    <?php }elseif($this->session->userdata('created_by')==38555){?>
                                        ...
                                        <?php }elseif($this->session->userdata('user_id')==43){?>
                                            <a href="<?php echo site_url('Admin/Home/energy_undp_single/')?>#energy" class="Lnk"><img src="<?php echo site_url() ?>asset/demoforall/Images/Electric-Meter-W.png" width="22px"/> <span class="Txt">Energy Meter</span></a>
                    ...
                    */?>
                    ...
                    <?php } if($this->session->userdata('created_by')==35){?>
                        ...
                        <?php } if($this->session->userdata('created_by')==3844){?>                       
                    ...
                    <?php } if($this->session->userdata('created_by')==43){?>
                        <a href="<?php echo site_url('Admin/Home/calender_view') ?>" class="Lnk Arr" id="reportss"><img src="<?php echo site_url() ?>asset/admin/img/reports-img.png" width="20px"/> <span class="Txt">Calender View</span></a>
                    ...
                    <?php } if($this->session->userdata('user_id')==43){?>
                        <a href="<?php echo site_url('Admin/Home/calender_view_undp') ?>" class="Lnk Arr" id="reportss"><img src="<?php echo site_url() ?>asset/admin/img/reports-img.png" width="20px"/> <span class="Txt">Calender View</span></a>
                        <a href="<?php echo site_url('Admin/Home/all_reports_undp_single') ?>" class="Lnk Arr" id="reportss"><img src="<?php echo site_url() ?>asset/admin/img/reports-img.png" width="20px"/> <span class="Txt">Reports</span></a>
