		...
		<div class="DshBrdSctn">
			...
			<div class="DshBrdSctnDtls"  style="background:#fff">
				<div class="row meter-top col-md-12">
					...
					if($m1=='fprr'){
						$this->load->view('reportcommon1/runnreport');
					}if($m1=='fpsvr'){
						$this->load->view('reportcommon1/statusview');
					}if($m1=='fpdrr'){
						$this->load->view('reportcommon1/dgreport');
					}
					if($m1=='fpdfar'){
						$this->load->view('reportcommon1/fadded');
					} 
					if($m1=='fpcr'){
						$this->load->view('reportcommon1/runnreport');
						$this->load->view('reportcommon1/statusview');
						$this->load->view('reportcommon1/dgreport');
						$this->load->view('reportcommon1/fadded');
						$this->load->view('reportcommon1/alertstatus');
					} 
