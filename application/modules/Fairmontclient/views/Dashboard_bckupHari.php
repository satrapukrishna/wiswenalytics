...
<head>
    ...
    <script type="text/javascript">
        ...
        function fetchAllData()
        {
            ...
            var urlString = "<?php echo base_url();?>Fairmontclient/getwaterdata";
            $.ajax({
                url:urlString,
                type : 'GET',
                async: true,
        ...
        function displayAlData(data)
        {
            ...
            for (var i = 0; i < d.length; i++)
            {
                ...
                if(d[i]['UtilityName']=='Volume_UG Flush Tank')
                {   
                    if(c==0)
                    {
                        ...
                        <ul class="ScndLvl" id="reportsInnerId">
                            <li>
                                ...
                                <ul class="ThrdLvl" id="dgsetinnerid">
                                     <li>
                                        <a href="<?php echo base_url(); ?>Fairmontclient/iaqGraphReport" class="Lnk"><span class="Txt"> Graph Report</span></a>
                                    </li>
                                </ul>
                            </li>
