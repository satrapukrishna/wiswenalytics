        ...
        <div id="DshbrdRgtCtnr" class="DshBrdCtnr">
			<div class="DshBrdSctn">
				<div class="DshBrdSctnDtls">
					<form name="reports" id="myForm" action="<?php echo site_url("Admin/Aurush/water")?>" method="post" onSubmit="return formValidation();">
						<div class=SrchFullBx>
							...
							<div class="SrchBtnHldr">
								...
								<a href="<?php echo site_url('Admin/Aurush/water') ?>" class="btn btn-info reset">Reset</a></span>
				...
				<div class="FullReportDtlsHldr" id="content">
					...
					<?php 	
						//echo print_r($device);die();
						//water tabular
						if($device==41 ){
						$this->load->view('reportcommon/arushreport');
						}
						if($device==19 ){
							$this->load->view('reportcommon/arushreport_waterlevel');
							}
						if($device==25){
								$this->load->view('reportcommon/arushreport_watermeter');
								}
								if($device==23){
									$this->load->view('reportcommon/arushreport_linepressure');
									}
