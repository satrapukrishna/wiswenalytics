                        ...
                        <ul class="ScndLvl" id="reportsInnerId">
                            ...
                            <li>
                                ...
                                <ul class="ThrdLvl" id="eminnerid">                                   
                                    ...
                                    <li>
                                        <a href="<?php echo base_url(); ?>SpInfocityClient/firepumpGraphReport" class="Lnk Actv act"><span class="Txt">Graph Report</span></a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
...
function getGraphReport(){
    ...
    //for (var j = 0; j < noofmeters; j++) {
      $("#loading").css("display", "block");
       ...
       var urlString1 = "firePumpRunningReportgraph";
       var urlString2 = "getDayPressure";
      $.ajax({
        url:urlString1,
        type : 'GET',
        async: true,
...
// }else if(meter=='Hydrant1 Running Time_Fire Pump house'){
//     meter='Hydrant Pump';
// }
