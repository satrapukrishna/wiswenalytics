...
th, td {
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <!-- ChartJS -->
    <script src="<?php echo base_url(); ?>asset/common-utilits/bower_components/Chart.js/Chart.js">
    </script>
    <!-- FastClick -->
...
function appendData(data){
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    rows += "<tr><td>" + j + "</td><td>" + data[i]['meter'] + "</td><td>" + data[i]['Time'] + "</td><td>" + data[i]['runninghrs'] + "</td><td>" + data[i]['Fuelconsume'] + "</td><td>" + data[i]['economy'] + "</td></tr>";
