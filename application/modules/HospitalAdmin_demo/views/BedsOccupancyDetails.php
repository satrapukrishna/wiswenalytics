        ...
        <div class="ContainerLeft">
            ...
            <div class="SctnInnerLnks">
                <ul class="InnrLnksHldr">
                    <li>
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/bedsOccupancyDetails" class="LnkTxt Icn Twr Actv">Tower 01</a>
                    </li>
                    <li>
            ...
            <div class="SctnDtlsTtlHldr">
                <div class="BrcmnbHldr">
                    <ul class="DtlsBrdCrmb">
                        <li>
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/bedsOccupancy" class="BrdCrmLnk">All Towers</a>
                        </li>
                        <li>
