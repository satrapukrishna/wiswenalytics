    ...
    <div id="MnCtnr" class="DshMnCtnr">
       ...
       <input type="hidden" name="date" id="date" value="<?php  echo date('Y-m-d');?>">
        <div id="DshbrdRgtCtnr" class="DshBrdCtnr">
            ...
            <div class="DshBrdSctn">
                <div class="DshBrdSctnTtl" id="fmdiv2">
                    <span class="TxtTtl chlr">UPS</span>
                    <span class="SctnVw Cllps FA" id="flowcollapse"></span>
                    <span class="SctnVwAll Cllps FA" id="collapseall"></span>
                </div>
                 <div class="DshBrdSctnDtls WhtBkgrnd EnrgyMtr" id="flowmeters1">
                ...
                <div class="DshBrdSctnDtls WhtBkgrnd FrPmp" id="fpump">
                    <table class="SctnDtlsDualGrd">
                         ...
                         <tr>
                            ...
                            <td class="Col-2">
                                <span class="Txt MblTtl">Running Status</span>
                                 <span class="Txt Stts Manual" id="hjss"></span>
                            ...
                            <td class="Col-5">
                                ...
                                <span class="Txt">2 min</span>
                            </td>
                            <td class="Col-6">
                                <span class="Txt MblTtl">Last Week</span>
                                <span class="Txt">18 min</span>
                            </td>
                        </tr>
                        <tr>
                            <td class="Col-1">
                        ...
                        <tr>
                            ...
                            <td class="Col-2">
                                <span class="Txt MblTtl">Running Status</span>
                                <span class="Txt Stts Manual" id="mhss"></span>
                            </td>
                             <td class="Col-3">
                                <span class="Txt MblTtl">Switch Status</span>
                        ...
                        <tr>
                            ...
                            <td class="Col-2">
                                <span class="Txt MblTtl">Running Status</span>
                                <span class="Txt Stts Manual" id="msss"></span>
                            </td>
                             <td class="Col-3">
                                <span class="Txt MblTtl">Switch Status</span>
                    ...
                    <div class="EnrgyMtrGuge">
                        ...
                        <div><span style="padding: 190px 119px;"><b>Pressure in Bar</span></b> </div>
...
var test="";
function UpsData(){
    test+='<div class="bxslider" id="dgset">'; 
    test+='<div class="childclass"><div class="SctnDtlsHldr"><div class="SldrCntnr"><div class="SctnDtls ErgyMtrHldr"><span class="SctnTtl"><b>UPS1 </b></span><span class="SctnTtl"><b>Sample Data </b></span><ul class="SctnDtlsGrdTbl"><li><div class="ClLft">UPS Status</div><div class="ClRgt"><span class="Txt Stts auto">DisCharging</span></div></li><li><div class="ClLft">Voltage</div><div class="ClRgt">80 V</div></li><li><div class="ClLft">% Loading on UPS</div><div class="ClRgt">0%</div></li><li><div class="ClLft">Battery Backup Time</div><div class="ClRgt">3 hours 15 min</div></li><li><div  id="container_pressure1" class="container_pressurediv"></div></li></ul></div></div></div></div>';
    test+='<div class="childclass"><div class="SctnDtlsHldr"><div class="SldrCntnr"><div class="SctnDtls ErgyMtrHldr"><span class="SctnTtl"><b>UPS1 </b></span><span class="SctnTtl"><b>Sample Data </b></span><ul class="SctnDtlsGrdTbl"><li><div class="ClLft">UPS Status</div><div class="ClRgt"><span class="Txt Stts auto">DisCharging</span></div></li><li><div class="ClLft">Voltage</div><div class="ClRgt">80 V</div></li><li><div class="ClLft">% Loading on UPS</div><div class="ClRgt">0%</div></li><li><div class="ClLft">Battery Backup Time</div><div class="ClRgt">3 hours 15 min</div></li><li><div  id="container_pressure2" class="container_pressurediv"></div></li></ul></div></div></div></div>';
    
        test+='</div>';
        $('#flowmeters1').append(test);
        var d=13;
var m=4;
Highcharts.chart('container_pressure1', {
    ...
    plotOptions: {
        spline: {
            ...
            pointStart: Date.UTC(2020, m, d, 0, 0, 0)
        }
    },
    series: [{
        name: 'Pressure',
        data: [
            340, 350, 355, 356, 356, 360, 371, 371, 380, 380, 370, 370,
            365, 360, 360, 355, 355, 350, 350, 345
        ]
