            ...
            <div class="DshBrdLnkCntr" id="root" data-simplebar>
                <ul class="LnkHldr FrstLvl">
						...
						<?php if(modules::run('Admin/Site/authlink','water_borewells')){ ?>	
                            <li>
                                <a href="<?php echo site_url('Admin/Home/water/')?>#borewell" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/HydroPnematicSystem.png" width="22px"/> <span class="Txt">Borewells</span></a>
                            </li>
						<?php } ?>
                        ...
                        <?php } ?>
                         <?php if(modules::run('Admin/Site/authlink','energy_btumeters')){ ?>
                            ...
                            <li>
                                <a href="<?php echo site_url('Admin/Home/energy/')?>#dgtrip" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/DG.png" width="22px"/> <span class="Txt">DG Trip Status</span></a>
                            </li>
                              <?php } ?>
						...
						<li>
							<a class="Lnk Arr Slct" href="#" onclick="menushow(559)" id="cat558"><img src="<?php echo site_url() ?>asset/demoforall/Images/air_menu.png" width="20px"/> <span id="dsh" class="Lnk Arr Slct Dshbrd">Switch Controls</span></a>
							<ul class="ScndLvl" id="subcat559" style="display: none;">
								 <li>
								 <a href="<?php echo site_url('Admin/Home/switchcontrol/')?>#swtch" class="Lnk"><img src="<?php echo site_url() ?>asset/demoforall/Images/ahu-w.png" width="35px" style="margin-right:0px"/> <span class="Txt">Switch Control</span></a>
								 </li>
								 <li>
									<a href="<?php echo site_url('Admin/Home/switchcontrol/')?>#swimm" class="Lnk"><img src="<?php echo site_url() ?>asset/admin/images/Chillers.png" width="28px" style="margin-right:2px"/> <span class="Txt">Swimming Pool </span></a>
								</li>
								 <li>
								  <a href="<?php echo site_url('Admin/Home/switchcontrol/')?>#msc" class="Lnk"><img src="<?php echo site_url() ?>asset/demoforall/Images/cooling-w.png" width="22px"/> <span class="Txt">Motor Switch Control</span></a>
								  </li>
                                  <li>
								  <a href="<?php echo site_url('Admin/Home/switchcontrol/')?>#lac" class="Lnk"><img src="<?php echo site_url() ?>asset/demoforall/Images/cooling-w.png" width="22px"/> <span class="Txt">Lighting Automation</span></a>
								  </li>
							</ul>
						</li>
						<?php } ?>
