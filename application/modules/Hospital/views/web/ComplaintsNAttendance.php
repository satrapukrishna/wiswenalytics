            ...
            <div class="InnrPgBgHldr">
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>Hospital/HospitalAdmin/complaintDetReports" class="FtrTtl"><span class="LnkTxt">Engineering Staff</span></a>
                    </div>
                ...
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>Hospital/HospitalAdmin/complaintDetReports" class="FtrTtl"><span class="LnkTxt">HVAC</span></a>
                    </div>
                    <div class="StffAttndDshbHldr">
                        <div class="StffBscDtls">
                            <div class="StffImgHldr">
                ...
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>Hospital/HospitalAdmin/complaintDetReports" class="FtrTtl"><span class="LnkTxt">Plumber</span></a>
                    </div>
                    <div class="StffAttndDshbHldr">
                        <div class="StffBscDtls">
                            <div class="StffImgHldr">
                ...
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>Hospital/HospitalAdmin/complaintDetReports" class="FtrTtl"><span class="LnkTxt">Electrician</span></a>
                    </div>
                    <div class="StffAttndDshbHldr">
                        <div class="StffBscDtls">
                            <div class="StffImgHldr">
                ...
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>Hospital/HospitalAdmin/complaintDetReports" class="FtrTtl"><span class="LnkTxt">Janitors</span></a>
                    </div>
                    <div class="StffAttndDshbHldr">
                        <div class="StffBscDtls">
                            <div class="StffImgHldr">
