                ...
                <div class="TableHldr">
                    <table class="AppDataTbl">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url(); ?>HospitalAdmin/audit_Observations" class="DataLnk">View Observations</a>
                            </td>
                            <td>
                                <a href="<?php echo base_url(); ?>HospitalAdmin/audit_Recommendations" class="DataLnk">View Recommendations</a>
                            </td>
                            <td>
