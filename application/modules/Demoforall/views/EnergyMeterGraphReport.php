    ...
    <div id="MnCtnr" class="DshMnCtnr">
        ...
        <div id="DshbrdRgtCtnr" class="DshBrdCtnr">
            <div class="DshBrdRprtSctn">
                <div class="RprtHldr">
                    <div class="RprtHdr">
                        <span class="TtlTxt">Energy Meter Graph Report</span>
                        <ul class="TtlBrdCrmb">
                            <li>
...
Highcharts.chart('consumption_graph', {
    ...
    series: [{
        name: 'Time/Date ',
        data: [34,34,44,35,37,43,29,30,32,23,44,33,23,43,45,45,23,43]

    }]
});
//tanks
Highcharts.chart('pf_graph', {
    chart: {
        type: 'spline'
    },
    title: {
    ...
    xAxis: {
        categories: [0,180,90,120,150,180]
    },
    yAxis: {
        title: {
            text: 'PowerFactor'
