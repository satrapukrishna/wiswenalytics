                ...
                <div class="accordion" id="accordionFlushExample">
                    <div class="accordion-item">
                        <span class="accordion-header" id="flush-headingOne">
                            <button class="accordion-button collapsed Actv" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                                Electrical
                            </button>
                        </span>
                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul class="SbLnk">
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Common Area Meter Reading</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">DG Daily</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Diesel Consumption</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Elevator Weekly</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">HT Meter</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">UPS</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul class="SbLnk">
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Extinguisher Service Report</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Fire Extinguisher Daily</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Fire Extinguisher Weekly</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Fire Fighting Daily</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Fire Hydrant Box</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Fire System Testing</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Sprinkler Main Tap Off Valve</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul class="SbLnk">
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Chiller Log Book</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">AC Unit</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">AHU</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Daily Exhaust System</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Daily Fresh Air Fan</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Daily Jet Fan</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Spilt A/C</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Ventilation Fan</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Ventilation</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul class="SbLnk">
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Sewage Treatment Plant</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Daily Plumbing Leakage B4 Shaft</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Pump Room  JWC</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">RO Plant Log Book</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Sewage Treatment Plant</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Sump Pump</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Water Consumption Log</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Water Pump Daily</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Water Softner Log</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Water Tank Level Status</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>HospitalAdmin/checklistDetails" class="SbLnk">Water Treatment Plant Log</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="SctnDtlsTtlHldr">
                <div class="BrcmnbHldr">
                    <ul class="DtlsBrdCrmb">
                        <li>
                            <a href="<?php echo base_url(); ?>HospitalAdmin/checklist" class="BrdCrmLnk">All Checklists</a>
                        </li>
                        <li>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-5 BttnHldr">
                            <button type="button" onclick="location.href='<?php echo base_url(); ?>HospitalAdmin/checklistSubDetails'" class="btn btn-primary SbmtBtn">Submit</button>
