function getReports(){		
		...
		if(solution==64){
			var div='<select name="device" class="form-control chosen-select" id="device"><option value="" selected="selected">Select Report</option><option value="iaq">IAQ Report</option></select>';
		   $("#report").html(div);
            $("#report").trigger("chosen:updated");
		...
		if(solution==62){
			var div='<select name="device" class="form-control chosen-select" id="device"><option value="" selected="selected">Select Report</option><option value="crgr">Running Graph Report</option></select>';
		   $("#report").html(div);
            $("#report").trigger("chosen:updated");
            var div1='<select name="device" class="form-control chosen-select" id="device"><option value="" selected="selected">Select Device</option><option value="m1">Chiller1</option><option value="m1">Chiller2</option></select>';
		   $("#device").html(div1);
		...
		if(solution==44){
			var div='<select name="device" class="form-control chosen-select" id="device"><option value="" selected="selected">Select Report</option><option value="fprgr">Running Hours</option><option value="fpsvgr">Status View</option><option value="fplpgr">LinePressure</option><option value="fpwlgr">Water Level</option></select>';
		   $("#report").html(div);
            $("#report").trigger("chosen:updated");
            var div1='<select name="device" class="form-control chosen-select" id="device"><option value="" selected="selected">Select Device</option><option value="m1">Firepump1</option><option value="m1">Firepump2</option></select>';
		   $("#device").html(div1);
	...
	function getSolution(){
		...
		if(category==16){
			...
			var div='<select name="device" class="form-control chosen-select" id="device" ><option value="" selected="selected">Select Solution</option><option  value="61" selected="selected">AHU</option>		<option value="62">Chiller</option><option value="63">Cooling Tower</option><option value="64">IAQ</option></select>';
			 $("#solution").html(div);
