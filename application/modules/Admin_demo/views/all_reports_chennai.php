...
.loader:before {
    ...
    width: 240px;
    height: 140px;
    background: transparent url(../../asset/Admin_demo/images/WIS-Spaces-Logo.svg) no-repeat center center;
...
.loader:after {
    ...
    width: 240px;
    height: 80px;
    background: transparent url(../../asset/Admin_demo/images/LoadingSmpl.gif) no-repeat center center;
...
div.RprtTabDv {
	...
	div.RprtTabDv span.TabLnk.Icn.HydPneSys {
		background-image: url(../../asset/Admin_demo/images/HydroPnematicSystem.png);
	}
	...
	div.RprtTabDv span.TabLnk.Icn.DG {
		background-image: url(../../asset/Admin_demo/images/DG.png);
	}
        ...
        <div id="DshbrdRgtCtnr" class="DshBrdCtnr">
			<div class="DshBrdSctn">
				<div class="DshBrdSctnDtls">
					<form name="reports" id="myForm" action="<?php echo site_url("Admin_demo/Home/all_reports_demo")?>" method="post" onSubmit="return formValidation();">
						<div class=SrchFullBx>
							...
							<div class="SrchBtnHldr">
								...
								<a href="<?php echo site_url('Admin_demo/Home/all_reports_demo') ?>" class="btn btn-info reset">Reset</a></span>
...
function getsolutions(){
    ...
    $.ajax({
        ...
        url: BASE_URL+'Admin_demo/Home/ajax_hardware_device_dropdown_chennai/',
...
function getdevices(){
    ...
    $.ajax({
        ...
        url: BASE_URL+'Admin_demo/Home/ajax_hardware_dropdown/',
        success: function (data){
...
function getreports7(){
	...
	$.ajax({
        ...
        url: BASE_URL+'Admin_demo/Home/ajax_report_dropdown/',
        success: function (data){
			//alert(data);return false;
            $("#report").html(data);
