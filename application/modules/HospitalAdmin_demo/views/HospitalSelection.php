            ...
            <ul class="PrtyDshbrdLst">
                <li>
                    <div class="PrtyDshbrdDtls">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="PrptyNme">FirstMedic Kompally</a>
                ...
                <li>
                    <div class="PrtyDshbrdDtls">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/hospitalSelection" class="PrptyNme">FirstMedic Kukatpally</a>
        ...
        <div class="ContainerRight">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-5 BttnHldr">
                            <button type="button" onclick="location.href='<?php echo base_url(); ?>HospitalAdmin_demo/checklistSubDetails'"
            ...
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/about" class="FtrTtl Icn Abt"><span class="LnkTxt">About</span></a>
                </div>
                <div class="DshbrdFtrSldrHldr NoSlider">
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/about" class="FtrInrTtl">2005<br />Established</a>
                    </div>
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrAbtTwrs">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/about" class="FtrInrTtl">03<br />Blocks/ Towers</a>
                    </div>
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrAbtBds">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/about" class="FtrInrTtl">300<br />Beds</a>
                    </div>
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrAbtNtfc">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/about" class="FtrInrTtl">05<br />Notifications</a>
                    </div>
                </div>
            </div>
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/leadershipTeam" class="FtrTtl Icn LdrshpTm"><span class="LnkTxt">Leadership
                            Team</span></a>
                </div>
                <div class="DshbrdFtrSldrHldr NoSlider">
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrLdrshpAdmin">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/leadershipTeam" class="FtrInrTtl">Administrative Department</a>
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/leadershipTeam" class="FtrInrTtl">Finance Department</a>
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/leadershipTeam" class="FtrInrTtl">Department Head</a>
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/leadershipTeam" class="FtrInrTtl">Engineering Department</a>
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/leadershipTeam" class="FtrInrTtl">Security Department</a>
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/leadershipTeam" class="FtrInrTtl">IT Department</a>
            ...
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/bedsOccupancy" class="FtrTtl Icn BdsOccpncy"><span class="LnkTxt">Beds &
                            Occupancy</span></a>
                </div>
                <div class="DshbrdFtrSldrHldr NoSlider">
                        ...
                        <div class="DshHvr">
                            <div class="HvrDtlsHldr NoBttn">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/bedsOccupancyDetails" class="SctnTtl">Tower 01</a>
                                </div>
                                    ...
                                    <div>
                                        <div class="FlpSlideHldr">
                                            ...
                                            <div class="HvrBtnHldr">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/bedsOccupancyFullDetails" class="BtnIssue">View
                                                    Details</a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="SldDtlsHldr DbleDv">
                        ...
                        <div class="DshHvr">
                            <div class="HvrDtlsHldr NoBttn">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/bedsOccupancyDetails" class="SctnTtl">Tower 02</a>
                                </div>
                                <div class="FlpIssueSlider">
                                    <div>
                                        <div class="FlpSlideHldr">
                    ...
                    <div class="SldDtlsHldr DbleDv">
                        ...
                        <div class="DshHvr">
                            <div class="HvrDtlsHldr NoBttn">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/bedsOccupancyDetails" class="SctnTtl">Tower 03</a>
                                </div>
                                <div class="FlpIssueSlider">
                                    <div>
                                        <div class="FlpSlideHldr">
            ...
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/attendence" class="FtrTtl Icn Attndnc"><span class="LnkTxt">Attendance</span></a>
                </div>
                <div class="DshbrdFtrSldrHldr NoSlider">
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg MdclStff" />
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/attendence" class="FtrInrTtl">Medical Staff</a>
                        <span class="AttAllot">1153 Total Staff</span>
                        <span class="AttPrsnt">1062 Alloted</span>
                        <div class="DshHvr">
                            <div class="HvrDtlsHldr NoBttn">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/attendence" class="SctnTtl">Medical Staff</a>
                                </div>
                                <div class="FlpIssueSlider">
                                    <div>
                                        <div class="FlpSlideHldr">
                                            ...
                                            <div class="HvrBtnHldr">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/attendenceDeptDetail" class="BtnIssue">View Details</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/attendence" class="FtrInrTtl">Nursing Staff</a>
                        <span class="AttAllot">482 Total Staff</span>
                        <span class="AttPrsnt">460 Alloted</span>
                        <div class="DshHvr">
                            <div class="HvrDtlsHldr NoBttn">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/attendence" class="SctnTtl">Nursing Staff</a>
                                </div>
                                <div class="FlpIssueSlider">
                                    <div>
                                        <div class="FlpSlideHldr">
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/attendence" class="FtrInrTtl">Security Staff</a>
                        <span class="AttAllot">40 Alloted</span>
                        <span class="AttPrsnt">32 Alloted</span>
                        <div class="DshHvr">
                            <div class="HvrDtlsHldr NoBttn">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/attendence" class="SctnTtl">Security Staff</a>
                                </div>
                                <div class="FlpIssueSlider">
                                    <div>
                                        <div class="FlpSlideHldr">
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/attendence" class="FtrInrTtl">Engineering Staff</a>
                        <span class="AttAllot">20 Total sTaff</span>
                        <span class="AttPrsnt">17 Alloted</span>
                        <div class="DshHvr">
                            <div class="HvrDtlsHldr NoBttn">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/attendence" class="SctnTtl">Engineering Staff</a>
                                </div>
                                <div class="FlpIssueSlider">
                                    <div>
                                        <div class="FlpSlideHldr">
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/attendence" class="FtrInrTtl">Administrative Staff</a>
                        <span class="AttAllot">30 Total Staff</span>
                        <span class="AttPrsnt">25 Alloted</span>
                        <div class="DshHvr">
                            <div class="HvrDtlsHldr NoBttn">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/attendence" class="SctnTtl">Administrative Staff</a>
                                </div>
                                <div class="FlpIssueSlider">
                                    <div>
                                        <div class="FlpSlideHldr">
            ...
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/resources" class="FtrTtl Icn Rsrcs"><span class="LnkTxt">Resources</span></a>
                </div>
                <div class="DshbrdFtrSldrHldr NoSlider">
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrRsrcsWtr" />
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/resources" class="FtrInrTtl">Water</a>
                        <span class="IssStts Stsfctry">2 Issues</span>
                        <div class="DshHvr">
                            <div class="FlpSlideHldr NoSlider">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/resources" class="SctnTtl">Water</a>
                                </div>
                                <div class="HvrDtlsHldr NoBttn">
                                    <div class="HvrTtlHldr">
                                    ...
                                    <div class="HvrInnrDtlsHldr FllLst">
                                        <ol class="IssueLst">
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/resources" class="IssueLstLnk">No Water from Municipal
                                                    Lines.</a>
                                            </li>
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/resources" class="IssueLstLnk">Order Water Tankers
                                                    Immediately.</a>
                                            </li>
                                        </ol>
                                    </div>
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/resources" class="FtrInrTtl">Energy</a>
                        <span class="IssStts Stsfctry">1 Issues</span>
                        <div class="DshHvr">
                            <div class="FlpSlideHldr NoSlider">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/resources" class="SctnTtl">Energy</a>
                                </div>
                                <div class="HvrDtlsHldr NoBttn">
                                    <div class="HvrTtlHldr">
                                    ...
                                    <div class="HvrInnrDtlsHldr FllLst">
                                        <ol class="IssueLst">
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/resources" class="IssueLstLnk">Power Consumption - 10%
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/resources" class="FtrInrTtl">Oxygen</a>
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/resources" class="FtrInrTtl">Backup Power (UPS)</a>
                        <span class="IssStts Good">0 Issues</span>
                    </div>
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrRsrcsDsl" />
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/resources" class="FtrInrTtl">Diesel</a>
                        <span class="IssStts Stsfctry">1 Issues</span>
                        <div class="DshHvr">
                            <div class="FlpSlideHldr NoSlider">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/resources" class="SctnTtl">Diesel</a>
                                </div>
                                <div class="HvrDtlsHldr NoBttn">
                                    <div class="HvrTtlHldr">
                                        <span class="IssTtl">1 Issues</span>
                                    ...
                                    <div class="HvrInnrDtlsHldr FllLst">
                                        <ol class="IssueLst">
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/resources" class="IssueLstLnk">DG 2 - Low Diesel Level.</a>
                                            </li>
                                        </ol>
                                    </div>
                                </div>
            ...
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering" class="FtrTtl Icn Engnrng"><span class="LnkTxt">Engineering</span></a>
                </div>
                <div class="DshbrdFtrSldrHldr NoSlider">
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg WtrRsrcs" />
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_Water" class="FtrInrTtl">Water</a>
                        <span class="IssStts Stsfctry">2 Issues</span>
                        <div class="DshHvr">
                            <div class="FlpSlideHldr NoSlider">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_Water" class="SctnTtl">Water</a>
                                </div>
                                <div class="HvrDtlsHldr NoBttn">
                                    <div class="HvrTtlHldr">
                                    ...
                                    <div class="HvrInnrDtlsHldr FllLst">
                                        <ol class="IssueLst">
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_Water" class="IssueLstLnk">No Water from
                                                    Municipal Lines.</a>
                                            </li>
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_Water" class="IssueLstLnk">Order Water Tankers
                                                    Immediately.</a>
                                            </li>
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_Water" class="IssueLstLnk">Water leakage at
                                                    Tower #1, Floor #5.</a>
                                            </li>
                                        </ol>
                                    </div>
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_Energy" class="FtrInrTtl">Electricity</a>
                        <span class="IssStts Stsfctry">1 Issues</span>
                        <div class="DshHvr">
                            <div class="FlpSlideHldr NoSlider">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_Energy" class="SctnTtl">Electricity</a>
                                </div>
                                <div class="HvrDtlsHldr NoBttn">
                                    <div class="HvrTtlHldr">
                                        <span class="IssTtl">1 Issues</span>
                                    ...
                                    <div class="HvrInnrDtlsHldr FllLst">
                                        <ol class="IssueLst">
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_Energy" class="IssueLstLnk">Power consumption
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_AirConditioning" class="FtrInrTtl">Air Conditioning</a>
                        <span class="IssStts Stsfctry">1 Issues</span>
                        <div class="DshHvr">
                            <div class="FlpSlideHldr NoSlider">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_AirConditioning" class="SctnTtl">Air Conditioning</a>
                                </div>
                                <div class="HvrDtlsHldr NoBttn">
                                    <div class="HvrTtlHldr">
                                        <span class="IssTtl">1 Issues</span>
                                    ...
                                    <div class="HvrInnrDtlsHldr FllLst">
                                        <ol class="IssueLst">
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_AirConditioning" class="IssueLstLnk">Chemotherapy Room - Low cooling complaint.</a>
                                            </li>
                                        </ol>
                                    </div>
                                </div>
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_AirQuality" class="FtrInrTtl">Air Quality</a>
                        <span class="IssStts Good">0 Issues</span>
                    </div>
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg SftIntgRsrcs" />
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_SoftIntegration" class="FtrInrTtl">Soft Integration</a>
                        <span class="IssStts Stsfctry">2 Issues</span>
                        <div class="DshHvr">
                            <div class="FlpSlideHldr NoSlider">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_SoftIntegration" class="SctnTtl">Soft Integration</a>
                                </div>
                                <div class="HvrDtlsHldr NoBttn">
                                    <div class="HvrTtlHldr">
                                        <span class="IssTtl">2 Issues</span>
                                    ...
                                    <div class="HvrInnrDtlsHldr FllLst">
                                        <ol class="IssueLst">
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_SoftIntegration" class="IssueLstLnk">Lift 4 - Maintenance Alert.</a>
                                            </li>
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_SoftIntegration" class="IssueLstLnk">DG 3 - Low Pressure Alert.</a>
                                            </li>
                                        </ol>
                                    </div>
                                </div>
                                ...
                                <div class="FlpIssueSlider">
                                    <div>
                                        <div class="FlpSlideHldr">
                                            ...
                                            <div class="HvrBtnHldr">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_SoftIntegration" class="BtnIssue">View
                                                    Issue</a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/engineering_SpecializedSolutions" class="FtrInrTtl">Specialized Solution</a>
                        <span class="IssStts Good">0 Issues</span>
                    </div>
                </div>
            </div>
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/checklist" class="FtrTtl Icn Chcklsts"><span class="LnkTxt">Checklist</span></a>
                </div>
                <div class="DshbrdFtrSldrHldr NoSlider">
                    <div class="SldDtlsHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/checklist" class="FtrInrTtl">Electrical</a>
                        <span class="IssStts Stsfctry">1 Issues</span>
                        <div class="DshHvr">
                            <div class="FlpSlideHldr NoSlider">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/checklist" class="SctnTtl">Electrical</a>
                                </div>
                                <div class="HvrDtlsHldr NoBttn">
                                    <div class="HvrTtlHldr">
                                        <span class="IssTtl">1 Issues</span>
                                    ...
                                    <div class="HvrInnrDtlsHldr FllLst">
                                        <ol class="IssueLst">
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/checklistDetails" class="IssueLstLnk">CCTV - 4 cameras
                                                    offline.</a>
                                            </li>
                                        </ol>
                                    </div>
                    ...
                    <div class="SldDtlsHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/checklist" class="FtrInrTtl">ELV</a>
                        <span class="IssStts Good">0 Issues</span>
                    </div>
                    <div class="SldDtlsHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/checklist" class="FtrInrTtl">Fire</a>
                        <span class="IssStts Stsfctry">1 Issues</span>
                        <div class="DshHvr">
                            <div class="FlpSlideHldr NoSlider">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/checklist" class="SctnTtl">Fire</a>
                                </div>
                                <div class="HvrDtlsHldr NoBttn">
                                    <div class="HvrTtlHldr">
                                        <span class="IssTtl">1 Issues</span>
                                    ...
                                    <div class="HvrInnrDtlsHldr FllLst">
                                        <ol class="IssueLst">
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/checklistDetails" class="IssueLstLnk">Fire Pump 2 - High
                    ...
                    <div class="SldDtlsHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/checklist" class="FtrInrTtl">HVAC</a>
                        <span class="IssStts Good">0 Issues</span>
                    </div>
                    <div class="SldDtlsHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/checklist" class="FtrInrTtl">PHE</a>
                        <span class="IssStts Stsfctry">2 Issues</span>
                        <div class="DshHvr">
                            <div class="FlpSlideHldr NoSlider">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/checklist" class="SctnTtl">PHE</a>
                                </div>
                                <div class="HvrDtlsHldr NoBttn">
                                    <div class="HvrTtlHldr">
                                        <span class="IssTtl">2 Issues</span>
                                    ...
                                    <div class="HvrInnrDtlsHldr FllLst">
                                        <ol class="IssueLst">
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/checklistDetails" class="IssueLstLnk">Sewage Treatment
                                                    Plant - Blower Issue.</a>
                                            </li>
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/checklistDetails" class="IssueLstLnk">Sump Pump 4 - Breakdown.</a>
                                            </li>
                                        </ol>
                                    </div>
                                </div>
            ...
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/sanitation" class="FtrTtl Icn Snttn"><span class="LnkTxt">Sanitation</span></a>
                </div>
                <div class="DshbrdFtrSldrHldr NoSlider">
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrSnttnWshrm">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/sanitation_Washroom" class="FtrInrTtl">Washroom</a>
                        <span class="IssStts Stsfctry">3 Issues</span>
                        <div class="DshHvr">
                            <div class="FlpSlideHldr NoSlider">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/sanitation_Washroom" class="SctnTtl">Washroom</a>
                                </div>
                                <div class="HvrDtlsHldr NoBttn">
                                    <div class="HvrTtlHldr">
                                        <span class="IssTtl">3 Issues</span>
                                    ...
                                    <div class="HvrInnrDtlsHldr FllLst">
                                        <ol class="IssueLst">
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/sanitation_Washroom_Details" class="IssueLstLnk">Tower #1,
                                            ...
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/sanitation_Washroom_Details" class="IssueLstLnk">Tower #2,
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/sanitation_WasteManagement" class="FtrInrTtl">Waste Management</a>
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/sanitation_PestControl" class="FtrInrTtl">Pest Control</a>
                        <span class="IssStts Good">0 Issues</span>
                    </div>
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrSnttnFcdClng">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/sanitation_FacadeCleaning" class="FtrInrTtl">Facade Cleaning</a>
                        <span class="IssStts Stsfctry">1 Issues</span>
                        <div class="DshHvr">
                            <div class="FlpSlideHldr NoSlider">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/sanitation_FacadeCleaning" class="SctnTtl">Facade Cleaning</a>
                                </div>
                                <div class="HvrDtlsHldr NoBttn">
                                    <div class="HvrTtlHldr">
                                        <span class="IssTtl">1 Issues</span>
            ...
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/machinery" class="FtrTtl Icn Mchnry"><span class="LnkTxt">Machinery</span></a>
                </div>
                <div class="DshbrdFtrSldrHldr NoSlider">
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrMchnCgss">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/machineryDetails" class="FtrInrTtl">CGSS Plant</a>
                        <span class="IssStts Good">0 Issues</span>
                    </div>
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrMchnAcPlnt">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/machinery" class="FtrInrTtl">A/C Plant</a>
                        <span class="IssStts Stsfctry">1 Issues</span>
                        <div class="DshHvr">
                            <div class="FlpSlideHldr NoSlider">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/machinery" class="SctnTtl">A/C Plant</a>
                                </div>
                                <div class="HvrDtlsHldr NoBttn">
                                    <div class="HvrTtlHldr">
                                        <span class="IssTtl">1 Issues</span>
                                    ...
                                    <div class="HvrInnrDtlsHldr FllLst">
                                        <ol class="IssueLst">
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/machineryDetails" class="IssueLstLnk">Chiller 2 tripping
                                                    frequently.</a>
                                            </li>
                                        </ol>
                                    </div>
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/machinery" class="FtrInrTtl">Sub Station</a>
                        <span class="IssStts Good">0 Issues</span>
                    </div>
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrMchnBlrPlnt">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/machinery" class="FtrInrTtl">Boiler Plant</a>
                        <span class="IssStts Stsfctry">1 Issues</span>
                        <div class="DshHvr">
                            <div class="FlpSlideHldr NoSlider">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/machinery" class="SctnTtl">Boiler Plant</a>
                                </div>
                                <div class="HvrDtlsHldr NoBttn">
                                    <div class="HvrTtlHldr">
                                        <span class="IssTtl">1 Issues</span>
                                    ...
                                    <div class="HvrInnrDtlsHldr FllLst">
                                        <ol class="IssueLst">
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/machineryDetails" class="IssueLstLnk">Boiler Plant - AMC
                                                    renewal pending.</a>
                                            </li>
                                        </ol>
                                    </div>
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/machinery" class="FtrInrTtl">Pump Room</a>
                        <span class="IssStts Good">0 Issues</span>
                    </div>
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrMchnWtrClr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/machinery" class="FtrInrTtl">Water Coolers</a>
                        <span class="IssStts Good">0 Issues</span>
                    </div>
                </div>
            </div>
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/pPM" class="FtrTtl Icn PPM"><span class="LnkTxt">PPM</span></a>
                </div>
                <div class="DshbrdFtrSldrHldr NoSlider">
                    <div class="SldDtlsHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/pPM" class="FtrInrTtl BgTxt Good">60</a>
                        <span class="IssStts Good">Completed</span>
                    </div>
                    <div class="SldDtlsHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/pPM" class="FtrInrTtl BgTxt Bad">47</a>
                        <span class="IssStts Bad">Pending</span>
                    </div>
                    <div class="SldDtlsHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/pPM" class="FtrInrTtl BgTxt Stsfctry">6</a>
                        <span class="IssStts Stsfctry">Ongoing</span>
                    </div>
                    <div class="SldDtlsHldr">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/pPM" class="FtrInrTtl BgTxt">7</a>
            ...
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/manpowerUtilization" class="FtrTtl Icn MnpwrUtlztn"><span class="LnkTxt">Manpower
                            Utilization</span></a>
                </div>
                <div class="DshbrdFtrSldrHldr NoSlider">
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrMnpwrAllc">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/manpowerUtilization" class="FtrInrTtl">Manpower Allocation</a>
                    </div>
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrMnpwrCmplnt">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/manpowerUtilization" class="FtrInrTtl">Complaint Turn around time</a>
                    </div>
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrMnpwrEffncy">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/manpowerUtilization" class="FtrInrTtl">Manpower Efficiency</a>
                    </div>
                </div>
            </div>
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/complaintFeedback" class="FtrTtl Icn CmplntsFdbck"><span class="LnkTxt">Complaints &
                            Feedback</span></a>
                </div>
                <div class="DshbrdFtrSldrHldr NoSlider">
                    <div class="DvsHldr">
                        ...
                        <div class="SldDtlsHldr">
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/complaintFeedback" class="FtrInrTtl BgTxt">385</a>
                            <span class="IssStts">Total</span>
                        </div>
                        <div class="SldDtlsHldr">
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/complaintFeedback" class="FtrInrTtl BgTxt Good">349</a>
                            <span class="IssStts Good">Completed</span>
                        </div>
                        <div class="SldDtlsHldr">
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/complaintFeedback" class="FtrInrTtl BgTxt Bad">36</a>
                            <span class="IssStts Bad">Pending</span>
                        </div>
                    </div>
                    <div class="DvsHldr">
                        ...
                        <div class="SldDtlsHldr">
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/complaintFeedback" class="FtrInrTtl BgTxt">417</a>
                            <span class="IssStts">Total</span>
                        </div>
                        <div class="SldDtlsHldr">
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/complaintFeedback" class="FtrInrTtl BgTxt Good">409</a>
                            <span class="IssStts Good">Completed</span>
                        </div>
                        <div class="SldDtlsHldr">
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/complaintFeedback" class="FtrInrTtl BgTxt Bad">8</a>
                            <span class="IssStts Bad">Pending</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/inventoryManagement" class="FtrTtl Icn InvntryMngmnt"><span class="LnkTxt">Inventory
                            Management</span></a>
                </div>
                <div class="DshbrdFtrSldrHldr NoSlider">
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrSnttnInvt">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/inventorySanitation" class="FtrInrTtl">Sanitation</a>
                        <span class="IssStts Good">0 Issues</span>
                    </div>
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrMdclEqpmntInvt">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/inventorySanitation" class="FtrInrTtl">Medical Equipments</a>
                        <span class="IssStts Stsfctry">1 Issues</span>
                        <div class="DshHvr">
                            <div class="FlpSlideHldr NoSlider">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/inventorySanitation" class="SctnTtl">Medical Equipments</a>
                                </div>
                                <div class="HvrDtlsHldr NoBttn">
                                    <div class="HvrTtlHldr">
                                        <span class="IssTtl">1 Issues</span>
                                    ...
                                    <div class="HvrInnrDtlsHldr FllLst">
                                        <ol class="IssueLst">
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/inventorySanitation" class="IssueLstLnk">Shortage of PPE
                                                    Kits.</a>
                                            </li>
                                        </ol>
                                    </div>
                    ...
                    <div class="SldDtlsHldr">
                        ...
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/inventorySanitation" class="FtrInrTtl">Wheelchairs and Strechers</a>
                        <span class="IssStts Good">0 Issues</span>
                    </div>
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrEngnrngInvt">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/inventorySanitation" class="FtrInrTtl">Engineering</a>
                        <span class="IssStts Stsfctry">2 Issues</span>
                        <div class="DshHvr">
                            <div class="FlpSlideHldr NoSlider">
                                <div class="HvrSctnTtlHldr">
                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/inventorySanitation" class="SctnTtl">Engineering</a>
                                </div>
                                <div class="HvrDtlsHldr NoBttn">
                                    <div class="HvrTtlHldr">
                                        <span class="IssTtl">2 Issues</span>
                                    ...
                                    <div class="HvrInnrDtlsHldr FllLst">
                                        <ol class="IssueLst">
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/inventorySanitation" class="IssueLstLnk">Shortage of Tube
                                                    Lights.</a>
                                            </li>
                                            <li class="Bad">
                                                <a href="<?php echo base_url(); ?>HospitalAdmin_demo/inventorySanitation" class="IssueLstLnk">Shortage of
                                                    Taps.</a>
                                            </li>
                                        </ol>
                                    </div>
            ...
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/audits" class="FtrTtl Icn Adts"><span class="LnkTxt">Audits</span></a>
                </div>
                <div class="DshbrdFtrSldrHldr NoSlider">
                    <div class="DvsHldr">
                        <div class="DvsnTtlHldr">
                        ...
                        <div class="SldDtlsHldr">
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/audits" class="FtrInrTtl BgTxt Good">109</a>
                            <span class="IssStts Good">Completed</span>
                        </div>
                        <div class="SldDtlsHldr">
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/audits" class="FtrInrTtl BgTxt Stsfctry">4</a>
                            <span class="IssStts Stsfctry">On-going</span>
                        </div>
                        <div class="SldDtlsHldr">
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/audits" class="FtrInrTtl BgTxt Bad">2</a>
                                ...
                                <div class="FlpSlideHldr NoSlider">
                                    <div class="HvrDtlsHldr NoBttn">
                                        ...
                                        <div class="HvrInnrDtlsHldr FllLst">
                                            <ol class="IssueLst">
                                                <li>
                                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/audits" class="IssueLstLnk">NAVH Audit on 15 July
                                                        2021.</a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/audits" class="IssueLstLnk">NAVM Audit on 18 July
                                                        2021.</a>
                                                </li>
                                            </ol>
                                        </div>
                    ...
                    <div class="DvsHldr">
                        ...
                        <div class="SldDtlsHldr">
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/audits" class="FtrInrTtl BgTxt Good">103</a>
                            <span class="IssStts Good">Completed</span>
                        </div>
                        <div class="SldDtlsHldr">
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/audits" class="FtrInrTtl BgTxt Stsfctry">0</a>
                            <span class="IssStts Stsfctry">On-going</span>
                        </div>
                        <div class="SldDtlsHldr">
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/audits" class="FtrInrTtl BgTxt Bad">1</a>
                            <span class="IssStts Bad">Upcoming</span>
                            <div class="DshHvr">
                                <div class="FlpSlideHldr NoSlider">
                                    <div class="HvrDtlsHldr NoBttn">
            ...
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/carbonFootprint" class="FtrTtl Icn CrbnFtprnt"><span class="LnkTxt">Carbon
                            Footprint</span></a>
                </div>
                <div class="DshbrdFtrSldrHldr NoSlider">
                    <div class="SldDtlsHldr">
            ...
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/benchmarking" class="FtrTtl Icn Bnchmrkng"><span
            ...
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/recommendations" class="FtrTtl Icn Rcmmndtns"><span
                ...
                <div class="DshbrdFtrSldrHldr NoSlider">
                    <div class="DvsHldr">
                        ...
                        <div class="SldDtlsHldr">
                            ...
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/recommendations" class="FtrInrTtl">Energy Optimization</a>
                        </div>
                        <div class="SldDtlsHldr">
                            <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrRcmmWtr">
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/recommendations" class="FtrInrTtl">Water Optimization</a>
                        </div>
                        <div class="SldDtlsHldr">
                            <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrRcmmMnpwr">
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/recommendations" class="FtrInrTtl">Manpower Optimization</a>
                        </div>
                        <div class="SldDtlsHldr">
                            <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrRcmmOthr">
                            <a href="<?php echo base_url(); ?>HospitalAdmin_demo/recommendations" class="FtrInrTtl">Other Recommendations</a>
                        </div>
                    </div>
                    <div class="DvsHldr">
                        <div class="DvsnTtlHldr">
            ...
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/comparisions" class="FtrTtl Icn Cmprsns"><span class="LnkTxt">Comparisions</span></a>
                </div>
                <div class="DshbrdFtrSldrHldr NoSlider">
                    <div class="container-fluid">
                        <div class="row">
            ...
            <div class="PrptyFtrsDshbrd NoSlider">
                <div class="FtrTtlHldr">
                    <a href="<?php echo base_url(); ?>HospitalAdmin_demo/plans" class="FtrTtl Icn Plns"><span class="LnkTxt">Plans</span></a>
                </div>
                <div class="DshbrdFtrSldrHldr NoSlider">
                    <div class="SldDtlsHldr">
                        <img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrFlrPln">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/floorPlans" class="FtrInrTtl">Floor Plans</a>
                    ...
                    <div class="SldDtlsHldr"><img src="<?php echo base_url(); ?>asset/hospital_admin/Images/Blank.png" class="FtrInrTtlImg FrFrEvctnPln">
                        <a href="<?php echo base_url(); ?>HospitalAdmin_demo/fireEvacuationPlans" class="FtrInrTtl">Fire Evacuation Plans</a>
