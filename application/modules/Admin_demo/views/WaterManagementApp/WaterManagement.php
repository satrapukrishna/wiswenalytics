    ...
    <div class="WtrMngtDshHldr">
        ...
        <div class="WtrMngtSrchSctn">
            <ul class="SrchBx">
                ...
                <li>
                    <input type="date" class="Inpt Clndr" />
                </li>
                <li class="BtnHldr">
...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo base_url(); ?>asset/admin/wmdImages/Blank.png" />
    <link rel="icon" sizes="192x192" href="<?php echo base_url(); ?>asset/admin/wmdImages/Blank.png" />
