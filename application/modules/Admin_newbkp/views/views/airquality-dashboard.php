...
<!--                     <span class="SctnVwAll Cllps FA" id="collapseall"></span>
 -->                </div>
			...
			<!-- Toilet start -->
             <div class="DshBrdSctn" style="padding: 10px 30px 25px 38px;">
                <div class="DshBrdSctnTtl" id="toilet">
                    <span class="TxtTtl imageadd"><img src="<?php echo site_url() ?>asset/admin/images/ToiletExhaust-Clr.png" width="40" />Toilet Exhaust</span>
                   
                    <span class="SctnVw Cllps dev" onclick="device(557)" id="device557"></span>
                     
<!--                     <span class="SctnVwAll Cllps FA" id="collapseall"></span>
 -->                </div>
                <div class="DshBrdSctnDtls device devicebox557"  style="background-color:#fff;padding:15px;border-bottom: 1px solid #d0cfcf;">
					<h4 class="head-h4">Toilets #01  to 05</h4>
                    <div class="subhead">Tower 1,Floor 1 Last Updated on 17-12-2020 02:00PM</div>
					
					<div class="small-box">
					<img src="<?php echo site_url() ?>asset/admin/images/fan.png" width="80" style="float:left" />
					<div><span class="toilet-head">Toilet
					#01</span>
					<span class="status-on">ON</span></div>
					</div>
					<div class="small-box">
					<img src="<?php echo site_url() ?>asset/admin/images/fan.png" width="80" style="float:left" />
					<div><span class="toilet-head">Toilet
					#02</span>
					<span class="status-off">OFF</span></div>
					</div>
					<div class="small-box">
					<img src="<?php echo site_url() ?>asset/admin/images/fan.png" width="80" style="float:left" />
					<div><span class="toilet-head">Toilet
					...
					<div><span class="toilet-head">Toilet
					#04</span>
					<span class="status-on">OFF</span></div>
					</div>
					<div class="small-box">
					<img src="<?php echo site_url() ?>asset/admin/images/fan.png" width="80" style="float:left" />
					<div><span class="toilet-head">Toilet
				...
				<div class="DshBrdSctnDtls device devicebox557"  style="background-color:#fff;padding:15px;border-bottom: 1px solid #d0cfcf;">
					<h4 class="head-h4">Toilets #05  to 10</h4>
                    <div class="subhead">Tower 1,Floor 2 Last Updated on 17-12-2020 02:00PM</div>
         ...
         <!-- Ventilator start -->
             <div class="DshBrdSctn" style="padding: 10px 30px 25px 38px;">
                <div class="DshBrdSctnTtl" id="ventilation">
                    <span class="TxtTtl imageadd"><img src="<?php echo site_url() ?>asset/admin/images/VentilationFan-Clr.png" width="40" />Ventilation Fans</span>
                ...
                <div class="DshBrdSctnDtls device devicebox558"  style="background-color:#fff;padding:15px;border-bottom: 1px solid #d0cfcf;">
					...
					<div class="box">
						...
						<div class="SctnDtls BorewellHldr">
							...
							<span class="SctnTtl" style="line-height: 30px;font: 600 16px 'Open Sans';color:#3c8dbc;float:left">Ventilation Fan #01 </span>
							<span style="float:right;margin-top:10px;margin-right:5px;" class="status-working">ON</span>
							<div style="clear:both"></div>
							</div>
							<div style="border-bottom:1px solid #ccc">
							<div class="inner-box">
							<span class="status-working">Auto</span><br/>
							<h5>Fan Status</h5>
							</div>
							<div class="inner-box">
							<span class="status-working">Ok</span><br/>
							<h5>Fan Trip Status</h5>
							</div>
							<div class="inner-box no-border-right">
							<h3> 76%</h3>
							<h5>CO  Level</h5>
							</div>
							<div style="clear:both"></div>							
					...
					<div class="box">
						...
						<div class="SctnDtls BorewellHldr">
							<div style="border-bottom:1px solid #ccc;">
							<span class="SctnTtl" style="line-height: 30px;font: 600 16px 'Open Sans';color:#3c8dbc;float:left">Ventilation Fan #02 </span>
							<span style="float:right;margin-top:10px;margin-right:5px;" class="status-stopped">OFF</span>
							<div style="clear:both"></div>
							</div>
							<div style="border-bottom:1px solid #ccc">
							<div class="inner-box">
							<span class="status-stopped">Manual</span><br/>
							<h5>Fan Status</h5>
							</div>
							<div class="inner-box">
							<span class="status-working">Ok</span><br/>
					...
					<div class="box">
						...
						<div class="SctnDtls BorewellHldr">
							<div style="border-bottom:1px solid #ccc;">
							<span class="SctnTtl" style="line-height: 30px;font: 600 16px 'Open Sans';color:#3c8dbc;float:left">Ventilation Fan #03 </span>
							<span style="float:right;margin-top:10px;margin-right:5px;" class="status-working">ON</span>
							<div style="clear:both"></div>
							</div>
							<div style="border-bottom:1px solid #ccc">
							...
							<div class="inner-box">
							<span class="status-stopped">Trip</span><br/>
							<h5>Fan Trip Status</h5>
							</div>
							<div class="inner-box no-border-right">
							<h3> 76%</h3>
					...
					<?php /*<div class="small-box1">
					<img src="<?php echo site_url() ?>asset/admin/images/fan3.jpg" width="70" style="float:left" />
					<div><span class="toilet-head1">Ventilation Fan
					#01</span><br/>
					<span style="color:#bdb0b0;font-size:11px;">Tower 1,floor 1,Toilet</span><br/>
					<span class="status-on">Open</span></div>
					</div>
					<div class="small-box1">
					<img src="<?php echo site_url() ?>asset/admin/images/fan3.jpg" width="70" style="float:left" />
					<div><span class="toilet-head1">Ventilation Fan
					#02</span><br/>
					<span style="color:#bdb0b0;font-size:11px;">Tower 1,floor 1,Batrom</span><br/>
					<span class="status-off">Closed</span></div>
					</div>
					<div class="small-box1">
					<img src="<?php echo site_url() ?>asset/admin/images/fan3.jpg" width="70" style="float:left" />
					<div><span class="toilet-head1">Ventilation Fan
