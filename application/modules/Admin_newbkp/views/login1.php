    ...
    <div class="LoginBgHldr">
        <div class="LoginHldr">
            <div class="LoginTtlHldr">
                <span class="LoginTtlNm">Super</span><span class="LoginTtlNmee">Admin</span>
            </div>
			
			<div class="LoginBx tabs">
				<?php /*<ul class="nav nav-tabs tab-group LoginType">
				...
				<div class="tab-content">
				  <div id="client" class="tab-pane fade in active">
					...
					<form action="<?php echo base_url('Admin/login_user1'); ?>" method="post">
                    <ul class="LoginFlds">
                        <li>
