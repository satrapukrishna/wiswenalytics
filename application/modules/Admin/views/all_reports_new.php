        ...
        <div id="DshbrdRgtCtnr" class="DshBrdCtnr">
			<div class="DshBrdSctn">
				<div class="DshBrdSctnDtls">
					<form name="reports" id="myForm" action="<?php echo site_url("Admin/HomeNew/all_reports_new")?>" method="post" onSubmit="return formValidation();">
						<div class=SrchFullBx>
							...
							<div class="SrchBtnHldr">
								...
								<a href="<?php echo site_url('Admin/HomeNew/all_reports_new') ?>" class="btn btn-info reset">Reset</a></span>
			...
			<?php $this->load->view('common_new/footer3') ?>
		</div>
    </div>
</body>
...
function getsolutions(){
    ...
    $.ajax({
        ...
        url: BASE_URL+'Admin/HomeNew/ajax_hardware_device_dropdown_chennai/',
