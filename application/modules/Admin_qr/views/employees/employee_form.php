                            ...
                            <?php if (isset($employee) && $employee): ?>
                                    ...
                                    <div class="form-group">
										...
										<div class="form-group">
											...
											$sol=array(1=>'water',2=>'energy',3=>'Air Quality',3=>'Air Conditioning',4=>'Remote Control',5=>'Soft Integrations',6=>'Specialised Solutions',7=>'Billing',8=>'Switch Controls',9=>'Switch Status');
											// echo count($sol);
                                                ...
                                                <?php if($all_per->num_rows()>0){ $count = $all_per->num_rows(); $rows = floor($count/4);$i=0; ?>
                                                        <table class="table">
                                                           <?php /* <th><input type="checkbox" name="checked_all" id="checked_all" /></th>
                                                            ...
                                                            <?php foreach($all_per->result() as $row){ 
                                ...
                                <?php echo form_open_multipart('Admin/Employees/create_employee/', array('id' => 'create_client','class' => 'form-horizontal')); ?>
                                    ...
                                    <div class="form-group">
										...
										<div class="form-group">
											...
											// $sol=array(0=>5,1=>6,2=>7,3=>8,4=>9,5=>10,6=>11,7=>12);
											// echo "<pre>";print_r($per);exit;
											$sol=array(1=>'water',2=>'energy',3=>'Air Quality',3=>'Air Conditioning',4=>'Remote Control',5=>'Soft Integrations',6=>'Specialised Solutions',7=>'Billing',8=>'Switch Controls');
											// echo count($sol);
											for($j=1;count($sol)>=$j;$j++){
												$this->db->select('');
												$this->db->where('type_name', $sol[$j]);
										...
										<?php if($this->session->userdata('user_id')!=1){?>
										<div class="form-group">
                                            <label class="col-md-2">Access Control <span class="required_fields"></span></label>
                                             <div class="col-md-8">
                                                        ...
                                                        <table class="table table-responsive">
															...
															<th>All</th>
                                                                   ...
                                                                   <?php if($i==1){	?>
                                                                    ...
                                                                    <td><input type="checkbox" class="selectCheckboxes" value="<?php echo $per[$j] ?>" name="permissions[]"/></td>
                                                                    <td><?php echo ucfirst(str_replace('_',' ',$per[$j])); ?></td>
																	<?php if($i==4){ $i = 0; ?>
                                                                    </tr>
																	<?php } ?>
																	<?php } ?>
