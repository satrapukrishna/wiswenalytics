    ...
    <?php if($id==1){ ?>
     ...
     if(g==1){
      ...
      var dt = new Date();
        ...
        var urlString = "<?php echo base_url(); ?>Demo2/getSodexoReport";
        $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
   ...
   if(fromdate == ""){
    ...
    return true;
      ...
      //         }
        ...
        var urlString = "<?php echo base_url(); ?>Demo2/getOudorLevelReport";
        $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
      ...
      //document.getElementById("loading").style.display="block";
        ...
        var urlString = "<?php echo base_url(); ?>Demo2/getSupervisorDayData";
        $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
...
document.getElementById("consolidate").style.display="block";
      for (var i1 = 0; i1 < c.length; i1++) {
        document.getElementById("dateid"+i1).innerHTML = c[i1];
          var urlStringfoot = "<?php echo base_url(); ?>Demo2/consolidateReport?date="+c[i1];
           ...
           $.ajax({
              ...
              success: function(data){
              var obj = JSON.parse(data);
              var cd='<br>Total Footfall:'+obj['footfallcount'][0]+'<br>Total Alerts:'+obj['footfallcount'][1];
                        $("#dateid"+i1).append(cd);
...
function addjanigraphLive(data,v){
       ...
       var valid=validate();
        ...
        var urlString = "<?php echo base_url(); ?>Demo2/getJanitorReport";
        $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
      ...
      if(mtype=='Feedback Report'){
       ...
       var valid=validate();
        ...
        var urlString = "<?php echo base_url(); ?>Demo2/getFeedbackReport";
        $.ajax({
          url:urlString,
          type : 'GET',
          async: true,
...
<body >
    ...
    <div style="position:absolute; top:15px; left:15px; height:70px; right:15px;overflow:hidden;">
        ...
        <div class="col-md-6" id="links">
                    <span class="SctnNm"><a href="<?php echo site_url('Demo2/DemoDashboard/demoData') ?>" class="Lnk">Dashboard</a></span>
        </div>
          <!--          <li>
...
<a href="<?php //echo site_url('Demo/getReport') ?>" class="Lnk"><span class="Txt">Report1</span></a>
          ...
          <div class="col-md-6" id="links">
            <span class="SctnNm"><a href="<?php echo site_url('Demo2/DemoDashboard/getReport') ?>" class="Lnk">Reports</a></span>
          </div>
                </div>
                ...
                <div class="SctnSrch"  id="reportsid">
                    <ul class="SrchLst">
                        ...
                        <li class="report_btn" style="padding:0px">
                            <input type="button" class="btnrset" value="Go" onclick="getSodexoReport();"/>
                            <a href="<?php echo site_url('Demo2/getReport') ?>" class="btnrset">Reset</a>
...
function formatDate(date) {
  ...
  function addconsolidate(cd)
  {
      ...
      for (var z = 0; z < cd.length; z++) 
      {
          ...
          document.getElementById("dateid"+z).innerHTML = cd[z];
          var urlStringfoot = "<?php echo base_url(); ?>Demo2/consolidateReport?date="+cd[z];
           ...
           $.ajax({
              ...
              var cd='<br>Total Footfall:'+obj['footfallcount'][0]+'<br>Total Alerts:'+obj['footfallcount'][1];
                        $("#dateid"+z).append(cd);
                         addjanigraphLive(obj['janitor'],z);
                         addOdourDataLiveDashboard(obj['odour'],z);
                         appendFootfallLive(obj['footfall'],z);
                         addfeedbackgraphLive(obj['feedback'],z,cd.length);
